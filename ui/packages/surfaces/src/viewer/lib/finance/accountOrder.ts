...
export const FINANCE_ACCOUNT_LABEL = {
	"accounts_payable_change": "매입채무변동",
	"accounts_receivable_change": "매출채권변동",
	"accrued_dividends": "미수배당금",
	"accrued_expenses": "미지급비용",
	"accrued_income": "미수수익",
	"accrued_income_taxes_current": "미지급법인세(유동)",
	"accumulated_deficit": "결손금",
	"accumulated_depreciation": "(감가상각누계액)",
	"accumulated_impairment_losses": "(손상차손누계액)",
	"accumulated_oci_related_to_assets_held_for_sale": "매각예정자산관련기타포괄손익누계액",
	"accumulated_other_comprehensive_income": "기타포괄이익누계액",
	"actuarial_gains_or_losses_on_defined_benefit_plans": "확정급여제도의보험수리적손익",
	"addition_of_expenses_of_noncash_transactions": "현금유출이없는비용등가산",
	"additional_paid_in_capital": "자본잉여금",
	"adjustments_for_sales": "(매출조정)",
	"adjustments_to_reconcile_net_income": "손익조정사항",
	"advance_from_customers": "선수금",
	"advance_payments": "선급금",
	"advertising_expenses": "광고선전비",
	"allowance_for_doubtful_accounts": "(대손충당금)",
	"amortization_of_discount_on_bonds": "사채할인발행차금상각",
	"amortization_of_intangible_assets": "무형자산상각비",
	"asset_held_for_sale": "매각예정자산",
	"assets": "자산총계",
	"assets_held_under_a_finance_lease": "금융리스채권",
	"availableforsale_financial_assets": "매도가능금융자산",
	"availableforsale_financial_assets_valuation": "매도가능금융자산평가손익",
	"basic_earnings_per_share": "기본주당이익",
	"basic_earnings_per_share_from_continuing_operations": "계속영업보통주기본주당손익",
	"basic_earnings_per_share_from_discontinued_operations": "중단영업보통주기본주당손익",
	"basic_earnings_per_share_preferred": "우선주기본주당이익",
	"biological_assets": "비유동생물자산",
	"bonds": "사채",
	"bonds_with_stock_warrants": "BW",
	"borrowings": "차입부채",
	"borrowings_from_financial_institutes": "금융기관차입금",
	"business_combination": "사업결합",
	"capital_change_in_equity_method": "지분법자본변동",
	"capital_lease_current": "금융리스부채(유동)",
	"capital_stock": "자본금",
	"capital_surplus": "자본잉여금",
	"cash_and_cash_equivalents": "현금및현금성자산",
	"cash_and_cash_equivalents_at_the_beginning_of_year": "기초현금및현금성자산",
	"cash_and_cash_equivalents_at_the_end_of_year": "기말현금및현금성자산",
	"cash_and_cash_equivalents_beginning": "분기초현금및현금성자산",
	"cash_and_cash_equivalents_ending": "분기말현금및현금성자산",
	"cash_and_receivables_from_banks": "현금및예치금",
	"cash_flow_hedges": "현금흐름위험회피적립금",
	"cash_flows_from_business": "영업에서창출된현금흐름",
	"cash_flows_from_control_of_subsidiaries_or_other_businesses": "종속기업및기타사업의지배력관련한현금흐름",
	"cash_flows_from_financing": "재무활동으로인한현금흐름",
	"cash_flows_from_financing_activities": "재무활동으로인한현금흐름",
	"cash_flows_from_investing": "투자활동으로인한현금흐름",
	"cash_flows_from_investing_activities": "투자활동으로인한현금흐름",
	"cash_flows_from_loss_of_control_of_subsidiaries_or_other_businesses": "종속기업과기타사업의지배력상실에따른현금흐름",
	"cash_flows_from_operating_activities": "영업활동으로인한현금흐름",
	"cash_flows_from_operatings": "영업활동으로인한현금흐름",
	"cash_from_acquisition_or_loss_of_control_of_subsidiaries": "지배력을획득하거나상실한종속기업또는기타사업이보유한현금및현금성자산",
	"cash_inflows_from_derivatives": "선물계약,선도계약,옵션계약및스왑계약에따른현금유입",
	"cash_inflows_from_discontinued_operations": "중단영업으로인한현금유입",
	"cash_inflows_from_disposal_of_equity_or_debt_instruments": "다른기업의지분상품이나채무상품의처분에따른기타현금유입",
	"cash_inflows_from_exercise_of_conversion_rights": "전환권/신주인수권행사로인한현금유입",
	"cash_inflows_from_investing_activities": "투자활동으로인한현금유입액",
	"cash_outflows_from_acquisition_of_equity_or_debt_instruments": "다른기업의지분상품이나채무상품의취득에따른기타현금유출",
	"cash_outflows_from_derivatives": "선물계약,선도계약,옵션계약및스왑계약에따른현금유출",
	"cash_outflows_from_discontinued_operations": "중단영업으로인한현금유출",
	"cash_outflows_from_investing_activities": "투자활동으로인한현금유출액",
	"change_by_merger_and_acquisition": "합병분할(영업양수도등)로인한변동",
	"change_in_noncontrolling_interests": "비지배지분의증감",
	"change_in_working_capital": "운전자본증감",
	"change_of_consolidated_scope": "연결범위변동으로인한현금의증가",
	"change_of_retained_earnings_in_equity_method": "회계변동효과",
	"changes_in_operating_assets_and_liabilities": "영업자산부채의변동",
	"collection_of_advance_payments_and_loans_to_third_parties": "제3자에대한선급금및대여금의회수에따른현금유입",
	"commercial_paper_liability": "기업어음",
	"commission_expenses": "수수료비용",
	"common_stock": "보통주자본금",
	"communication_expenses": "통신비",
	"comprehensive_income": "포괄손익",
	"computer_software": "컴퓨터소프트웨어",
	"consideration_for_conversion_rights": "전환권대가",
	"consideration_for_stock_warrants": "신주인수권대가",
	"construction_in_progress": "건설중인자산",
	"construction_in_progress_receivables": "미청구공사",
	"contract_assets": "계약자산",
	"contract_liabilities": "계약부채",
	"contract_liability": "계약부채",
	"contribution_from_noncontrolling_interests": "비지배지분의출자",
	"convertible_bonds": "CB",
	"copyrights": "저작권",
	"cost_of_finished_goods_sold": "제품매출원가",
	"cost_of_merchandise_finished_goods": "상품·제품매출원가",
	"cost_of_merchandise_sold": "상품매출원가",
	"cost_of_sales": "매출원가",
	"cost_of_service": "용역원가",
	"current_afs_financial_assets": "단기매도가능금융자산",
	"current_assets": "유동자산",
	"current_derivative_assets": "유동파생상품자산",
	"current_derivative_liabilities": "유동파생상품부채",
	"current_financial_assets": "유동금융자산",
	"current_financial_guarantee_liabilities": "유동금융보증부채",
	"current_income_tax_assetsprepaid_income_tax_payments": "당기법인세자산(선급법인세)",
	"current_income_tax_liabilitiesincome_taxes_payable": "당기법인세부채(미지급법인세)",
	"current_inventories": "유동재고자산",
	"current_lease_liabilities": "단기리스부채",
	"current_liabilities": "유동부채",
	"current_portion_of_bonds": "유동성사채",
	"current_portion_of_convertible_bonds": "유동성전환사채",
	"current_portion_of_lease_obligationsother_payables": "유동성(금융)리스부채(미지급금등)",
	"current_portion_of_longterm_borrowings": "유동성장기차입금",
	"current_portion_of_longterm_debt": "유동성장기부채",
	"current_provisions": "유동충당부채",
	"debentures": "사채",
	"debt_issuance": "차입금조달",
	"debt_repayment": "차입금상환",
	"decrease_in_availableforsale_financial_assets": "매도가능금융자산의감소",
	"decrease_in_biological_assets": "생물자산의감소",
	"decrease_in_buildings_and_structures": "건물및부속설비의감소",
	"decrease_in_consolidated_capital_transaction": "연결자본거래로인한현금유출액",
	"decrease_in_construction_in_progress": "건설중인자산의감소",
	"decrease_in_equity_investments": "출자금의감소",
	"decrease_in_financial_assets_at_amortised_cost": "상각후원가측정금융자산의감소",
	"decrease_in_financial_assets_at_fv_through_profit": "당기손익인식금융자산의처분",
	"decrease_in_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "기타포괄손익-공정가치측정금융자산의감소",
	"decrease_in_financial_assets_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융자산의감소",
	"decrease_in_financial_instruments": "금융상품의처분",
	"decrease_in_goodwill": "영업권의감소",
	"decrease_in_guarantee_deposits": "공탁금의감소",
	"decrease_in_held_to_maturity_investments": "만기보유금융자산의감소",
	"decrease_in_intangible_assets": "무형자산의감소",
	"decrease_in_investment_in_properties": "투자부동산의감소",
	"decrease_in_investments_in_associates": "관계기업투자자산의처분",
	"decrease_in_investments_in_associates_subsidiaries_and_joint_venteures": "종속기업,조인트벤처와관계기업에대한투자자산의처분",
	"decrease_in_investments_in_associatesequity_method_securities": "관계기업투자등(지분법적용투자주식)의감소",
	"decrease_in_investments_in_joint_ventures": "조인트벤처투자의감소",
	"decrease_in_investments_in_subsidiaries": "종속기업투자의감소",
	"decrease_in_land": "토지의감소",
	"decrease_in_lease_obligations": "(금융)리스부채의감소",
	"decrease_in_leasehold_deposits_provided": "임차보증금의감소",
	"decrease_in_leasehold_deposits_received": "임대보증금의감소",
	"decrease_in_liabilities_held_for_sale": "매각예정으로분류된처분자산집단에포함된부채의처분",
	"decrease_in_loans": "대출금의감소",
	"decrease_in_loans_and_receivables": "대여금및수취채권의처분",
	"decrease_in_longterm_availableforsale_financial_assets": "비유동매도가능금융자산의처분",
	"decrease_in_longterm_financial_assets_at_fair_value_through_profit_or_loss": "비유동당기손익인식금융자산의처분",
	"decrease_in_longterm_financial_instruments": "장기금융상품의감소",
	"decrease_in_machinery_and_equipment": "기계장치의감소",
	"decrease_in_motor_vehicles": "차량운반구의감소",
	"decrease_in_noncontrolling_interests": "비지배지분의감소",
	"decrease_in_noncurrent_asset_held_for_sale": "매각예정비유동자산의감소",
	"decrease_in_other_current_financial_assets": "기타단기금융자산의감소",
	"decrease_in_other_financial_assets": "기타금융자산의처분",
	"decrease_in_other_financial_liabilities": "기타금융부채의감소",
	"decrease_in_other_liabilities": "기타부채의감소",
	"decrease_in_other_noncurrent_financial_assets": "기타장기금융자산의감소",
	"decrease_in_other_property_and_equipment": "기타유형자산의감소",
	"decrease_in_property_plant_and_equipment": "유형자산의감소",
	"decrease_in_shortterm_availableforsale_financial_assets": "단기매도가능금융자산의감소",
	"decrease_in_shortterm_borrowings": "단기차입금의감소",
	"decrease_in_shortterm_financial_assets_at_fair_value_through_profit_or_loss": "유동당기손익인식금융자산의처분",
	"decrease_in_shortterm_financial_instruments": "단기금융상품의감소",
	"decrease_in_shortterm_held_to_maturity_investments": "단기만기보유금융자산의감소",
	"decrease_in_shortterm_loans": "단기대여금의감소",
	"decrease_in_structures": "구축물의감소",
	"decrease_in_tools_and_office_equipment": "공구기구비품의감소",
	"decrease_of_convertible_bonds": "전환사채의감소",
	"decrease_of_exchangeable_bonds": "교환사채의감소",
	"decreaseincrease_in_accrued_revenues": "미수수익의감소",
	"decreaseincrease_in_advance_payments": "선급금의감소",
	"decreaseincrease_in_construction_in_progress_receivables": "미청구공사감소(증가)",
	"decreaseincrease_in_contract_assetscosts": "계약자산(원가)의감소",
	"decreaseincrease_in_current_income_tax_assetsprepaid_income_tax_payments": "당기법인세자산(선급법인세)의감소",
	"decreaseincrease_in_deferred_income_tax_assets": "이연법인세자산의감소",
	"decreaseincrease_in_deposits_provided": "보증금등의감소",
	"decreaseincrease_in_derivative_assets": "파생금융자산의감소",
	"decreaseincrease_in_due_from_banks": "예치금의감소(증가)",
	"decreaseincrease_in_financing_leases_receivables": "금융리스채권의감소",
	"decreaseincrease_in_inventories": "재고자산의감소",
	"decreaseincrease_in_loans": "대출금의감소",
	"decreaseincrease_in_longterm_advance_payments": "장기선급금의감소(증가)",
	"decreaseincrease_in_longterm_deposits_provided": "장기보증금의감소(증가)",
	"decreaseincrease_in_longterm_prepaid_expenses": "장기선급비용의감소(증가)",
	"decreaseincrease_in_longterm_receivables": "장기미수금의감소(증가)",
	"decreaseincrease_in_longterm_trade_receivables": "장기매출채권의감소(증가)",
	"decreaseincrease_in_other_assets": "기타자산의감소",
	"decreaseincrease_in_other_current_assets": "기타의유동자산의감소",
	"decreaseincrease_in_other_current_financial_assets": "기타유동금융자산의감소(증가)",
	"decreaseincrease_in_other_financial_assets": "기타금융자산의감소",
	"decreaseincrease_in_other_noncurrent_assets": "기타비금융자산의감소(증가)",
	"decreaseincrease_in_other_noncurrent_financial_assets": "기타비유동금융자산의감소(증가)",
	"decreaseincrease_in_other_receivables": "미수금의감소(증가)",
	"decreaseincrease_in_other_trade_and_other_receivables": "기타매출채권및기타채권의감소",
	"decreaseincrease_in_plan_assets": "사외적립자산의감소",
	"decreaseincrease_in_prepaid_expenses": "선급비용의감소",
	"decreaseincrease_in_receivables": "미수금의감소",
	"decreaseincrease_in_shortterm_deposits_provided": "단기보증금의감소(증가)",
	"decreaseincrease_in_shortterm_prepaid_expenses": "단기선급비용의감소(증가)",
	"decreaseincrease_in_trade_and_other_current_receivables": "매출채권및기타유동채권의감소(증가)",
	"decreaseincrease_in_trade_and_other_noncurrent_receivables": "장기매출채권및기타비유동채권의감소(증가)",
	"decreaseincrease_in_trade_and_other_receivables": "매출채권및기타채권의감소",
	"decreaseincrease_in_trade_receivables": "매출채권의감소",
	"deferred_revenue_current": "선수수익(유동)",
	"deferred_revenue_noncurrent": "선수수익(비유동)",
	"deferred_tax_assets": "이연법인세자산",
	"deferred_tax_liabilities": "이연법인세부채",
	"deferred_taxes": "이연법인세",
	"defined_benefit_assets": "확정급여자산등",
	"defined_benefit_liabilities": "확정급여채무",
	"defined_benefit_liability": "확정급여부채",
	"deposits_liabilities": "예수부채",
	"depreciation": "감가상각비",
	"depreciation_amortization": "감가상각비",
	"depreciation_cf": "감가상각비",
	"depreciation_other_amortization_and_impairment_losses_expense": "감가상각비와기타상각비및손상차손",
	"derivative_valuation": "파생상품평가손익",
	"derivatives_assets": "파생상품자산",
	"derivatives_liabilities": "파생상품부채",
	"difference_by_changes_in_foreign_exchange_rates": "환율변동으로인한차이조정",
	"diluted_earnings_per_share": "희석주당이익",
	"diluted_earnings_per_share_from_continuing_operations": "계속영업보통주희석주당손익",
	"diluted_earnings_per_share_from_discontinued_operations": "중단영업보통주희석주당손익",
	"discontinued_operating_incomeloss": "중단사업이익",
	"disposal_of_finance_lease_assets": "금융리스자산의처분",
	"disposal_of_intangible_assets": "무형자산의처분",
	"disposal_of_tangible_assets": "유형자산의처분",
	"disposition_of_interest_in_subsidiaries": "종속기업소유지분변동에따른현금흐름",
	"dividends": "배당금",
	"dividends_paid": "배당금지급",
	"dividends_received": "배당금수입",
	"donations": "기부금",
	"earnings_per_share": "주당순이익",
	"effect_of_exchange_rate_changes": "현금및현금성자산에대한환율변동효과",
	"employee_benefit_assets": "종업원급여자산",
	"employee_benefits": "복리후생비",
	"ending_cash": "기말현금",
	"entertainment": "접대비",
	"equity_method_investments": "지분법투자",
	"equity_related_to_assets_held_for_sale": "매각예정자산과관련된자본",
	"estimates_of_contract_losses": "(추정공사손실)",
	"exchangeable_bonds": "EB",
	"exercise_of_stock_options": "주식매입선택권의행사",
	"expenses_of_allowance_for_doubtful_accounts": "대손상각비",
	"expenses_of_allowance_for_doubtful_accounts_provision_for_allowance_for_bad_debits": "대손상각비(대손충당금전입액)",
	"facilities": "시설장치",
	"finance_costs": "금융비용",
	"finance_income": "금융이익",
	"finance_lease_liability_noncurrent": "금융리스부채(비유동)",
	"financial_assets_at_amortised_cost": "상각후원가측정금융자산",
	"financial_assets_at_amortized_cost": "상각후원가금융자산",
	"financial_assets_at_fv_through_oci": "기타포괄손익-공정가치금융자산",
	"financial_assets_at_fv_through_profit": "당기손익인식금융자산",
	"financial_assets_measured_at_fair_value_through_other_comprehensive_income": "기타포괄손익-공정가치측정금융자산",
	"financial_assets_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융자산",
	"financial_costs": "금융원가",
	"financial_guarantee_provisions": "금융보증충당부채",
	"financial_income": "금융수익",
	"financial_liabilities_at_amortised_cost": "상각후원가측정금융부채",
	"financial_liabilities_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융부채",
	"financial_liability_at_fv_through_profit": "장기당기손익인식금융부채",
	"financing_cashflow": "재무활동현금흐름",
	"financing_expenses": "금융비용",
	"foreign_currency_translation": "해외사업환산손익",
	"foreign_currency_translation_differences": "해외사업장의환산이익",
	"foreign_currency_translation_differences_before_tax": "해외사업장환산외환차이세전기타포괄이익",
	"gains_from_capital_reduction": "감자차익",
	"gains_on_assets_revaluations": "자산재평가이익",
	"gains_on_bargain_purchase": "염가매수차익",
	"gains_on_debt_restructuring": "채무조정이익",
	"gains_on_derivatives_transactions": "파생상품거래이익",
	"gains_on_disposal_of_assets": "자산처분(폐기)이익",
	"gains_on_disposal_of_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "기타포괄손익-공정가치측정금융자산처분이익",
	"gains_on_disposal_of_financial_assets_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융자산처분이익",
	"gains_on_disposal_of_financial_liabilities_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융부채처분이익",
	"gains_on_disposal_of_held_for_sale_or_disposal_group": "매각및처분예정자산집단처분이익",
	"gains_on_disposal_of_intangible_assets": "무형자산처분이익",
	"gains_on_disposal_of_leased_housing_assets": "임대주택자산처분이익",
	"gains_on_disposal_of_other_assets": "기타자산처분이익",
	"gains_on_disposal_of_tangible_assets": "유형자산처분이익",
	"gains_on_disposition_of_associates": "관계기업처분이익",
	"gains_on_disposition_of_associates_subsidiaries_joint_ventures": "종속기업/관계기업/공동기업투자처분이익",
	"gains_on_disposition_of_availableforsale_financial_assets": "매도가능금융자산처분이익",
	"gains_on_disposition_of_equity_method_securities": "지분법적용투자주식처분이익",
	"gains_on_disposition_of_financial_assets": "금융자산처분이익",
	"gains_on_disposition_of_investments": "투자자산처분이익",
	"gains_on_disposition_of_subsidiaries": "종속기업처분이익",
	"gains_on_disposition_of_treasury_stock": "자기주식처분이익",
	"gains_on_foreign_currencies_transaction": "외환차익",
	"gains_on_foreign_currency_translation": "외화환산이익",
	"gains_on_investment_in_properties": "투자부동산처분이익",
	"gains_on_redemption_of_bonds": "사채상환이익",
	"gains_on_valuation_of_availableforsale_financial_assets": "매도가능금융자산평가이익",
	"gains_on_valuation_of_equity_method_securities": "지분법이익",
	"gains_on_valuation_of_financial_assets_at_fv_through_profit": "당기손익인식금융자산평가이익",
	"gains_on_valuation_of_financial_assets_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융자산평가이익",
	"gains_on_valuation_of_investments": "자산평가이익",
	"gains_on_valuation_of_shortterm_trading_financial_assets": "단기매매금융자산평가이익",
	"gains_on_valuations_of_derivatives": "파생상품평가이익",
	"gainslosses_in_equity_method": "지분법관련손익",
	"gainslosses_on_disposal_of_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "기타포괄손익-공정가치지분상품처분손익",
	"gainslosses_on_disposition_of_noncurrent_assets": "비유동자산처분손실(이익)",
	"gainslosses_on_disposition_of_other_noncurrent_assets": "기타장기성자산의처분",
	"gainslosses_on_valuation_of_availableforsale_financial_assets": "매도가능금융자산평가손익",
	"gainslosses_on_valuation_of_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "기타포괄손익-공정가치측정금융자산평가손익",
	"goods_in_transit": "미착품",
	"goodwill": "영업권",
	"government_grants": "(정부보조금등)",
	"government_grants_deferred_income": "이연수익",
	"government_grants_received": "정부보조금의수취",
	"gross_amount_due_to_customers_for_contract_work": "초과청구공사",
	"gross_profit": "매출총이익",
	"guarantee_deposits_withhold": "예수보증금",
	"hedges_of_net_investment_in_foreign_operations": "해외사업장순투자위험회피",
	"held_to_maturity_financial_assets": "만기보유금융자산",
	"held_to_maturity_investments": "만기보유금융자산",
	"hybrid_bond": "신종자본증권",
	"hybrid_bond_dividends": "(신종자본증권분배금)",
	"impairment_loss_on_inventories": "재고자산감모손실",
	"impairment_losses_on_asset_held_for_sale_or_disposal_group": "매각예정처분자산집단손상차손",
	"impairment_losses_on_associates": "관계기업손상차손",
	"impairment_losses_on_availableforsale_financial_assets": "매도가능금융자산손상차손",
	"impairment_losses_on_financial_assets": "금융자산손상차손",
	"impairment_losses_on_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "기타포괄손익-공정가치측정금융자산손상차손",
	"impairment_losses_on_held_to_maturity_investments": "만기보유금융자산손상차손",
	"impairment_losses_on_intangible_assets": "무형자산손상차손",
	"impairment_losses_on_investments": "투자자산손상차손",
	"impairment_losses_on_investments_in_subsidiaries": "종속기업투자주식손상차손",
	"impairment_losses_on_investments_in_subsidiaries_associates_joint_ventures": "종속기업/관계기업/공동기업투자손상차손",
	"impairment_losses_on_property_plant_and_equipment": "유형자산손상차손",
	"impairment_losses_on_right_of_use_assets": "사용권자산손상차손",
	"income_tax_benefit": "법인세이익",
	"income_tax_expense": "법인세비용",
	"income_taxes": "법인세비용",
	"income_taxes_payable": "미지급법인세",
	"increase_in_advance_payments": "선급금의증가",
	"increase_in_availableforsale_financial_assets": "매도가능금융자산의증가",
	"increase_in_bonds": "사채의증가",
	"increase_in_borrowings": "차입부채의증가",
	"increase_in_buildings_and_structures": "건물및부속설비의증가",
	"increase_in_consolidated_capital_transaction": "연결자본거래로인한현금유입액",
	"increase_in_construction_in_progress": "건설중인자산의증가",
	"increase_in_equity_investments": "출자금의증가",
	"increase_in_financial_assets_at_amortised_cost": "상각후원가측정금융자산의증가",
	"increase_in_financial_assets_at_fv_through_profit": "당기손익인식금융자산의취득",
	"increase_in_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "기타포괄손익-공정가치측정금융자산의증가",
	"increase_in_financial_assets_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융자산의증가",
	"increase_in_financial_instruments": "금융상품의취득",
	"increase_in_goodwill": "영업권의증가",
	"increase_in_held_to_maturity_investments": "만기보유금융자산의증가",
	"increase_in_industrial_property_rights": "기타산업재산권의증가",
	"increase_in_intangible_assets": "무형자산의증가",
	"increase_in_investment_in_properties": "투자부동산의증가",
	"increase_in_investments_in_associates": "관계기업투자자산의취득",
	"increase_in_investments_in_associates_subsidiaries_and_joint_venteures": "종속기업,조인트벤처와관계기업에대한투자자산의취득",
	"increase_in_investments_in_associatesequity_method_securities": "관계기업투자등(지분법적용투자주식)의증가",
	"increase_in_investments_in_joint_ventures": "조인트벤처투자의증가",
	"increase_in_investments_in_subsidiaries": "종속기업투자의증가",
	"increase_in_land": "토지의증가",
	"increase_in_lease_obligations": "(금융)리스부채의증가",
	"increase_in_leasehold_deposits_provided": "임차보증금의증가",
	"increase_in_leasehold_deposits_received": "임대보증금의증가",
	"increase_in_loans": "대출금의증가",
	"increase_in_loans_and_receivables": "대여금및수취채권의취득",
	"increase_in_longterm_availableforsale_financial_assets": "비유동매도가능금융자산의취득",
	"increase_in_longterm_borrowings": "장기차입금의차입",
	"increase_in_longterm_financial_assets_at_fair_value_through_profit_or_loss": "비유동당기손익인식금융자산의취득",
	"increase_in_longterm_financial_instruments": "장기금융상품의증가",
	"increase_in_longtermborrowings": "장기차입금의증가",
	"increase_in_machinery_and_equipment": "기계장치의증가",
	"increase_in_motor_vehicles": "차량운반구의증가",
	"increase_in_noncontrolling_interests": "비지배지분의증가",
	"increase_in_noncurrent_asset_held_for_sale": "매각예정비유동자산의증가",
	"increase_in_other_current_financial_assets": "기타단기금융자산의증가",
	"increase_in_other_financial_assets": "기타금융자산의취득",
	"increase_in_other_financial_liabilities": "기타금융부채의증가",
	"increase_in_other_longterm_assets": "기타장기성자산의취득",
	"increase_in_other_noncurrent_financial_assets": "기타장기금융자산의증가",
	"increase_in_other_property_and_equipment": "기타유형자산의증가",
	"increase_in_preferred_stock_of_redemption": "상환우선주부채의증가",
	"increase_in_property_and_equipment": "유형자산의증가",
	"increase_in_property_plant_and_equipment": "유형자산의증가",
	"increase_in_right_of_use_assets": "사용권자산의취득",
	"increase_in_shortterm_borrowings": "단기차입금의증가",
	"increase_in_shortterm_financial_assets_at_fair_value_through_profit_or_loss": "유동당기손익인식금융자산의취득",
	"increase_in_shortterm_financial_instruments": "단기금융상품의증가",
	"increase_in_shortterm_held_to_maturity_investments": "단기만기보유금융자산의증가",
	"increase_in_shortterm_loans": "단기대여금의증가",
	"increase_in_structures": "구축물의증가",
	"increase_of_convertible_bonds": "전환사채의증가",
	"increase_of_exchangeable_bonds": "교환사채의증가",
	"increase_of_longtermbonds": "사채의증가",
	"increasedecrease_in_accrued_expenses": "미지급비용의증가",
	"increasedecrease_in_advance_from_customers": "선수금의증가",
	"increasedecrease_in_cash_and_cash_equivalents": "현금의증가",
	"increasedecrease_in_contract_liabilities": "계약부채의증가",
	"increasedecrease_in_current_income_tax_liabilitiesincome_taxes_payable": "당기법인세(미지급법인세)의증가",
	"increasedecrease_in_deferred_income_tax_liabilities": "이연법인세부채의증가",
	"increasedecrease_in_deferred_revenue": "이연수익의증가(감소)",
	"increasedecrease_in_defined_benefit_liabilities": "퇴직급여채무의증가(감소)",
	"increasedecrease_in_defined_benefit_liability": "순확정급여부채증가(감소)",
	"increasedecrease_in_deposits_provided": "보증금의증가",
	"increasedecrease_in_derivative_liabilities": "파생상품부채의증가",
	"increasedecrease_in_dividends_payable": "미지급배당금의증가",
	"increasedecrease_in_excess_billing": "초과청구공사의증가(감소)",
	"increasedecrease_in_liability_provisions": "충당부채의증가",
	"increasedecrease_in_longterm_other_payables": "장기미지급금의증가(감소)",
	"increasedecrease_in_longterm_trade_and_other_payables": "장기매입채무및기타비유동채무의증가(감소)",
	"increasedecrease_in_noncurrent_provisions": "비유동충당부채의증가(감소)",
	"increasedecrease_in_other_current_liabilities": "기타유동부채의증가(감소)",
	"increasedecrease_in_other_financial_liabilities": "기타금융부채의증가",
	"increasedecrease_in_other_liabilities": "기타부채의증가",
	"increasedecrease_in_other_noncurrent_liabilities": "기타비유동부채의증가(감소)",
	"increasedecrease_in_other_payables": "미지급금의증가",
	"increasedecrease_in_other_provisions": "기타충당부채의증가(감소)",
	"increasedecrease_in_other_trade_and_payables": "매입채무및기타채무의증가",
	"increasedecrease_in_product_warranties_provisions": "판매보증충당부채의증가(감소)",
	"increasedecrease_in_provisions": "충당부채의증가(감소)",
	"increasedecrease_in_provisions_for_employee_benefits": "퇴직급여채무(종업원급여충당부채,확정급여부채)의증가",
	"increasedecrease_in_provisions_for_restoration_costs": "복구충당부채의증가(감소)",
	"increasedecrease_in_shortterm_borrowings": "단기차입금의순증감",
	"increasedecrease_in_trade_and_other_payables": "매입채무및기타채무의증가(감소)",
	"increasedecrease_in_trade_payables": "매입채무의증가",
	"increasedecrease_in_withholdings": "예수금의증가(감소)",
	"insurance_contract_assets": "보험계약자산",
	"insurance_contract_liabilities": "보험계약부채",
	"insurance_premium": "보험료",
	"intangible_assets": "무형자산",
	"intangible_assets_under_development": "개발중인무형자산",
	"interest_expenses": "이자비용",
	"interest_expensesamortization_of_discount_on_bonds_etc": "이자비용(사채할인발행차금상각등)",
	"interest_income": "이자수익",
	"interest_paid": "이자지급(-)",
	"interest_received": "이자수입",
	"inventories": "재고자산",
	"inventory_change": "재고자산변동",
	"investing_cashflow": "투자활동현금흐름",
	"investment_in_properties": "투자부동산",
	"investment_maturities": "투자자산만기상환",
	"investment_purchases": "투자자산취득",
	"investment_sales": "투자자산처분",
	"investments_in_associates": "관계기업등지분관련투자자산",
	"investments_in_associates_and_joint_ventures": "관계및공동기업투자",
	"investments_in_associates_and_joint_ventures_transactions": "관계기업및공동기업주식취득및처분",
	"investments_in_associates_subsidiaries_and_joint_venteures": "관계기업등지분관련투자자산",
	"investments_in_associatesequity_method_securities": "관계기업투자등(지분법적용투자주식)",
	"investments_in_associatesinvestments_in_equity_method": "관계기업투자(지분법적용투자)",
	"investments_in_equity_method": "지분법적용투자지분",
	"investments_in_joint_ventures": "조인트벤처투자(공동기업투자)",
	"investments_in_subsidiaries": "종속기업투자",
	"investments_in_subsidiaries_and_associates_equity_method": "관계종속기업투자자산-지분법",
	"investments_in_subsidiaries_associates_and_joint_ventures": "종속기업,관계기업및공동기업투자",
	"issuance_of_bonds": "사채의발행",
	"issuance_of_common_stock": "주식의발행",
	"issue_of_hybrid_bond": "신종자본증권의발행",
	"lease_liabilities": "리스부채",
	"lease_obligations": "(금융)리스부채",
	"leased_assets": "리스자산",
	"leasehold_deposits_received": "(임대보증금)",
	"legal_proceedings_provisions": "소송충당부채",
	"legal_reserve": "이익준비금",
	"liabilities": "부채총계",
	"liabilities_classified_as_held_for_sale": "매각예정분류부채",
	"liabilities_included_in_disposal_groups_classified_as_held_for_sale": "부채_매각예정처분자산",
	"liability_provisions": "충당부채전입액",
	"loans": "대출채권",
	"long_term_investments": "장기투자자산",
	"longterm_accounts_receivablesconstruction_work": "장기공사미수금",
	"longterm_accrued_expenses": "장기미지급비용",
	"longterm_advance_from_customers": "장기선수금",
	"longterm_advance_payments": "장기선급금",
	"longterm_availableforsale_financial_assets": "장기매도가능금융자산",
	"longterm_borrowings": "장기차입금",
	"longterm_derivative_assets": "장기파생상품자산",
	"longterm_derivative_liabilities": "장기파생상품부채",
	"longterm_finance_lease_receivables": "장기금융리스채권",
	"longterm_financial_assets": "장기금융자산",
	"longterm_financial_assets_at_fair_value_through_profit_or_loss": "장기당기손익인식금융자산",
	"longterm_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "비유동기타포괄손익공정가치금융자산",
	"longterm_financial_instruments": "장기금융상품",
	"longterm_financial_liabilities": "비유동금융부채",
	"longterm_guarantee_deposits_withhold": "장기예수보증금",
	"longterm_gurarantee": "장기보증금",
	"longterm_held_to_maturity_investments": "장기만기보유금융자산",
	"longterm_investment_assets": "장기투자자산",
	"longterm_leasehold_deposits_provided": "장기임차보증금",
	"longterm_leasehold_deposits_received": "장기임대보증금",
	"longterm_loans": "장기대여금",
	"longterm_other_payables": "장기미지급금",
	"longterm_other_payables_others": "기타장기미지급금",
	"longterm_preferred_stock_of_redemption": "장기상환우선주부채",
	"longterm_prepaid_expenses": "장기선급비용",
	"longterm_provisions": "장기충당부채",
	"longterm_receivables": "장기미수금",
	"longterm_trade_and_other_noncurrent_payables": "장기매입채무및기타채무",
	"longterm_trade_payables": "장기매입채무",
	"longterm_trade_receivables": "장기매출채권",
	"longterm_unearned_income": "장기선수수익",
	"longterm_withholdings": "장기예수금",
	"loss_before_tax": "법인세차감전순손실",
	"losses_on_derivatives_transactions": "파생상품거래손실",
	"losses_on_disposal_of_assets": "자산처분(폐기)손실",
	"losses_on_disposal_of_financial_assets_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융자산처분손실",
	"losses_on_disposal_of_held_for_sale_or_disposal_group": "매각및처분예정자산집단처분손실",
	"losses_on_disposal_of_intangible_assets": "무형자산처분손실",
	"losses_on_disposal_of_tangible_assets": "유형자산처분손실",
	"losses_on_disposal_of_trade_receivables": "매출채권처분손실",
	"losses_on_disposition_of_associates": "관계기업처분손실",
	"losses_on_disposition_of_associates_subsidiaries_joint_ventures": "종속기업/관계기업/공동기업투자처분손실",
	"losses_on_disposition_of_availableforsale_financial_assets": "매도가능금융자산처분손실",
	"losses_on_disposition_of_designatedfinancial_assets_at_fv_through_profit": "당기손익인식금융자산처분손실",
	"losses_on_disposition_of_financial_assets": "금융자산처분손실",
	"losses_on_disposition_of_investments": "투자자산처분손실",
	"losses_on_disposition_of_subsidiaries": "종속기업처분손실",
	"losses_on_evaluation_of_inventories": "재고자산평가손실",
	"losses_on_foreign_currencies_transaction": "외환차손",
	"losses_on_foreign_currency_translation": "외화환산손실",
	"losses_on_inventory_clearing": "재고자산폐기(처분)손실",
	"losses_on_investment_in_properties": "투자부동산처분손실",
	"losses_on_redemption_of_bonds": "사채상환손실",
	"losses_on_revaluation_of_property_plant_and_equipment": "유형자산재평가손실",
	"losses_on_valuation_of_availableforsale_financial_assets": "매도가능금융자산평가손실",
	"losses_on_valuation_of_equity_method_securities": "종속기업,공동지배기업및관계기업(지분법)관련손실",
	"losses_on_valuation_of_financial_assets_at_fv_through_profit": "당기손익인식금융자산평가손실",
	"losses_on_valuation_of_financial_assets_measured_at_fair_value_through_profit_or_loss": "당기손익-공정가치측정금융자산평가손실",
	"losses_on_valuation_of_investment_assets": "자산평가손실",
	"losses_on_valuation_of_shortterm_trading_financial_assets": "단기매매금융자산평가손실",
	"losses_on_valuations_of_derivatives": "파생상품평가손실",
	"lt_trade_and_other_receivables": "장기매출채권및기타채권",
	"miscellaneous_income_for_lease": "리스잡수익",
	"miscellaneous_losses": "잡손실",
	"motor_vehicles": "차량운반구",
	"net_change_in_cash": "현금순변동",
	"net_decrease_in_shortterm_borrowings": "단기차입금의순감소",
	"net_income": "당기순이익",
	"net_income_cf": "당기순이익",
	"net_incomenet_loss_for_the_year_attributable_tononcontrolling_interests_equity": "(비지배주주지분)당기순이익",
	"net_incomenet_loss_for_the_year_attributable_toowners_of_parent_equity": "(지배주주지분)당기순이익",
	"net_increase_decrease_in_cash_and_cash_equivalents": "현금및현금성자산의증감",
	"net_increase_in_shortterm_borrowings": "단기차입금의순증가",
	"net_profit": "당기순이익",
	"noncontrolling_interests_equity": "비지배주주지분",
	"noncurrent_afs_financial_assets": "매도가능금융자산비유동",
	"noncurrent_asset_held_for_sale_or_disposal_group": "자산_매각예정비유동자산처분",
	"noncurrent_assets": "비유동자산",
	"noncurrent_borrowings": "장기차입부채",
	"noncurrent_derivative_assets": "비유동파생상품자산",
	"noncurrent_derivative_liabilities": "비유동파생상품부채",
	"noncurrent_financial_guarantee_liabilities": "장기금융보증부채",
	"noncurrent_lease_liabilities": "장기리스부채",
	"noncurrent_liabilities": "비유동부채",
	"noncurrent_provisions": "비유동충당부채",
	"noncurrent_provisions_for_employee_benefits": "비유동종업원급여충당부채",
	"nonoperating_income_expenses": "영업외손익",
	"office_furniture_and_equipment": "기구및비품",
	"operating_cashflow": "영업활동현금흐름",
	"operating_expenses": "영업비용",
	"operating_lease_liability_current": "운용리스부채(유동)",
	"operating_lease_liability_noncurrent": "운용리스부채(비유동)",
	"operating_lease_rou_asset": "운용리스사용권자산",
	"operating_profit": "영업이익",
	"operating_revenues": "영업수익",
	"other_accrued_expenses": "기타미지급비용",
	"other_accrued_income": "기타미수수익",
	"other_adjustments_to_reconcile_net_income": "당기순이익조정을위한기타가감",
	"other_advance_payments": "기타선급금",
	"other_allowance": "기타충당부채",
	"other_assets": "기타자산",
	"other_capital_surplus": "기타자본잉여금",
	"other_cash_inflows_outflows": "현금의 기타유출입",
	"other_components_of_equity": "기타자본조정",
	"other_comprehensive_income": "기타포괄이익",
	"other_comprehensive_income_not_to_be_reclassified": "당기손익으로재분류되지않는항목(세후기타포괄손익)",
	"other_comprehensive_income_not_to_be_reclassified_before_tax": "당기손익으로재분류되지않는항목(세전기타포괄손익)",
	"other_comprehensive_income_of_associates_etc": "관계기업등기타포괄이익",
	"other_comprehensive_income_to_be_reclassified": "당기손익으로재분류될수있는항목(세후기타포괄손익)",
	"other_comprehensive_income_to_be_reclassified_before_tax": "당기손익으로재분류될수있는항목(세전기타포괄손익)",
	"other_cost_of_sales": "기타매출원가",
	"other_current_assets": "기타유동자산",
	"other_current_financial_assets": "기타단기금융자산",
	"other_current_financial_liabilities": "기타유동금융부채",
	"other_current_liabilities": "기타유동부채",
	"other_equity": "기타자본구성요소",
	"other_expenses": "기타비용",
	"other_expenses_of_allowance_for_doubtful_accounts": "기타대손상각비",
	"other_financial_assets": "기타금융자산",
	"other_financial_expenses": "기타금융원가",
	"other_financial_income": "기타금융수익",
	"other_financial_institutions_liabilities": "기타금융업부채",
	"other_financing_cost": "기타금융비용",
	"other_income": "기타수익",
	"other_intangible_assets": "기타무형자산",
	"other_inventories": "기타재고자산",
	"other_investment_in_properties": "기타투자부동산",
	"other_items_classified_as_investing_or_financing_activities": "투자활동현금흐름이나재무활동현금흐름으로분류되는기타모든항목",
	"other_leased_assets": "기타리스자산",
	"other_legal_reserves": "기타법정적립금",
	"other_liabilities": "기타부채",
	"other_longterm_availableforsale_financial_assets": "기타장기매도가능금융자산",
	"other_longterm_borrowings": "기타장기차입금",
	"other_longterm_derivatives": "기타장기파생상품자산",
	"other_longterm_financial_liabilities": "기타장기금융부채",
	"other_longterm_held_to_maturity_investments": "기타장기만기보유금융자산",
	"other_longterm_provisions": "기타장기충당부채",
	"other_noncash_adjustments": "비현금항목에관한기타조정",
	"other_noncurrent_assets": "기타비유동자산",
	"other_noncurrent_financial_assets": "기타비유동금융자산",
	"other_noncurrent_financial_liabilities": "장기기타금융부채",
	"other_noncurrent_liabilities": "기타비유동부채",
	"other_noncurrent_receivables": "기타장기채권",
	"other_nonoperating_expenses": "기타영업외비용",
	"other_nonoperating_income": "기타영업외수익",
	"other_operating_expenses": "기타영업비용",
	"other_operating_income": "기타영업이익",
	"other_paid_in_capital": "기타불입자본",
	"other_payables": "미지급금",
	"other_payables_others": "기타미지급금",
	"other_property_plant_equipment": "기타유형자산",
	"other_receivables": "미수금",
	"other_receivables_current": "기타매출채권(유동)",
	"other_reserves": "기타자본",
	"other_retained_earnings": "기타이익잉여금",
	"other_revenues_without_cash_inflows": "기타현금의유입없는수익등",
	"other_sales": "기타수익",
	"other_sga": "기타판매비와관리비",
	"other_shortterm_borrowings": "기타단기차입금",
	"other_shortterm_provisions": "단기충당부채",
	"other_withholdings": "기타예수금",
	"others_expense": "기타비용",
	"others_in_advance_from_customers": "기타선수금",
	"others_longterm_employee_benefits_liabilitiesbonuses_etc": "기타장기종업원급여부채(연차,상여등)",
	"owners_of_parent_equity": "지배주주지분",
	"packing_expenses": "포장비",
	"paid_in_capital_decrease": "유상감자",
	"paid_in_capital_increase": "유상증자",
	"paidin_capital": "자본금",
	"paidin_capital_in_excess_of_par_value": "주식발행초과금",
	"payment_of_stock_issuance_costs": "신주발행비지급",
	"payments_of_income_taxes": "법인세납부(-)",
	"payments_of_retirement_allowance": "퇴직금의지급",
	"periodicals_and_printing_expenses": "도서인쇄비",
	"plan_assets": "(사외적립자산)",
	"policyholders_equity_adjustment": "계약자지분조정",
	"preferred_stock": "우선주자본금",
	"prepaid_expenses": "선급비용",
	"prepaid_income_taxes": "선급법인세",
	"present_value_discount": "(현재가치할인차금)",
	"present_value_of_defined_benefit_obligations": "확정급여채무의현재가치",
	"product_warranties_expenses": "판매보증비",
	"product_warranties_provisions": "제품보증충당부채",
	"profit_attributable_to_noncontrolling_interests": "비지배지분귀속",
	"profit_before_tax": "법인세비용차감전순이익",
	"profit_from_continuing_operations": "계속사업이익",
	"profit_from_continuing_operations_attributable_to_noncontrolling_interests": "비지배지분에귀속될계속영업이익손실",
	"profit_from_continuing_operations_attributable_to_owners_of_parent": "지배기업의소유주에게귀속될계속영업손익",
	"profit_from_discontinued_operations": "중단사업이익",
	"profit_from_discontinued_operations_attributable_to_noncontrolling_interests": "비지배지분에귀속될중단영업이익(손실)",
	"profit_from_discontinued_operations_attributable_to_owners_of_parent": "지배기업의소유주에게귀속될중단영업손익",
	"property_plant_and_equipment": "유형자산",
	"provision_for_construction_provisions": "하자보수충당부채",
	"provision_for_loss_on_acceptances_and_guarantees": "지급보증충당부채전입액",
	"provisions": "충당부채",
	"provisions_for_others": "기타충당부채전입액",
	"provisions_for_restoration_costs": "복구충당부채",
	"purchase_of_intangible_assets": "무형자산의취득",
	"purchase_of_property_plant_and_equipment": "유형자산의취득",
	"purchase_of_treasury_stock": "자기주식의취득",
	"raw_materialssubmaterials": "원재료(부재료)",
	"receivables": "미수금",
	"reclassification_of_availableforsale_financial_assets": "매도가능금융자산평가손익의세후재분류조정",
	"recovery_of_impairment_losses_on_assets": "자산손상차손환입",
	"recovery_of_impairment_losses_on_associates": "관계기업손상차손환입",
	"recovery_of_impairment_losses_on_availableforsale_financial_assets": "매도가능금융자산손상차손환입",
	"recovery_of_impairment_losses_on_intangible_assets": "무형자산손상차손환입",
	"recovery_of_impairment_losses_on_property_plant_and_equipment": "유형자산손상차손환입",
	"recovery_of_losses_on_evaluation_of_inventories": "재고자산평가손실환입",
	"redeemable_noncontrolling_interest": "상환가능비지배지분",
	"redemption_of_callable_stock": "상환주식상환액",
	"redemption_of_current_portion_of_longterm_borrowings": "유동성장기부채의감소",
	"redemption_of_hybrid_bond": "신종자본증권상환",
	"refunds_of_income_taxes": "법인세환급액",
	"refunds_payments_of_income_taxes": "법인세환입(납부)",
	"reinsurance_assets": "재보험자산",
	"remeasurement_elements_of_defined_benefit_plans": "확정급여제도의재측정요소",
	"remeasurement_elements_of_defined_benefit_plans_before_tax": "확정급여제도의재측정손익(세전기타포괄손익)",
	"rent": "임차료",
	"rental_assets": "렌탈자산",
	"rental_income": "임대료수익",
	"rental_lease_income": "임대수익",
	"repairs_and_maintenance_expenses": "수선비",
	"repayment_of_borrowings": "차입금상환",
	"repayment_of_convertible_bonds": "전환사채의상환",
	"repayment_of_longterm_borrowings": "장기차입금의상환",
	"repayment_of_shortterm_borrowings": "단기차입금의상환",
	"repayments_of_bonds": "사채의감소",
	"repayments_of_government_grants": "정부보조금의상환",
	"research_development": "연구개발비",
	"reserve_for_outstanding_claims_for_reinsurance_ceded": "출재지급준비금",
	"reserve_of_sharebased_payments": "주식기준보상적립금",
	"restricted_cash_current": "제한현금(유동)",
	"retained_earnings": "이익잉여금",
	"returned_products_provisions": "반품충당부채",
	"revaluation_surplus": "재평가잉여금",
	"reversal_of_allowance_for_acceptances_and_guarantees": "지급보증충당부채환입액",
	"reversal_of_allowance_for_doubtful_accounts": "대손충당금환입액",
	"reversal_of_allowance_for_other_doubtful_accounts": "기타대손충당금환입",
	"reversal_of_other_provisions": "기타충당부채의환입",
	"reversion_of_liability_provisions": "충당부채환입액",
	"reversion_of_provisions_for_restoration_costs": "복구충당부채환입액",
	"right_of_use_assets": "사용권자산",
	"salaries_and_wages": "급여",
	"sale_of_treasury_stock": "자기주식의처분",
	"sales": "매출액",
	"sales_of_finished_goods": "제품매출액",
	"sales_of_merchandise": "상품매출액",
	"sales_of_merchandise_finished_goods": "재화의판매로인한수익(상품,제품매출액)",
	"sales_promotion_expenses": "판매촉진비",
	"securities_at_amortised_cost": "상각후원가측정유가증권",
	"selling_and_administrative_expenses": "판매비와관리비",
	"separate_account_credits": "특별계정자산",
	"separate_account_liabilities": "특별계정부채",
	"service_revenue": "용역의제공으로인한수익(매출액)",
	"severance_and_retirement_benefits": "퇴직급여",
	"sga": "판매비와관리비",
	"share_of_oci_of_associates_and_joint_ventures": "관계기업및공동기업의기타포괄손익에대한지분",
	"share_of_other_comprehensive_income_of_associates_and_joint_ventures": "지분법적용대상관계기업과공동기업의기타포괄손익에대한지분(세후기타포괄손익)",
	"share_premium": "주식발행초과금",
	"short_term_borrowings": "단기차입금",
	"short_term_investments": "단기투자자산",
	"shortterm_accrued_expenses": "단기미지급비용",
	"shortterm_advance_from_customers": "단기선수금",
	"shortterm_availableforsale_financial_assets": "단기매도가능금융자산",
	"shortterm_bonds": "사채",
	"shortterm_borrowings": "단기차입금",
	"shortterm_deposits_provided": "단기보증금",
	"shortterm_derivative_assets": "단기파생상품자산",
	"shortterm_derivative_liabilities": "단기파생상품부채",
	"shortterm_financial_assets_at_fair_value_through_profit_or_loss": "유동당기손익인식지정금융자산",
	"shortterm_financial_assets_measured_at_fair_value_through_other_comprehensive_income": "유동기타포괄손익공정가치금융자산",
	"shortterm_financial_instruments": "단기금융상품",
	"shortterm_financial_liabilities": "유동금융부채",
	"shortterm_held_to_maturity_investments": "단기만기보유금융자산",
	"shortterm_investment_assets": "단기투자자산",
	"shortterm_loans": "단기대여금",
	"shortterm_other_receivables": "단기미수금",
	"shortterm_prepaid_expenses": "단기선급비용",
	"shortterm_trade_and_other_current_payables": "단기매입채무및기타유동채무",
	"shortterm_trading_financial_assets": "단기매매금융자산",
	"shortterm_trading_financial_liabilities": "단기매매금융부채",
	"software": "컴퓨터소프트웨어",
	"stock_compensation": "주식기준보상비용",
	"stock_compensation_expense": "주식보상비용(배분)",
	"stock_compensation_expenses": "주식보상비용",
	"stock_dividends": "배당금수익",
	"stock_issuance": "주식발행",
	"stock_options": "주식매수선택권",
	"stock_repurchase": "자사주매입",
	"stockholders_equity": "자본총계",
	"structures": "구축물",
	"supplies": "소모품비",
	"suppliesconsumables": "저장품(소모품)",
	"tangible_assets": "유형자산",
	"tax_on_items_not_reclassified_to_profit_or_loss": "당기손익으로재분류되지않는항목과관련된법인세",
	"tax_on_items_reclassified_to_profit_or_loss": "당기손익으로재분류될수있는항목과관련된법인세",
	"taxes_and_dues": "세금과공과",
	"tools_and_office_equipment": "공구기구비품",
	"total_assets": "자산총계",
	"total_comprehensive_income": "총포괄이익",
	"total_comprehensive_income_from_continuing_operations_owners_of_parent": "지배기업의소유주에게귀속되는계속영업포괄손익",
	"total_comprehensive_income_from_discontinued_operations_owners_of_parent": "지배기업의소유주에게귀속되는중단영업포괄손익",
	"total_comprehensive_income_owners_of_parent": "총포괄손익,지배기업의소유주에게귀속되는지분",
	"total_liabilities": "부채총계",
	"total_liabilities_and_equity": "자본과부채총계",
	"total_other_comprehensive_income": "기타포괄손익 합계",
	"total_stockholders_equity": "자본총계",
	"trade_and_other_current_payables": "매입채무및기타채무",
	"trade_and_other_current_receivables": "매출채권및기타채권",
	"trade_and_other_noncurrent_receivables": "장기매출채권및기타채권",
	"trade_and_other_payables": "매입채무및기타채무",
	"trade_and_other_receivables": "매출채권및기타채권",
	"trade_payables": "매입채무",
	"trade_receivables": "매출채권",
	"training_expenses": "교육훈련비",
	"transfer_to_assets_held_for_sale": "매각예정자산대체",
	"transportation_expenses": "운반비",
	"traveling_expenses": "여비교통비",
	"treasury_stock": "자기주식",
	"unappropriated_retained_earnings_deficit": "미처분이익잉여금(결손금)",
	"unearned_income": "선수수익",
	"vehicle_maintenance_expenses": "차량유지비",
	"voluntary_reserves": "임의적립금",
	"water_light_and_heating_expenses": "수도광열비",
	"withholdings": "예수금",
	"work_in_process": "재공품"
} as const;
...
export const FINANCE_ACCOUNT_ID_ALIAS = {
	"AdjustmentsForInterestExpense": "finance_costs",

"""story builders.py 단위 테스트 — 합성 데이터로 빌더 함수 검증.
...
class TestProfileBlock:
    def test_empty_data(self):
        from dartlab.story.builders import profileBlock
...
class TestMarginTrendBlock:
    def test_empty_data(self):
        from dartlab.story.builders import marginTrendBlock
...
class TestReturnTrendBlock:
    def test_empty_data(self):
        from dartlab.story.builders import returnTrendBlock
...
class TestGrowthTrendBlock:
    def test_empty_data(self):
        from dartlab.story.builders import growthTrendBlock
...
class TestLeverageTrendBlock:
    def test_empty_data(self):
        from dartlab.story.builders import leverageTrendBlock
...
class TestCashFlowOverviewBlock:
    def test_empty_data(self):
        from dartlab.story.builders import cashFlowOverviewBlock
...
class TestDividendPolicyBlock:
    def test_empty_data(self):
        from dartlab.story.builders import dividendPolicyBlock
...
class TestScorecardBlock:
    def test_empty_data(self):
        from dartlab.story.builders import scorecardBlock
...
class TestCreditMetricsBlock:
    def test_empty_data(self):
        from dartlab.story.builders import creditMetricsBlock
...
class TestTechnicalVerdictBlock:
    def test_empty_data(self):
        from dartlab.story.builders import technicalVerdictBlock
...
class TestFlagsBuilders:
    def test_revenue_flags_empty(self):
        from dartlab.story.builders import revenueFlagsBlock
    ...
    def test_profitability_flags(self, block_types):
        from dartlab.story.builders import profitabilityFlagsBlock
    ...
    def test_capital_flags_empty(self):
        from dartlab.story.builders import capitalFlagsBlock

        assert capitalFlagsBlock([]) == []

    def test_credit_flags_with_warnings_and_opportunities(self, block_types):
        from dartlab.story.builders import creditFlagsBlock
    ...
    def test_growth_flags(self, block_types):
        from dartlab.story.builders import growthFlagsBlock
    ...
    def test_stability_flags(self, block_types):
        from dartlab.story.builders import stabilityFlagsBlock
    ...
    def test_efficiency_flags(self, block_types):
        from dartlab.story.builders import efficiencyFlagsBlock
    ...
    def test_asset_flags(self, block_types):
        from dartlab.story.builders import assetFlagsBlock
    ...
    def test_cost_structure_flags(self, block_types):
        from dartlab.story.builders import costStructureFlagsBlock
    ...
    def test_capital_allocation_flags(self, block_types):
        from dartlab.story.builders import capitalAllocationFlagsBlock
    ...
    def test_investment_flags(self, block_types):
        from dartlab.story.builders import investmentFlagsBlock
    ...
    def test_cross_statement_flags(self, block_types):
        from dartlab.story.builders import crossStatementFlagsBlock
    ...
    def test_summary_flags(self, block_types):
        from dartlab.story.builders import summaryFlagsBlock
    ...
    def test_cash_flow_flags(self, block_types):
        from dartlab.story.builders import cashFlowFlagsBlock
    ...
    def test_governance_flags_empty(self):
        from dartlab.story.builders import governanceFlagsBlock
    ...
    def test_disclosure_delta_flags(self, block_types):
        from dartlab.story.builders import disclosureDeltaFlagsBlock
    ...
    def test_peer_benchmark_flags_empty(self):
        from dartlab.story.builders import peerBenchmarkFlagsBlock
...
class TestHelpers:
    def test_extractSeries_from_history(self):
        from dartlab.story.builders import _extractSeries
    ...
    def test_timelineTable_empty(self):
        from dartlab.story.builders import _timelineTable
    ...
    def test_flagsBlock_positive_keyword_classification(self, block_types):
        from dartlab.story.builders import _flagsBlock
    ...
    def test_fmtAmtShort_krw(self):
        from dartlab.story.builders import _fmtAmtShort
...
class TestAdditionalBuilders:
    def test_piotroskiBlock(self, block_types):
        from dartlab.story.builders import piotroskiBlock
    ...
    def test_concentrationBlock(self, block_types):
        from dartlab.story.builders import concentrationBlock
    ...
    def test_segmentCompositionBlock(self, block_types):
        from dartlab.story.builders import segmentCompositionBlock
...
class TestEnrichedFlagsBlock:
    def test_empty_flags(self):
        from dartlab.story.builders import _enrichedFlagsBlock
...
class TestNotesDetailBlocks:
    def test_empty(self):
        from dartlab.story.builders import _notesDetailBlocks
...
class TestSegmentTrendBlock:
    def test_empty_data(self):
        from dartlab.story.builders import segmentTrendBlock
...
class TestBreakdownBlock:
    def test_empty_data(self):
        from dartlab.story.builders import breakdownBlock
...
class TestRevenueGrowthBlock:
    def test_empty_data(self):
        from dartlab.story.builders import revenueGrowthBlock
...
class TestRevenueQualityBlock:
    def test_empty_data(self):
        from dartlab.story.builders import revenueQualityBlock
...
class TestGrowthContributionBlock:
    def test_empty_data(self):
        from dartlab.story.builders import growthContributionBlock
...
class TestFundingBuilders:
    def test_fundingSourcesBlock_empty(self):
        from dartlab.story.builders import fundingSourcesBlock
    ...
    def test_capitalOverviewBlock_empty(self):
        from dartlab.story.builders import capitalOverviewBlock
    ...
    def test_interestBurdenBlock_empty(self):
        from dartlab.story.builders import interestBurdenBlock
    ...
    def test_liquidityBlock_empty(self):
        from dartlab.story.builders import liquidityBlock
    ...
    def test_distressBlock_empty(self):
        from dartlab.story.builders import distressBlock
...
class TestCashFlowBlock:
    def test_empty_data(self):
        from dartlab.story.builders import cashFlowBlock
...
class TestEarningsQualityBuilders:
    def test_accrualAnalysisBlock_empty(self):
        from dartlab.story.builders import accrualAnalysisBlock
    ...
    def test_earningsPersistenceBlock_empty(self):
        from dartlab.story.builders import earningsPersistenceBlock
    ...
    def test_beneishMScoreBlock_empty(self):
        from dartlab.story.builders import beneishMScoreBlock
    ...
    def test_earningsQualityFlagsBlock_dict_format(self, block_types):
        from dartlab.story.builders import earningsQualityFlagsBlock
...
class TestCostStructureBuilders:
    def test_costBreakdownBlock_empty(self):
        from dartlab.story.builders import costBreakdownBlock
    ...
    def test_operatingLeverageBlock_empty(self):
        from dartlab.story.builders import operatingLeverageBlock
...
class TestValuationBuilders:
    def test_dcfValuationBlock_empty(self):
        from dartlab.story.builders import dcfValuationBlock
    ...
    def test_ddmValuationBlock_na(self, block_types):
        from dartlab.story.builders import ddmValuationBlock
    ...
    def test_relativeValuationBlock_empty(self):
        from dartlab.story.builders import relativeValuationBlock
...
class TestResearchBuilders:
    def test_penmanDecompositionBlock_empty(self):
        from dartlab.story.builders import penmanDecompositionBlock
    ...
    def test_roicTreeBlock_empty(self):
        from dartlab.story.builders import roicTreeBlock
    ...
    def test_ocfDecompositionBlock_empty(self):
        from dartlab.story.builders import ocfDecompositionBlock
...
class TestAssetStructureBlock:
    def test_empty_data(self):
        from dartlab.story.builders import assetStructureBlock
...
class TestWorkingCapitalBlock:
    def test_empty_data(self):
        from dartlab.story.builders import workingCapitalBlock
...
class TestDupontBlock:
    def test_empty_data(self):
        from dartlab.story.builders import dupontBlock
...
class TestCapitalAllocationBuilders:
    def test_shareholderReturnBlock_empty(self):
        from dartlab.story.builders import shareholderReturnBlock

        assert shareholderReturnBlock({}) == []

    def test_reinvestmentBlock_empty(self):
        from dartlab.story.builders import reinvestmentBlock

        assert reinvestmentBlock({}) == []

    def test_fcfUsageBlock_empty(self):
        from dartlab.story.builders import fcfUsageBlock
...
class TestInvestmentEfficiencyBuilders:
    def test_roicTimelineBlock_empty(self):
        from dartlab.story.builders import roicTimelineBlock

        assert roicTimelineBlock({}) == []

    def test_investmentIntensityBlock_empty(self):
        from dartlab.story.builders import investmentIntensityBlock

        assert investmentIntensityBlock({}) == []

    def test_evaTimelineBlock_empty(self):
        from dartlab.story.builders import evaTimelineBlock
...
class TestFinancialConsistencyBuilders:
    def test_isCfDivergenceBlock_empty(self):
        from dartlab.story.builders import isCfDivergenceBlock

        assert isCfDivergenceBlock({}) == []

    def test_isBsDivergenceBlock_empty(self):
        from dartlab.story.builders import isBsDivergenceBlock

        assert isBsDivergenceBlock({}) == []

    def test_anomalyScoreBlock_empty(self):
        from dartlab.story.builders import anomalyScoreBlock

        assert anomalyScoreBlock({}) == []

    def test_effectiveTaxRateBlock_empty(self):
        from dartlab.story.builders import effectiveTaxRateBlock

        assert effectiveTaxRateBlock({}) == []

    def test_deferredTaxBlock_empty(self):
        from dartlab.story.builders import deferredTaxBlock
...
class TestPeerBenchmarkBuilders:
    def test_peerRankingBlock_empty(self):
        from dartlab.story.builders import peerRankingBlock

        assert peerRankingBlock({}) == []

    def test_riskReturnPositionBlock_empty(self):
        from dartlab.story.builders import riskReturnPositionBlock
...
class TestForecastBuilders:
    def test_revenueForecastBlock_empty(self):
        from dartlab.story.builders import revenueForecastBlock

        assert revenueForecastBlock({}) == []

    def test_segmentForecastBlock_empty(self):
        from dartlab.story.builders import segmentForecastBlock

        assert segmentForecastBlock({}) == []

    def test_forecastMethodologyBlock_empty(self):
        from dartlab.story.builders import forecastMethodologyBlock

        assert forecastMethodologyBlock({}) == []

    def test_forecastFlagsBlock_empty(self):
        from dartlab.story.builders import forecastFlagsBlock
...
class TestMarketAnalysisBuilders:
    def test_technicalSignalsBlock_empty(self):
        from dartlab.story.builders import technicalSignalsBlock

        assert technicalSignalsBlock({}) == []

    def test_marketBetaBlock_empty(self):
        from dartlab.story.builders import marketBetaBlock

        assert marketBetaBlock({}) == []

    def test_fundamentalDivergenceBlock_empty(self):
        from dartlab.story.builders import fundamentalDivergenceBlock
    ...
    def test_marketAnalysisFlagsBlock_empty(self):
        from dartlab.story.builders import marketAnalysisFlagsBlock

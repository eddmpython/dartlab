...
def test_views_periodOrderValue():
    from dartlab.engines.edgar.docs.sections.views import _periodOrderValue
...
def test_views_buildMarkdownWide_empty():
    from dartlab.engines.edgar.docs.sections.views import buildMarkdownWide
...
def test_splitText_short():
    from dartlab.engines.edgar.docs.sections.views import _splitText
...
def test_splitTable_short():
    from dartlab.engines.edgar.docs.sections.views import _splitTable
...
def test_retrievalBlocks_returns_none_without_data(monkeypatch):
    ...
    from dartlab.engines.edgar.docs.sections import pipeline as _pipeline_mod
    from dartlab.engines.edgar.docs.sections import views as _views_mod

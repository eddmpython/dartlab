...
U0-G02에서 exact-locator machine review queue 600행을 만들었지만 전부 미검토이며 goldEligible은 false다. Reviewed positive 300개와 hard negative 300개 및 prediction을 구성해 precision 98% 및 false accept 1% gate를 실행해야 한다. U0-V01과 U0-V04 participant review 및 U0-V05 named screen reader 수동 확인 전 production 이관은 불가하다.

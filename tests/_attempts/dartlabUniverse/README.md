...
| U0-G03 original source binding | Machine review queue 600행과 local DART original Parquet | source artifact 305개 SHA-256, exact original occurrence 63,345개. Binding ready 600/600, unique 119, ambiguous 481, source row missing 0, locator parity failure 0 | Original artifact provenance promote. Human locator 선택, predicate/direction 및 time 전 gold 승격 차단 |

...
from dartlab.data.compositePaging import _decodeEagerResult
...
def _descriptor(attribute: str = "_fixtureFrame") -> DataAssetDescriptor:
    return DataAssetDescriptor(
        ...
        owner="tests.data.test_eagerSupervisor",
        layer="L2",
        kind="computed",
        label="Eager supervisor fixture",
        description="Fixture-only eager process",
        sourceRef=f"python:tests.data.test_eagerSupervisor:{attribute}",
        queryable=True,
        executorKind="callable",
        executorModule="tests.data.test_eagerSupervisor",

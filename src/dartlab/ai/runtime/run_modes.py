...
def _run_light_mode(
    ...
    *,
    ...
    # insights 등급 1줄 요약
    try:
        from dartlab.analysis.financial.insight.pipeline import analyze as _light_analyze
...
def _run_guided_json(
    ...
    from dartlab.ai.conversation.prompts import guided_json_to_markdown
    from dartlab.ai.conversation.templates.self_critique import GUIDED_SCHEMA
...
def _run_agent(
    ...
    *,
    ...
    from dartlab.ai.runtime.agent import agent_loop_stream, build_agent_system_addition

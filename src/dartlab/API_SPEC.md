...
| `profitBeforeTax` | `Optional` | None |
| `incomeTaxExpense` | `Optional` | None |
...
| `fixedAssetTurnover` | `Optional` | None |
| `inventoryTurnover` | `Optional` | None |
| `receivablesTurnover` | `Optional` | None |
| `payablesTurnover` | `Optional` | None |
| `operatingCycle` | `Optional` | None |
| `fcf` | `Optional` | None |
| `operatingCfMargin` | `Optional` | None |
| `operatingCfToNetIncome` | `Optional` | None |
| `operatingCfToCurrentLiab` | `Optional` | None |
| `capexRatio` | `Optional` | None |
| `dividendPayoutRatio` | `Optional` | None |
| `fcfToOcfRatio` | `Optional` | None |
| `roic` | `Optional` | None |
| `dupontMargin` | `Optional` | None |
| `dupontTurnover` | `Optional` | None |
| `dupontLeverage` | `Optional` | None |
| `debtToEbitda` | `Optional` | None |
| `ccc` | `Optional` | None |
| `dso` | `Optional` | None |
| `dio` | `Optional` | None |
| `dpo` | `Optional` | None |

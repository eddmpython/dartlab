...
from dartlab.data.continuation import ArrowPayloadFacts
from dartlab.data.contracts import DataAssetDescriptor, DataQuery, UniverseSelection
...
_OUTER_METADATA = {b"dartlab.data.owner-page": b"v1"}

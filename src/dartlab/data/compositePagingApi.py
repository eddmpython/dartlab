...
from dartlab.data.compositePagingSchedule import _materializeComposite, _outerPins
...
from dartlab.data.continuation import ContinuationError, ContinuationQueryState, canonicalDigest
from dartlab.data.contracts import AssetRef, DataAssetDescriptor, DataQuery, DataResult
...
def _defaultAdapters() -> _AdapterProtocol:
    ...
    import dartlab.data.compositePaging as facade

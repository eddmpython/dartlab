...
from dartlab.data.contracts import AssetRef, DataResult
...
def iterDataResultPages(
    ...
    *,
    ...
    Capabilities:
        초기 page를 즉시 yield하고 다음 page가 요구될 때만 ``dartlab.data("query")``를 호출한다.
    ...
    Args:
        ...
        queryCaller: token 하나만 받는 resume seam. None이면 public ``dartlab.data``를 사용한다.

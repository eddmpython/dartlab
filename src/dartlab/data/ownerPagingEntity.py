...
from dartlab.data.contracts import DataAssetDescriptor
...
from dartlab.data.ownerPagingPayload import _framePayload
from dartlab.data.ownerPagingState import _requestedMeasures
from dartlab.data.pagingRuntime import manifestCachePath, requireDeadline
from dartlab.data.projections import projectOutput


def _requestRef(task: _OwnerTask, entityId: str) -> str:
    from dartlab.data.execution import _requestRef as requestRef

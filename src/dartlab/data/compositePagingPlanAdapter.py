...
from dartlab.data.continuation import ContinuationError, arrowSchemaDigest, canonicalDigest
from dartlab.data.contracts import DataAssetDescriptor, DataQuery, ResourceProjection
from dartlab.data.pagingRuntime import MAX_PAGE_BYTES, MAX_PAGE_ROWS, requireDeadline
...
class CompositePlanAdapterMixin:
    ...
    def plan(
        ...
        *,
        ...
        resource = importlib.import_module("dartlab.data.resourcePaging")
    ...
    def _planEager(
        ...
        *,
        ...
        if safeLocator:
            ...
            supervisor = importlib.import_module("dartlab.data.eagerSupervisor")

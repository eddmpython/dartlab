...
_AXIS_REGISTRY: dict[str, _AxisEntry] = {
    ...
    "altman": _AxisEntry(
        ...
        fn="calcAltmanFactor",
        label="Altman Z",
        description="비금융 전종목 Altman Z'' 부실위험 판별 점수 + 적용성·입력 coverage",
    ...
    "beneish": _AxisEntry(
        ...
        label="Beneish M (비발행)",
        description="원식 계정의 공급자 공통 의미가 없어 점수 대신 structured unavailable 반환",
    ...
    "strategy": _AxisEntry(
        ...
        fn="runStrategy",
        label="전략",
        description="사용자 정의 boolean Rule 백테스트 (진입시 고정 sizing + stop)",
    ...
    "multi": _AxisEntry(
        ...
        fn="runMultiAsset",
        label="멀티자산",
        description="같은 시장·기간의 초기 동일자본 strategy sleeve 백테스트",

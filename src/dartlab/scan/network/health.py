...
Example::
    ...
    from dartlab.scan.network.health import groupHealth
...
def groupHealth(*, verbose: bool = True) -> tuple[pl.DataFrame, pl.DataFrame]:
    ...
    """
    from dartlab.scan.network import build_graph
    from dartlab.scan.screen.screen import _ensureMarketRatios

...
from dartlab.providers.dart.docs.finance.companyOverviewDetail.parser import parseCompanyInfo
from dartlab.providers.dart.docs.finance.companyOverviewDetail.types import CompanyOverviewDetailResult

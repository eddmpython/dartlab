...
from dartlab.providers.dart.docs.finance.internalControl.parser import (
    extractTableBlocks,
    parseInternalControlTable,
)
from dartlab.providers.dart.docs.finance.internalControl.types import InternalControlResult

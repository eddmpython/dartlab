...
from dartlab.providers.dart.docs.finance.dividend.parser import parseDividendTable
from dartlab.providers.dart.docs.finance.dividend.types import DividendResult

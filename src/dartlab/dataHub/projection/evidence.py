...
from dartlab.dataHub.contracts import DataAssetDescriptor, DataLineage, DataQuery, QualityAssertion
...
def lineageFacet(descriptor: DataAssetDescriptor, receiptRef: str) -> DataLineage:
    ...
    return DataLineage(
        runId=receiptRef,
        jobName=f"dartlab.dataHub.{descriptor.owner}.{descriptor.executorAxis or descriptor.assetId}",

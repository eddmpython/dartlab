"""DataHub pageable owner가 공유하는 continuation runtime."""
...
def dataHubRoot() -> Path:
    ...
    Returns:
        ``DARTLAB_HOME`` 아래의 absolute private DataHub 경로.
    ...
    return Path(os.path.abspath(home / "dataHub"))
...
def manifestCachePath(
    ...
    *,
    ...
    from dartlab.dataHub.continuation import canonicalDigest

    root = dataHubRoot() / "manifest-cache"
...
def ownerProcessArtifactRoot() -> Path:
    ...
    return dataHubRoot() / "continuations" / "owner-process"

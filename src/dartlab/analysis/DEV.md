...
| 2-1 | 수익성 | 4 | strategy/profitability.py | 구현 완료 |
| 2-2 | 성장성 | 3 | strategy/growthAnalysis.py | 구현 완료 |
| 2-3 | 안정성 | 4 | strategy/stability.py | 구현 완료 |
...
```
scan()       시장 전체 횡단 (12축)     -- 종목 간 비교/스크리닝

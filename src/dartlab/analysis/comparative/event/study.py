...
사용법::
    ...
    from dartlab.analysis.comparative.event.study import analyze_events
...
from dartlab.analysis.comparative.event.types import (
    EventImpact,
    EventStudyResult,
    EventWindow,
)
...
def analyze_events(
    ...
    *,
    ...
    from dartlab.analysis.comparative.event.price import get_market_returns, get_prices

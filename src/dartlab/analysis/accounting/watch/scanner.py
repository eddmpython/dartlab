...
사용법::
    ...
    from dartlab.analysis.accounting.watch.scanner import scan_company, scan_market
...
from dartlab.analysis.accounting.watch.scorer import ScoredChange, score_changes, scored_to_dataframe

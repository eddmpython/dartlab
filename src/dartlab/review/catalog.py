...
SECTIONS: list[SectionMeta] = [
    ...
    SectionMeta("성장성", "2-2", "성장성 -- 얼마나 빨리 성장하는가"),
    # ── Q3. 남은 돈이 현금으로 들어오는가? ──
    SectionMeta("현금흐름", "3", "현금흐름 -- 남은 돈이 현금으로 들어오는가"),
    SectionMeta("이익품질", "3-2", "이익의 질 -- 이익이 진짜인가"),
    # ── Q4. 돈의 출처와 구조는 건전한가? ──
    SectionMeta("자금조달", "4", "자본/부채 -- 돈의 출처와 구조는 건전한가"),
    SectionMeta("안정성", "4-2", "안정성 -- 망하지 않는가"),
    # ── Q5. 자산을 효율적으로 쓰고 있는가? ──
    SectionMeta("자산구조", "5", "자산/효율 -- 자산을 효율적으로 쓰고 있는가"),
    SectionMeta("효율성", "5-2", "효율성 -- 자산을 잘 굴리는가"),
    SectionMeta("투자효율", "5-3", "투자 효율 -- 투자가 가치를 만드는가"),
    # ── Q6. 비용은 어떻게 쓰는가? ──
    SectionMeta("비용구조", "6", "비용 구조 -- 비용이 어떻게 움직이는가"),
    SectionMeta("자본배분", "6-2", "자본 배분 -- 번 돈을 어디에 쓰는가"),
    # ── Q7. 숫자를 종합하면? ──
    SectionMeta("종합평가", "7", "종합 평가 -- 재무 상태를 한마디로"),
    SectionMeta("재무정합성", "7-2", "재무 정합성 -- 재무제표가 서로 맞는가"),
    # ── Q8. 얼마의 가치인가? ──
    SectionMeta("가치평가", "8", "가치평가 -- 이 회사의 적정 가치는 얼마인가"),
    # ── Q9. 신뢰할 수 있는가? ──
    SectionMeta("지배구조", "9", "지배구조 -- 이 회사의 주인은 누구이며 감시는 작동하는가"),
    SectionMeta("공시변화", "9-2", "공시변화 -- 이 회사의 공시가 뭐가 달라졌는가"),
    SectionMeta("비교분석", "9-3", "비교분석 -- 이 회사는 시장에서 어디에 서 있는가"),
    # ── Q10. 앞으로 어떻게 될 것인가? ──
    SectionMeta("매출전망", "10", "매출 전망 -- 이 회사의 매출은 어디로 가는가"),
]

...
SIMPLE: dict[str, str] = {
    ...
    "edgar:bulk_download_start": "SEC EDGAR 재무 데이터 전체 다운로드 중 (~1.37GB, 최초 1회 5~15분). companyfacts.zip",
    "edgar:bulk_download_done": "\u2713 companyfacts.zip 다운로드 완료 ({sizeMB:.0f}MB, {elapsedSec:.0f}s)",
    "edgar:bulk_convert_start": "companyfacts.zip \u2192 종목별 parquet 변환 중 (수 분 소요). {totalCiks}개 기업",
    ...
    "edgar:bulk_quarterly_start": "SEC 분기 메타 벌크 다운로드 중 ({year}Q{quarter}, {sizeMB:.0f}MB)",

...
CAPABILITIES: dict[str, dict] = {
    ...
    "Company": {"kind": "function", "summary": "종목코드/회사명/ticker → 적절한 Company 인스턴스 생성."},
    "Company.BS": {
    ...
    "Company.currency": {"kind": "property", "summary": "통화 코드 (DART 제공자는 항상 KRW)."},
    "Company.debt": {
    ...
    "Company.getRatios": {"kind": "method", "summary": "Deprecated — use ``c.ratios`` property instead."},
    ...
    "Company.market": {"kind": "property", "summary": "시장 코드 (DART 제공자는 항상 KR)."},
    "Company.network": {
    ...
    "Company.sce": {"kind": "property", "summary": "자본변동표 DataFrame (연결 기준)."},
    "Company.sceMatrix": {
    ...
    "Review": {"kind": "class", "summary": "분석 리뷰 — AnalysisReport + core/Report 통합."},
    ...
    "fuzzySearch": {"kind": "function", "summary": "한글 fuzzy 종목 검색 — 초성 매칭 + Levenshtein 거리."},
    "gather": {
    ...
    "getKindList": {"kind": "function", "summary": "KRX KIND 상장법인 전체 목록."},
    "governance": {
    ...
    "llm": {"kind": "module", "summary": "LLM 기반 기업분석 엔진."},
    ...
    "searchName": {"kind": "function", "summary": "회사명 부분 검색."},
    "setup": {
    ...
    "text": {"kind": "module", "summary": "텍스트 분석 도구."},
    "valuation": {

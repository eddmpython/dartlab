...
from dartlab.engines.dart.docs.finance.investmentInOther.parser import parseInvestments
from dartlab.engines.dart.docs.finance.investmentInOther.types import InvestmentInOtherResult

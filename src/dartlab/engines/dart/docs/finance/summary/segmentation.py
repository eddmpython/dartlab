from dartlab.engines.dart.docs.finance.summary.constants import BREAKPOINT_THRESHOLD
from dartlab.engines.dart.docs.finance.summary.types import BridgeResult, Segment

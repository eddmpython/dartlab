...
사용법::
    ...
    from dartlab.engines.dart.openapi.collector import DocsCollector

    collector = DocsCollector("005930")
    collector.collect(quarters=8)

    # 여러 종목
    from dartlab.engines.dart.openapi.collector import collectMultiple
...
from dartlab.engines.dart.openapi.corpCode import findCorpCode, loadCorpCodes
from dartlab.engines.dart.openapi.disclosure import listFilings

...
def registerOpenapiTool(registerTool: Callable) -> None:
    ...
    def _dartCall(endpoint: str = "", params: str = "", **_kw) -> str:
        ...
        try:
            from dartlab.engines.company.dart.openapi.dart import callEndpoint
    ...
    def _searchFilings(keyword: str = "", **_kw) -> str:
        ...
        try:
            from dartlab.engines.company.dart.openapi.dart import searchFilings
    ...
    def _capabilities(**_kw) -> str:
        try:
            from dartlab.engines.company.dart.openapi.dart import getCapabilities

...
def _get_coding_runtime_policy() -> tuple[bool, str]:
...
def _build_runtime_capabilities_markdown(company: Any | None = None) -> str:
    ...
    coding_runtime_enabled, coding_runtime_reason = _get_coding_runtime_policy()
...
def _build_coding_runtime_markdown() -> str:
    ...
    enabled, reason = _get_coding_runtime_policy()
...
def register_defaults(company: Any | None = None, *, runtime: ToolRuntime | None = None) -> ToolRuntime:
    ...
    coding_runtime_enabled, _ = _get_coding_runtime_policy()
    if coding_runtime_enabled:

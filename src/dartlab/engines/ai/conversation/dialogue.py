...
_CODING_KEYWORDS = (
    "코드", "버그", "에러", "리팩터", "리팩토링", "파일", "함수",
    "테스트", "구현", "수정", "patch", "diff", "workspace", "cli", "codex",
)
_EXPLORE_KEYWORDS = (
    "어떤 데이터", "무슨 데이터", "뭘 볼 수", "뭐가 있어", "어떤 기능",
    "가능한 것", "가능한거", "범위", "얼마나", "더 받을 수", "추가 수집", "openapi",
)
_FOLLOW_UP_PREFIXES = ("그럼", "그러면", "이건", "이거", "그거", "왜", "어째서", "더", "계속", "이어")

_VIEWER_INTENT_KEYWORDS = (
    "보여줘", "보여 줘", "보여주세요", "열어줘", "열어 줘",
    "공시 보기", "공시 열기", "원문 보기", "원문 보여",
    "sections 보여", "section 보여", "show me", "open viewer",
)

...
_META_KEYWORDS = frozenset(
    {
        ...
        "뭘할수있", "뭐할수있", "뭘 할 수", "뭐 할 수", "할수있",
        "기능", "데이터", "몇개", "몇 개", "개수", "목록", "리스트", "상태",
        "원본", "raw", "모듈", "module", "다운로드", "설치", "업데이트",
        "안녕", "반가", "고마", "안녕하세요", "hello", "hi", "thanks",
        "어떻게", "how", "what", "why", "설정", "config", "provider",
        "모델", "ollama", "문서", "docs", "파일", "저장",
        "opendart", "openedgar", "openapi", "api", "dart api", "edgar api",
        "엔진", "engine", "spec", "스펙", "tool", "도구", "런타임", "runtime",
        "codex", "gpt", "claude", "mcp", "서버", "server", "종목검색", "search",
    }
)
...
_SYSTEM_ENTITIES = frozenset(
    {
        "opendart", "openedgar", "dartlab", "dart api", "edgar api",
        "openapi", "dart 시스템", "edgar 시스템",
        "mcp", "codex", "claude", "gpt", "ollama",
    }
)
...
_PURE_CONVERSATION_TOKENS = frozenset(
    {
        ...
        "좋아", "오키", "ok", "yes", "no", "yeah",
        "알겠어", "그렇구나", "아하", "오", "와", "ㅠㅠ", "ㅜㅜ", "ㄴㄴ",
        "아니", "됐어",
    }
)

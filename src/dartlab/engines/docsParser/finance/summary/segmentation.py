from dartlab.engines.docsParser.finance.summary.constants import BREAKPOINT_THRESHOLD
from dartlab.engines.docsParser.finance.summary.types import BridgeResult, Segment

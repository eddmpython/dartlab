...
from dartlab.engines.supply.types import SupplyChainResult, SupplyLink
...
def analyze_supply_chain(company: object) -> SupplyChainResult | None:
    ...
    """
    from dartlab.engines.supply.extractor import extract_supply_links
    ...
    # 기업명 → 종목코드 매칭 시도
    try:
        from dartlab.engines.supply.mapper import resolve_links

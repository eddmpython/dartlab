...
사용법::
    ...
    from dartlab.engines.analysis.watch.scanner import scan_company, scan_market
...
from dartlab.engines.analysis.watch.scorer import ScoredChange, score_changes, scored_to_dataframe
from dartlab.engines.common.docs.diff import DiffResult, sectionsDiff
...
def _filter_by_sector(codes: list[str], sector: str) -> list[str]:
    ...
    try:
        ...
        for code in codes:
            try:
                from dartlab.engines.gather.listing import codeToName

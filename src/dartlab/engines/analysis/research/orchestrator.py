...
from dartlab.engines.analysis.research.quality import calcCoverageScore
from dartlab.engines.analysis.research.scoring import calcAllScores
from dartlab.engines.analysis.research.thesis import classifyProfile, synthesizeThesis
...
def generateResearch(
    ...
    *,
    ...
    if aSeries and (wantAll or want & {"narrative", "thesis"}):
        try:
            from dartlab.engines.analysis.insight.benchmark import getBenchmark
            from dartlab.engines.analysis.research.narrative import buildNarrative
...
def _buildSectorKpis(company: object, aSeries: dict, ratios: object) -> object:
    """섹터 KPI 조립."""
    try:
        from dartlab.engines.analysis.research.sectorKpi import calcSectorKpis
...
def _buildPeerAnalysis(
    ...
    try:
        ...
        try:
            from dartlab.engines.analysis.sector.params import SECTOR_PARAMS

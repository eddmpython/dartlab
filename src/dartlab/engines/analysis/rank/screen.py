...
Example::
    ...
    from dartlab.engines.analysis.rank.screen import screen, presets
    df = screen("가치주")
    df = screen("고위험")
...
def screen(preset: str, *, verbose: bool = True) -> pl.DataFrame:
    ...
    Example::
        ...
        from dartlab.engines.analysis.rank.screen import screen
        df = screen("가치주")
    """
...
def screenCustom(
    ...
    *,
    ...
    Example::
        ...
        from dartlab.engines.analysis.rank.screen import screenCustom
        import polars as pl
...
def benchmark(*, verbose: bool = True) -> pl.DataFrame:
    ...
    Example::
        ...
        from dartlab.engines.analysis.rank.screen import benchmark
        bm = benchmark()
    """
    df = _ensureMarketRatios(verbose=verbose)

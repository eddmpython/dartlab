...
사용법::
    ...
    from dartlab.engines.analysis.event.study import analyze_events
...
from dartlab.engines.analysis.event.types import (
    EventImpact,
    EventStudyResult,
    EventWindow,
)
...
def analyze_events(
    ...
    *,
    ...
    from dartlab.engines.analysis.event.price import get_market_returns, get_prices

...
def reportFrameInner(stockCode: str, apiType: str, topic: str, *, raw: bool = False) -> pl.DataFrame | None:
    ...
    from dartlab.engines.company.dart.report.extract import extractClean
...
class _ReportAccessor:
    ...
    def _pivot(self, name: str) -> Any:
        ...
        from dartlab.engines.company.dart.report import (
            pivotAudit,
            pivotDividend,
            pivotEmployee,
            pivotExecutive,
    ...
    def status(self, apiType: str | None = None) -> pl.DataFrame | dict[str, bool]:
        ...
        from dartlab.engines.company.dart.report.types import API_TYPE_LABELS, API_TYPES, PREFERRED_QUARTER

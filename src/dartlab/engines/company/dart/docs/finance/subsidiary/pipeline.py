...
from dartlab.engines.company.dart.docs.finance.subsidiary.parser import parseSubsidiaryTable
from dartlab.engines.company.dart.docs.finance.subsidiary.types import SubsidiaryInvestment, SubsidiaryResult

...
from dartlab.engines.company.dart.docs.finance.tangibleAsset.parser import findMovementTables
from dartlab.engines.company.dart.docs.finance.tangibleAsset.types import TangibleAssetResult, TangibleMovement

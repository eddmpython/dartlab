...
from dartlab.engines.company.dart.docs.finance.internalControl.parser import (
    extractTableBlocks,
    parseInternalControlTable,
)
from dartlab.engines.company.dart.docs.finance.internalControl.types import InternalControlResult

...
def _sceToDataFrame(
    ...
    from dartlab.engines.company.dart.finance.sceMapper import CAUSE_LABELS, DETAIL_LABELS
...
def _financeCisAnnual(stockCode: str, fsDivPref: str = "CFS") -> tuple[dict[str, dict[str, list]], list[str]] | None:
    ...
    from dartlab.engines.company.dart.finance.pivot import _loadAndNormalize

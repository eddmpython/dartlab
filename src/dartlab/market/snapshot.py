...
사용법::
    ...
    from dartlab.market.snapshot import buildScanSnapshot, getScanPosition
...
def buildScanSnapshot(*, verbose: bool = True) -> dict[str, dict]:
    ...
    from dartlab.market.governance.scanner import (
        scan_audit_opinion,
        scan_major_holder_pct,
        scan_outside_directors,
        scan_pay_ratio,
    )
    from dartlab.market.governance.scorer import (
        grade,
        score_audit,
        score_outside_ratio,
        score_ownership,
    ...
    from dartlab.market.workforce.scanner import scan_revenue_per_employee
    ...
    from dartlab.market.capital.scanner import (
        scan_capital_change,
        scan_dividend,
        scan_treasury_stock,
    )
    ...
    if verbose:
        print("  [4/4] debt 스캔...")
    from dartlab.market.debt.risk import classify_risk, scan_icr
    from dartlab.market.debt.scanner import scan_bonds

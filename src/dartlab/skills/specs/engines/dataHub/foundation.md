---
id: engines.dataHub.foundation
title: 데이터 엔진 기본기
kind: curated
scope: builtin
status: unverified
category: engines
purpose: DartLab DataHub 아래에서 Company, gather, scan 원천을 선택하고 수집, prebuild, freshness를 운영하는 기본 절차를 정의한다.
whenToUse:
...
dartlab.dataHub("catalog")                    # L1, L1.5, L2 stable asset 발견

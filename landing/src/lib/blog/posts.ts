...
export const seriesDefinitions = {
	...
	'financial-context': {
		...
		label: '숫자 뒤 맥락 읽기',
		description: '재무제표 숫자만으로 놓치는 사업 맥락과 해석의 함정을 개발비·무형자산, 리스부채, 지분법손익, 영업외손익, 환율·파생, 판관비 구조, 이연법인세, 기타포괄손익 누적, 매각예정자산·중단영업까지 포함해 잡아주는 입문형 시리즈입니다.',
		seoTitle: '숫자 뒤 맥락 읽기 | 재무제표 숫자만 보면 안 되는 이유',
		seoDescription: 'DartLab 숫자 뒤 맥락 읽기 시리즈. 숫자만 보지 않고 사업보고서, 신규사업, 개발비·무형자산, 리스부채, 지분법손익, 영업외손익, 환율·파생, 판관비 구조, 이연법인세, 기타포괄손익, 매각예정자산·중단영업 같은 공시 문맥을 함께 읽는 기초 글을 모았습니다.',
		brandMessage: 'DartLab은 숫자가 맞는지보다, 그 숫자가 왜 그렇게 나왔는지와 어떤 기대, 부채, 비본업 손익, 환율 효과, 세금 시차, OCI 누적, 분류 변화, 비용 구조가 뒤에 숨어 있는지까지 설명되는 분석을 더 중요하게 봅니다.'
	},
	'data-automation': {
		id: 'data-automation',
		label: '공시 데이터 파이프라인',
	...
	'working-capital-and-earnings-quality': {
		...
		label: '재고·채권·이익의 질',
		description: '매출채권, 재고, 매출 인식 시점, 영업현금흐름, 선수금·계약부채, 팩토링·유동화, 공급망금융을 함께 봐서 성장의 질과 회수 구조를 읽는 시리즈입니다.',
		seoTitle: '재고·채권·이익의 질 | 운전자본, 매출 인식, 현금흐름 읽는 법',
		seoDescription: 'DartLab 재고·채권·이익의 질 시리즈. 매출채권, 대손충당금, 재고, 매출 인식 시점, 영업현금흐름, 선수금·계약부채, 팩토링·유동화, 공급망금융을 통해 숫자 뒤 질을 해석합니다.',
		brandMessage: 'DartLab은 이익의 크기보다, 그 이익이 언제 잡혔는지, 실제로 회수되고 지급되는지와 어떤 금융기법 없이도 오래 버틸 수 있는지를 더 중요하게 봅니다.'
	},
	'audit-and-governance-reading': {
		id: 'audit-and-governance-reading',
		label: '감사와 경고 신호',
		description: '감사보고서, KAM, 한정·부적정·의견거절, 우발부채, 지급보증·담보·약정, 내부회계·감사위원회, 적정 의견 아래 위험 신호, 계속기업 관련 불확실성, 차입 약정·기한이익상실 위험, 정정·재감사 신호, 감사보수·비감사보수, 자본잠식·관리종목 신호를 읽는 시리즈입니다.',
		seoTitle: '감사와 경고 신호 | 감사보고서, 비적정 의견, 우발부채 읽는 법',
		seoDescription: 'DartLab 감사와 경고 신호 시리즈. 감사보고서, KAM, 한정·부적정·의견거절, 우발부채, 소송, 지급보증, 담보, 약정, 내부회계, 감사위원회, 계속기업 관련 불확실성, 차입 약정 위반 위험, 정정·재감사 신호, 감사보수·비감사보수, 자본잠식·관리종목 신호처럼 신뢰도 판단에 중요한 문구를 해석하는 글을 모았습니다.',
		brandMessage: 'DartLab은 감사의견 한 줄보다, 비적정 의견의 강도와 근거, 우발부채와 보증·담보 구조, 내부회계와 감독기구, 계속기업 관련 불확실성, 차입 약정과 기한이익상실 가능성, 정정·재감사 신호, 감사보수와 비감사보수의 긴장감, 자본잠식과 관리종목 경고까지 포함해 그 뒤에서 실제로 무엇을 걱정하고 있는지를 보여주는 문구를 더 중요하게 봅니다.'
	},
	...
	'corporate-actions-and-financing': {
		...
		label: '이벤트·자금조달 공시',
		description: '유상증자, 전환사채, 교환사채, 우선주·RCPS, 메자닌 보호조항과 만기연장·조건변경, 리픽싱 이후 실제 전환·오버행, 자기주식, 제3자배정, 최대주주 변경, 합병·분할, 감자·주식병합 같은 기업 이벤트 공시를 실제 판단 흐름으로 읽는 시리즈입니다.',
		seoTitle: '이벤트·자금조달 공시 | 유상증자, CB, 리픽싱 읽는 법',
		seoDescription:
			'DartLab 이벤트·자금조달 공시 시리즈. 유상증자, 전환사채, BW, 교환사채, 우선주, RCPS, 메자닌 보호조항과 만기연장·조건변경, 리픽싱 이후 실제 전환·오버행, 자기주식, 제3자배정, 최대주주 변경, 합병·분할, 감자·주식병합 같은 이벤트 공시를 실제 판단 흐름으로 정리합니다.',
		brandMessage: 'DartLab은 기업 이벤트 공시를 단발 뉴스가 아니라, 희석과 자금조달, 권리 구조, 지배력 변화, 메자닌 보호조항과 조건변경, 실제 전환과 오버행, 주가 착시의 신호로 읽습니다.'
	}
} as const;

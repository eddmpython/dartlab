...
이런 변경이 있었을 때는 전기 재작성 수치만 믿지 말고, 이전 사업보고서의 원본 부문 수치를 직접 가져와서 비교하는 것이 좋다. 통합 전 적자 부문의 규모가 얼마였는지, 통합 후 해당 금액이 어디에 묻혔는지를 추적해야 한다. [영업외손익이 본업을 가릴 때](/blog/non-operating-income-vs-core-earnings)에서 다루는 본업 밖 숫자 분리와 같은 맥락이다.

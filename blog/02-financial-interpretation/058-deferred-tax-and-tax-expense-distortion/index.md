...
그다음에는 원인을 찾아야 한다. 감가상각과 세무상 차이인지, 개발비와 무형자산 인식 차이인지, 평가손실과 충당금 관련 시차인지, 결손금 이월과 세액공제인지에 따라 해석이 달라진다. 그래서 [감가상각 읽는 법](/blog/capacity-utilization-capex), [개발비·무형자산은 어디서 과열 신호가 보이나](/blog/development-costs-and-intangibles), [매출채권과 대손충당금 읽는 법](/blog/receivables-and-allowance) 같은 글과 연결해 원인을 추적하면 좋다.

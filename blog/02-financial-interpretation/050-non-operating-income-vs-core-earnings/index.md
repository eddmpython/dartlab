...
이 글은 영업외손익을 `순이익 -> 영업이익 -> 영업외 항목 분해 -> 현금 여부 -> 다음 기수 반복성` 순서로 읽는 방법을 정리한다. 기본 숫자 분해는 [숫자만 보면 왜 자주 틀리나](/blog/beyond-the-numbers), 현금 검증은 [영업현금흐름이 순이익을 부정할 때](/blog/operating-cash-flow-vs-net-income), 투자손익 분리는 [관계기업·공동기업투자는 본업 숫자를 어떻게 흐리나](/blog/associates-joint-ventures-and-equity-method), 말과 숫자 충돌은 [사업보고서에서 CEO 말보다 숫자가 중요한 순간](/blog/reading-business-reports)과 같이 보면 좋다.

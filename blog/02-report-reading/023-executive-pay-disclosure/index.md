...
DART 화면이 아직 익숙하지 않다면 [`공시를 처음 볼 때 DART에서 어디부터 눌러야 하나`](/blog/where-to-click-first-in-dart)를 먼저 보고, 주총공고 읽는 기준은 [`주주총회소집공고에서 꼭 봐야 할 것은 무엇인가`](/blog/how-to-read-agm-notice)에서 이어서 보면 된다.

...
건설사는 [진행률 기반 수익인식](/blog/order-backlog-vs-cash-flow) 때문에 계약자산/계약부채가 핵심이다. 매출과 현금흐름의 괴리가 크고, [공사손실충당부채](/blog/order-backlog-vs-cash-flow)가 있는지 확인하는 것이 업종 특화 검증이다.

...
dCR-AAA는 [매출 87.7조원 규모]에서 출발하는 [영업이익률 4%의 수익 기반]이 [OCF 3.8조원의 현금창출력]를 유지하게 하고, [부채 부담 없는 순현금 구조]가 등급을 뒷받침하는 구조를 반영한다. 핵심 강점인 채무상환능력, 사업안정성, 공시리스크이 업황 변동 시에도 등급을 방어하는 완충 역할을 한다.

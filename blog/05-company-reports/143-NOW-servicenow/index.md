...
date: 2026-06-20
description: "2026Q1 ServiceNow는 매출 +22%인데 영업이익률은 14.6%→13.3%, 영업현금흐름은 16.7억 달러로 제자리였다. 현금이 먼저 닿는 구조는 남았지만 레버리지는 아직 직선이 아니다."
...
youtubeId: ""
ai:
  verdict: "dartlab 연결(EDGAR, USD) 시계열이 단독으로 증명하는 강사실은 '현금이 이익보다 먼저 닿았다'는 것이다. 2019년 영업이익은 $0.04B로 사실상 본전인데 영업현금흐름은 $1.24B였고, 2025년에도 영업CF($5.44B)는 영업이익($1.82B)의 약 3배다. 2026Q1 SEC 10-Q를 붙이면 결론이 더 정밀해진다. 매출은 $3.77B로 전년 Q1 대비 +22.1%, 영업이익은 $0.503B로 +11.5%였지만 영업이익률은 14.6%에서 13.3%로 내려왔다. 순이익은 $0.469B로 거의 제자리, 영업CF도 $1.670B로 전년 $1.677B와 거의 같았다. 즉 현금이 먼저 닿는 구조는 남았지만, 레버리지가 매 분기 직선으로 확장되는 것은 아니다. RPO $27.7B, 유동 계약부채 $8.03B, 주식보상비 $558M은 SEC 공시의 보조줄이고, 연결 손익이 단독으로 증명하는 것은 '현금 선행 + 이익 추격 + 2026Q1의 속도 조절'이다."
  direction: 상승
  confidence: 높음
  archetype: 성장
...
> **데이터 기준**: 2026-06-20 dartlab 실측 + SEC 2026Q1 10-Q 확인 — ServiceNow(NOW) **연결(EDGAR, USD)** 기준, 연간 표는 2019~2025 분기 합산, 최신 업데이트는 2026Q1 SEC companyfacts/10-Q 기준. 구독(SaaS) 모델·이연수익·RPO(잔여수행의무)·갱신율·주식보상비(SBC)·세그먼트·AI(Now Assist) ACV는 연결 손익에 분해되지 않으므로 SEC 공시로 분리 표기한다.
>
...
![현금이 이익보다 먼저 닿았다 — 영업CF÷영업이익 배수가 9에서 3으로 좁혀진다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/20/2082939e07d45e1ab84a08a2e75aa8d63254cc977627811c10e25d9029cfb03d.svg)
...
있는 그대로의 출발점은 '장부가 본전을 적는 해에도 현금은 매출의 약 36%를 만들었다'는 비대칭 그 자체다. 그 현금이 미리 들어오는 구조 — 과거 분기 체결 구독에서 이연수익으로 인식되고, 클라우드 제공분은 구독기간에 걸쳐 비례 인식된다는 것([SEC Form 10-Q](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000056/now-20260331.htm)) — 은 SEC 공시로 확인한다. 왜 현금이 장부와 무관하게 미리 들어오는가 — 2막.
...
매출 곡선이 한 해도 꺾이지 않고 3.46 / 4.52 / 5.90 / 7.25(2019→2022)로 매끄럽게 **+110%** 오른다는 사실은, 미리 약속된 구독을 기간에 걸쳐 푸는 구조와 양립한다. 그러나 짚어 둘 것은 — 매끄러운 복리 곡선은 '선납 구조'와도, '신규 계약을 잘 따낸 것'과도 똑같이 양립하므로 내부 수치는 메커니즘을 구별해주지 못한다.

구조의 실물 증거 — 계약부채·RPO·갱신율 — 는 연결 손익이 아니라 SEC 공시의 보조줄이다. 2026Q1 10-Q 기준 유동 계약부채는 **$8.030B**, RPO는 **$27.7B**다. 시계열이 단독으로 말하는 것은 '현금이 장부와 다른 궤도로, 끊김 없이 쌓였다'는 형태뿐이다. 이 형태가 3막에서 두 궤도의 기울기 차이로 드러난다.
...
OCF/영업이익 배수가 31 → 9 → 8.4 → 7.8로 단조 감소한다. 그러나 31배는 1막에서 폐기했으니, 더 명확한 진술은 '9배에서 7.8배로의 완만한 축소'다. 핵심은 절대 배수가 아니라 두 시계열의 기울기가 다르다는 것 — 현금은 거의 직선으로 2배, 장부이익은 바닥권에서 미동이다.

![두 궤도, 다른 기울기 — 영업CF는 매끄럽게, GAAP 영업이익은 뒤늦게](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/c1/c1304cd68c212bbc6a414e2eab141782301e2fe87d8744d6213fc0096485104e.svg)
...
매출 2배에도 OPM이 한 자릿수 초반에 눌린 것은 비용이 매출과 거의 비례로 늘었다는 형태다. 그 비용의 비현금 성분 중 하나가 주식보상비(SBC)라는 점은 SEC 공시와 정합하나, 내부 시계열엔 SBC가 보이지 않으므로 '정합'까지만이다. 2026Q1 10-Q의 총 주식보상비는 **$558M**으로 전년 동기 **$470M**보다 늘었고, 두 기간 모두 매출의 **15%**였다.
...
![영업이익 vs 순이익 — 순이익은 영업 외 항목으로 따로 튄다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/52/52e9d403d35d5f983ece2653db94b38729d2e39153a0d54241509c5449382e2c.svg)
...
![운영 레버리지가 장부에서 켜진 자리 — 영업이익 +139% > 매출 +48%](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/31/31460cd2d89ed59c3862aa3d39f2244761941c6457af5dd626ef52a2a84db354.svg)
...
## 2026 Q1 업데이트 — 매출은 뛰었지만 레버리지는 한 박자 쉬었다

2026년 1분기는 이 글의 결론을 더 날카롭게 만든다. 매출은 **$3.770B**로 전년 동기 **$3.088B**보다 **+22.1%** 늘었다. 그런데 영업이익은 **$503M**으로 전년 **$451M** 대비 **+11.5%**에 그쳤고, 영업이익률은 **14.6% → 13.3%**로 내려왔다. 순이익도 **$469M**으로 전년 **$460M**과 거의 같았다.

현금 쪽도 마찬가지다. 영업현금흐름은 **$1.670B**로 전년 **$1.677B**와 사실상 제자리였다. 이것은 "현금이 먼저 닿는 구조가 사라졌다"가 아니라, "그 구조가 매 분기 장부 레버리지로 곧장 번역되지는 않는다"는 뜻이다. 구독 회사의 장점은 선납 현금과 RPO가 미래 매출을 미리 보여준다는 데 있지만, GAAP 영업이익률은 SBC·인건비·판매비의 속도를 같이 맞아야 한다.

보조줄은 여전히 두껍다. RPO는 **$27.7B**, 유동 계약부채는 **$8.030B**다. 같은 분기에 과거 계약부채에서 매출로 인식한 금액은 **$3.2B**였고, 총 SBC는 **$558M**이었다. 그래서 2026Q1의 메시지는 낙관도 비관도 아니다. 현금 선행 구조는 남아 있지만, 장부이익이 그 현금을 따라잡는 속도는 아직 분기별로 울퉁불퉁하다.
...
4. **주식보상비(SBC)·계약부채·RPO** — GAAP 이익을 누르는 비현금·선납 구조. 규모는 SEC 10-Q에서 분리 확인한다.
5. **AI(Now Assist) ACV·자사주·희석 관리** — 성장 동인과 주주 지분 정산. 연결 손익만으로는 분해되지 않는다.

![ServiceNow — 2026년에 봐야 할 다섯 가지](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/ee/ee0ff89a1f71a6787400a4dc574c7b369ec911442017a444c402ce457076249e.svg)
...
|---|---|---|---|
| FY2026 Q1 Form 10-Q | 2026-03-31 | 매출 $3.770B, 영업이익 $503M, 영업CF $1.670B, RPO $27.7B, 유동 계약부채 $8.030B, SBC $558M | [SEC 10-Q](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000056/now-20260331.htm) |
| FY2025 Form 10-K | 2025-12-31 | 2019~2025 장기 성장, 구독 매출 인식 정책, 리스크와 비용 구조 확인 | [SEC 10-K](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000007/now-20251231.htm) |
...
본문 인용 수치를 dartlab 호출과 SEC 공시로 검증한다. 계약부채·RPO·SBC·AI·자사주는 연결 손익이 아니라 SEC 공시 또는 회사 공시에서 분리 확인한다. 📅 dartlab 실측 2026-06-20 · ServiceNow(NOW) 연결(EDGAR, USD)·분기 합산 기준.
...
| 2026Q1 매출 $3.770B(+22.1%), 영업이익 $503M(+11.5%), OPM 14.6%→13.3% | [FY2026 Q1 10-Q](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000056/now-20260331.htm) | ✓ SEC |
| 2026Q1 순이익 $469M, 영업CF $1.670B(전년 $1.677B) | [FY2026 Q1 10-Q](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000056/now-20260331.htm) | ✓ SEC |
| RPO $27.7B, 유동 계약부채 $8.030B, 계약부채에서 인식한 매출 $3.2B | [FY2026 Q1 10-Q](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000056/now-20260331.htm) | ✓ SEC |
| 총 주식보상비(SBC) $558M vs $470M, 양 기간 매출의 15% | [FY2026 Q1 10-Q](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000056/now-20260331.htm) | ✓ SEC |
| 세그먼트·AI(Now Assist) ACV — 연결 손익에 분해 없음 | dartlab 데이터 한계 | 주의/제외 |

본문의 숫자 중 이 표에 없는 것은 발행 차단 대상이다. 계약부채·RPO·SBC·AI는 dartlab 연결로 증명되지 않는 공시 분리 항목이며, 영업CF가 영업이익을 앞서는 것을 'SBC 때문'이라 단정하지 않는다. OCF/영업이익 31배(2019)는 분모 노이즈라 후크로 쓰지 않는다 — 연결이 증명하는 것은 '현금이 먼저 닿고 이익이 약 4년 늦게 따라왔다, 그 배수가 9에서 3으로 좁혀졌다'는 수렴의 방향까지다.

...
date: 2026-04-19
description: "매출 2.57조(2022)→1.51조(2025) 3년 -41%. 2024년 창사 첫 영업적자 -1,092억. 그런데 2025년 순이익은 영업이익의 21배인 3,474억. 현금 3조를 쌓은 회사가 게임에서 금융으로 이동한 흔적."
...
ai:
  ...
  dataAsOf: "2026-04-19"
carousel:
  title: 28년 흑자 게임사가 첫 적자를 낸 해, 순이익은 오히려 영업이익의 21배였다
  caption: |-
    엔씨소프트는 1997년 창업 이래 28년간 한 번도 적자를 낸 적이 없었습니다. 그런데 2024년 영업이익 -1,092억으로 그 기록이 깨졌죠. 매출은 2022년 2.57조에서 2025년 1.51조로 3년 만에 41% 빠졌습니다. 리니지 하나에 28년을 건 회사의 약점이 처음 드러난 순간입니다.

    반전은 그 다음입니다. 2025년 영업이익은 간신히 +161억으로 흑자 복귀했는데, 순이익은 3,474억 — 영업이익의 21배였습니다. 본업(게임)이 아니라 쌓아둔 돈이 만든 숫자입니다. 현금 1.26조에 금융상품까지 합쳐 약 3조(재무 재구성 추정)가 금리 상승기에 이자수익으로 돌아왔습니다.

    관전 포인트는 이겁니다. 자본 3.37조, 부채비율 28.6%의 이 회사는 게임회사에서 현금부자로 한 발씩 이동 중입니다. 2026~2028년 신작 성공 여부와 주주환원 정책이 "게임회사 복귀"냐 "투자회사 전환"이냐를 가릅니다. 다음에 볼 지표는 신작 첫 6개월 동시접속자와 배당성향입니다.
  explainers:
  - term: 영업이익 vs 순이익
    body: 영업이익은 본업(게임)으로 번 돈, 순이익은 거기에 영업 밖 손익(자산 매각·이자 등)까지 더한 최종 이익입니다. 엔씨는 2025년 순이익이 영업이익의 21배 — 본업이 아니라 영업외가 만든 숫자입니다.
  - term: 영업외이익
    body: 본업과 무관한 이익입니다. 엔씨의 2025년 순이익 3,474억 급증에는 엔씨타워1 사옥 매각 같은 일회성 이익과 쌓아둔 현금의 이자수익이 컸습니다 — 그래서 '매년 반복되는 이익인가'가 관건입니다.
  relatedNews:
  - title: 엔씨소프트 2025년 영업이익 161억원…흑자 전환
    source: insightkorea.co.kr
    date: '2026-02-11'
    url: https://www.insightkorea.co.kr/news/articleView.html?idxno=240991
    track: naver
    description: 카드가 본 '간신히 흑자 복귀' — 영업이익 161억 흑자전환에 순이익 3,474억(269%↑)은 엔씨타워1 매각이 컸습니다.
  - title: 엔씨소프트, 2026년 매출 목표 '2.5조원'
    source: inven.co.kr
    date: '2026-02-11'
    url: https://www.inven.co.kr/webzine/news/?news=313502
    track: naver
    description: 카드의 관전 지표인 신작 — 아이온2 글로벌과 신규 IP가 '게임회사 복귀'를 가르는 2026년 승부수입니다.
  pinnedComment: 투자 판단이 아닙니다. 재무 수치는 dartlab 실측(2026-04-19, 연결 기준)이며, 금융자산 약 3조·이자수익 연 1,500~1,800억·직원 수·게임 빅4 비교는 재무 재구성 추정 또는 외부(IR·공시) 인용입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
  ...
  - layout: editorialStat
    kicker: 2024 창사 첫 영업적자
    bigNumber: '-1,092'
    unit: 억원
    context: |-
      1997년 창업 후 28년 연속 흑자가
      처음 끊긴 해.
      리니지 둔화 + 신작 TL 실패가 겹쳤다.
  ...
  - layout: editorialStat
    ...
    unit: '%'
    context: |-
      2022년 2.57조 → 2025년 1.51조.
      리니지 단일 IP에 28년을 건 회사의
      약점이 처음 드러났다.
    image: user-context
  - layout: editorialStat
    kicker: 2025 순이익 vs 영업이익
    bigNumber: '3,474'
    unit: 억원
    context: |-
      영업이익은 +161억뿐.
  ...
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[28년간 쌓아둔 현금]]의 이자였다
    sub: |-
      현금 1.26조 + 금융상품 합쳐 약 3조(추정).
      금리 상승기에 이자수익으로 돌아왔다.
    image: ncsoft-pangyo-rd
  - layout: editorialStat
    kicker: 재무 건전성 (2025Q4)
    bigNumber: '28.6'
    unit: '%'
    context: |-
      부채비율 28.6%, 자본 3.37조.
...
>
> **이 글의 용어**: IP = 지적재산(Intellectual Property) · MMORPG = 대규모 다중접속 역할수행 게임 · ARPU = 유저당 평균 지출 · FCF = 잉여현금흐름(Free Cash Flow) · ROE = 자기자본이익률(Return on Equity) · OPM = 영업이익률(Operating Profit Margin). 본문 첫 등장 시 괄호 풀이.
...
표시: **2025 기준 영업이익률 순위**: 넥슨 27.8% > [크래프톤 (259960)](/blog/259960-krafton) 25.4% > 넷마블 3.5% > **엔씨 1.1%**. 한때 2021 16.2%로 넷마블을 크게 앞서던 엔씨가 이제는 넷마블에 근소하게 앞선 **3위**로 내려앉았다.

### 구조적 차이 — 왜 이 차이가 나는가

**넥슨**: 메이플스토리(25년) + 던파 모바일(글로벌) + 서든어택 등 **IP 다각화** + 중국 텐센트 퍼블리싱 수수료 구조. 한 IP 실패해도 다른 IP가 받쳐주는 포트폴리오.

**크래프톤**: PUBG(배틀그라운드) 단일 IP지만 **글로벌 시장 지배** (인도·동남아 1위) + **PC·모바일·콘솔 멀티플랫폼**. 규모의 경제가 마진을 지킨다. [크래프톤 (259960)](/blog/259960-krafton) 편에서 본 "PUBG 현금을 모아 ADK 인수"라는 자본배분 전략은 엔씨의 판교 사옥 5조 투자와 대비된다 — 크래프톤은 글로벌 IP 확보, 엔씨는 자국 내 고정자산.
...
[삼양식품 (003230)](/blog/003230-samyang-foods)이 불닭 단일 IP로 매출 급증한 사례와 엔씨의 리니지 단일 IP 구조는 표면상 비슷하다. 하지만 삼양식품은 **매년 새 변형(소스·컵면·해외 시장)을 통해 IP를 확장**하는 반면, 엔씨는 리니지 시리즈 3종 이후 새 IP 확장이 TL에서 막혔다. 이 차이가 2025년 매출 추세에 결정적으로 반영된다 — 삼양식품 2.35조 vs 엔씨 1.51조. 같은 "단일 IP"지만 운영 방식이 다르다.

엔씨의 dartlab storyTemplate은 2023년까지 "프랜차이즈(안정 수익 + 현금 기계)"였다. 2024~2025년은 **"프랜차이즈 + 현금부자"** 의 하이브리드로 이동한다. 현금 기계가 여전히 돌아가지만, 새로 돈을 만들기보다 **쌓인 돈의 이자로 번다**는 구조가 전면으로 올라왔다. [크래프톤 (259960)](/blog/259960-krafton) 편에서 본 "ADK 인수로 IP 다각화" 전략과 대조된다.
...
**첫째, 2024년 첫 적자는 예정된 결말이었다.** 리니지 단일 IP가 23년간 매출의 절반 이상을 지탱하는 동안, 엔씨는 신작을 통해 IP를 다각화하는 데 실패했다. 아이온·블레이드&소울·TL 모두 리니지의 대체재가 되지 못했다. 2020~2022년 리니지W 피크가 끝나자 매출은 3년 만에 41% 하락했고, 5년 개발한 TL은 2023년 출시 직후 한국 시장에서 반응이 부정적이었다. 여기에 판교 사옥 5조 투자가 **고정비를 올려둔 상태**였다. 이 세 조건이 겹치자 매출 하락이 고스란히 영업손실로 전환됐다.

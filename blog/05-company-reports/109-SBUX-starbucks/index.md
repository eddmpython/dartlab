...
ai:
  ...
  dataAsOf: "2026-06-20"
carousel:
  title: 가장 많이 팔고도 무너진 해 — 스타벅스의 마진
  caption: |-
    스타벅스는 2025년에 사상 최대로 팔았습니다. 매출은 6년간 +40%, $37.18B에 닿았죠. 그런데 영업이익은 2023년 피크 $5.87B에서 $2.94B로 정확히 반토막 났습니다.
  ...
  - layout: editorialStat
    kicker: 매출 (2019→2025, dartlab 실측)
    bigNumber: '37.18'
    unit: $B (+40%)
    context: |-
      $26.51B에서 코로나 해를 빼면 멈춤 없이 우상향
      외형은 사상 최대에 닿았다
    image: beans
  - layout: editorialStat
    kicker: 영업이익 (2023 피크→2025, 실측)
    bigNumber: '2.94'
    unit: "$B (-50%)"
    context: |-
      2023년 피크 $5.87B에서 정확히 반토막
      매출은 컸는데 이익은 무너졌다
    image: coffee
  - layout: editorialStat
    kicker: 연결 OPM (2023→2025, 실측)
    bigNumber: '7.9'
    unit: "% (-840bp)"
    context: |-
      2023년 16.3% 피크에서 약 840bp 하락
      성장과 수익성이 정반대로 갈라졌다
    image: beans
  - layout: editorialBeat
    kicker: 현금까지 같이 줄었다 (실측)
    line: |-
      영업현금흐름 $6.10B → $4.75B
      [[영업CF -22%]]
    sub: |-
      당기순이익도 $3.76B → $1.86B로 둔화
      그래도 영업CF는 순이익 $1.86B을 웃돈다 — '현금 붕괴'는 아니다
    image: cafe
  - layout: editorialBeat
    kicker: 2026년에 볼 것 — 회복의 '질' (회사 공시)
    line: |-
      2026 Q2 OPM 8.7%로 반등(외부 공시)
      [[그래도 마진 증명은 뒤에 남았다]]
    sub: |-
      반기 누적 OPM은 8.8% — 2023년 16.3% 체력의
      절반을 조금 넘는 수준(외부 공시)
      다음에 볼 지표 = 매출이 아니라 영업이익률(OPM)의 두 자릿수 복귀
    image: coffee
---

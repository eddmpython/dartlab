...
ai:
  ...
  dataAsOf: "2026-04-21"
carousel:
  title: 한 장의 공시가 PBR 최악을 최고로 바꾼 3년
  caption: |-
    2022년 11월 15일 오후 4시 30분, 메리츠금융지주가 전자공시 3건을 동시에 올렸습니다. 자회사 둘(화재·증권)을 완전자회사화하고, 당기순이익의 50%를 주주에게 환원하겠다는 선언이었습니다.

    그날 이후 3년, PBR이 0.49배(한국 금융주 최악)에서 1.8배(최고)로, 주가는 3.5배가 됐습니다. 순이익은 2년 연속 사상 최대 2.3조+, 자기자본수익률 22%로 5대 금융지주 중 1위입니다.

    핵심은 '선언을 실제로 집행했다'는 것입니다. 3년간 2.9조를 돌려줬고, 자사주는 전량 소각했습니다. 남은 질문은 이 속도가 10년 지속되는가 — 실적·오너 승계·선두 유지에 달렸습니다.
  explainers:
  - term: 자사주 소각·주주환원
    body: 번 돈으로 자사주를 사서 없애 주주 몫을 키우는 정책입니다. 메리츠는 순이익 50% 환원을 선언하고 3년간 2.9조를 집행, 자사주를 전량 소각했습니다.
  - term: PBR(주가순자산비율)
    body: 주가가 순자산의 몇 배인지 보는 지표입니다. 메리츠는 환원을 실제 집행하며 0.49배(금융주 최악)에서 1.8배(최고)로 재평가됐습니다.
  relatedNews:
  - title: "'육천피' 돌파에 '자사주 소각' 행진…밸류업 지수도 사상 최고치"
    source: news1.kr
    date: '2026-03-05'
    url: https://www.news1.kr/finance/general-stock/6091131
    track: naver
    description: 네이버 보관 뉴스 기준. 자사주 소각·밸류업 흐름 속 메리츠 — 카드가 말한 '환원을 실제 집행하는' 대표 사례입니다.
  pinnedComment: 투자 판단이 아닙니다. 연 순이익 2.5조+ 유지, 자사주 소각 연 6,000억+, 자기자본수익률 20%+, 오너 승계 공시 — 이 넷이 혁명의 지속성을 가립니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
    ...
    sub: |-
      한국 금융주 중 가장 싸던 주식이
      주가 3.5배가 됐다.
      시작은 2022년 11월의 공시 세 건.
    image: meritz-hq-dusk
  - layout: editorialBeat
    kicker: 2022.11.15 오후 4시 30분
    line: |-
      한 날에
      [[3건의 공시]]
    sub: |-
      자회사 2개 완전자회사화 + 주주환원 50% 선언.
      따로 냈으면 평범했을 것을,
      같이 내자 '오너가 움직인다'는 신호가 됐다.
    image: dart-disclosure-meritz-bg
  - layout: editorialStat
    kicker: 정관에 박은 약속
    bigNumber: '50'
    unit: '% 주주환원'
    context: |-
      '당기순이익의 50% 이상을 배당·자사주 소각으로.'
      립서비스가 아니라 구속력 있는 자본배분 규칙.
      3년간 실제로 2.9조를 돌려줬다.
    image: stock-certificate-buyback
  - layout: editorialStat
    kicker: 그 결과
    bigNumber: '3.5'
    unit: 배
    context: |-
      주가 약 3만원 → 약 10만원, PBR 0.49 → 1.8.
      같은 3년 한국 5대 금융지주 중 주가·PBR·자기자본수익률 1위.
      2위 KB금융 상승률의 4배 이상.
    image: financial-tower
  - layout: editorialBeat
    kicker: 실적이 받쳤다
    line: |-
      순이익 2년 연속
      [[사상 최대 2.3조]]
    sub: |-
      2023년 9,451억 → 2024·2025년 각 2.3조+.
      메리츠화재가 73%, 손해보험 업계 최상위 수익률.
      자기자본수익률 22%로 5대 지주 중 최고.
    image: meritz-fire-hq
  - layout: editorialBeat
    kicker: 왜 못 따라하나
    line: |-
      [[오너 단일 지배]]가
      속도를 만든다
    sub: |-
      조정호 회장 + 김용범 부회장 25년 분업.
      KB·신한은 임기 3년 전문경영인 체제라
      같은 속도의 자본배분 결단이 어렵다.
    image: financial-tower
  - layout: editorial
    line: |-
    ...
    sub: |-
      실적이 받치고, 오너 승계가 매끄럽고,
      선두를 유지하면 PBR 1.8배는 2030년에도 유효하다.
      셋 중 하나만 무너지면 다시 1.0배로.
    image: meritz-hq-dusk
---
...
이 구조 변화가 **PBR 재평가의 첫 계단**. [이마트 (139480)](/blog/139480-emart) 편에서 본 "6개 사업부가 합쳐진 복합 기업의 저평가"와 정반대 구조 — 이마트는 사업부가 흩어져 매출 성장이 이익으로 안 왔다면, 메리츠는 자회사를 흡수해 "이익이 한 곳으로 모이는" 구조를 만들었다. 2022.10 PBR 0.49 → 2023.4 약 **0.85배**. 5개월 만에 +74%. 이 첫 단계가 "이중상장 디스카운트 해소"라는 이론적 효과의 증명이었다.
...
**실제로는 소각 없이도 오너 지분은 안 줄어들지만, 소각을 계속하면 오너 지분율이 계속 올라가는 구조**. 이게 "주주환원이 오너에게 특별히 좋은 이유"이기도 하다. 비슷한 구조 혜택이 [엔씨소프트 (036570)](/blog/036570-ncsoft) 편에서도 나왔다 — 2021·2024 자사주 2,700억 매입 누적으로 유통주식 감소 + 김택진 대표 간접 지분 증가.
...
이 선제성이 2025년 주가 재평가의 또 다른 축. [팔란티어 (PLTR)](/blog/PLTR-palantir)의 SBC 논란과 구조가 다르지만, [네이버 (035420)](/blog/035420-naver)의 라인·Z Holdings 처분처럼 **"자본 구조 최적화 → 주가 재평가"** 인과는 같다. [현대코퍼레이션 (011760)](/blog/011760-hyundai-corp) 편에서 본 "종합상사가 지주형 자본배분으로 전환"한 케이스와도 방향성이 겹친다.

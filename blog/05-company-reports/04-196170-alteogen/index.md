...
carousel:
  ...
  explainers:
  - term: 키트루다 SC
    body: 머크의 항암제 키트루다를 정맥주사(IV)에서 피하주사(SC)로 바꾼 제형입니다. 알테오젠의 효소(ALT-B4)가 이를 가능하게 해 알테오젠이 로열티를 받습니다.
  - term: 로열티
    body: 라이선스를 준 대가로 상대 매출의 일정 비율을 받는 돈입니다. 키트루다 SC 매출과 실제 로열티율이 알테오젠 이익을 좌우합니다.
  relatedNews:
  - title: 전태연 알테오젠 대표 "특허 분쟁 결과 글로벌 빅파마 신뢰 더 커졌다"
    source: etoday.co.kr
    date: '2026-06-28'
    url: https://www.etoday.co.kr/news/view/2597850
    track: naver
    description: 네이버 보관 뉴스 기준. 빅파마 신뢰 — 카드가 말한 '머크 외 두 번째 빅파마 계약' 관전 포인트와 닿습니다.
  - title: 벌써 기술수출 13조원…K-바이오, 하반기 더 뜨거워진다
    source: mt.co.kr
    date: '2026-06-28'
    url: https://www.mt.co.kr/thebio/2026/06/28/2026062513272830848
    track: naver
    description: 네이버 보관 뉴스 기준. 알테오젠 이익의 출발점인 '라이선스(기술수출)' 모델의 업계 흐름입니다.
  - title: 바이오USA서 질문이 바뀌었다…K-바이오, 이제 "어떻게 벌 것인가"
    source: kormedi.com
    date: '2026-06-26'
    url: https://kormedi.com/?p=2828956
    track: naver
    description: 네이버 보관 뉴스 기준. '일회성이냐 새 시대냐' — 카드의 수익 지속성 질문과 같은 맥락입니다.

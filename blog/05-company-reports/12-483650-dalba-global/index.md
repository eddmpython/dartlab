---
title: "달바글로벌 (483650) — 2,700개 종목을 스캔했더니 영업이익률 20%짜리 화장품 회사가 걸렸다"
date: 2026-04-09
description: "전종목 횡단분석에서 발견한 회사. 공장 없이 미스트 하나로 5,000만병. 매출총이익률 76%. 영업이익률 19.5%. 금융차입 0%. 컨설턴트 출신이 화장품 경험 0에서 시작해 5,000억을 만든 구조를 dartlab으로 추적한다."
...
ai:
  ...
  weaknesses:
    - "해외 의존도"
    - "브랜드 단순성"
  keyMetrics: {revenue: 0.52, opm: 19.5, roe: 39.8, fcf: 0.07}
  dataAsOf: "2026-04-09"
carousel:
  title: 공장 0개, 미스트 하나로 5,000만병 — 화장품인데 반도체 마진
  caption: |-
    코스피 2,700개 종목을 스캔하다 영업이익률 19.5%, 매출총이익률 76%짜리 화장품 회사가 걸렸다. 화장품인데 반도체 마진이다. 자체 공장은 하나도 없고, 미스트 하나로 누적 5,000만병을 팔았다.

    반전은 구조에 있었다. 위탁생산 100%라 설비투자/매출이 0.1%, 1인당 매출 17.3억(아모레퍼시픽 2.2배), 금융차입 0%. 이익만으로 자본을 쌓아 1년 만에 매출 1,690억→5,197억(3배), 내부유보 19%→40%. dartlab 스코어카드는 5개 A를 줬다.

    그런데 같은 카드에 수익성 D, 현금흐름 D가 공존한다. 상장 일회성 비용 약 224억과 영업CF 67% 전환이 범인. 다음에 볼 지표는 판관비율(56.4%)이 50% 밑으로 내려가는가, 그리고 북미가 러시아(해외 29%)를 넘는 시점이다.
  explainers:
  - term: 위탁생산(OEM/ODM)
    body: 공장을 직접 짓지 않고 외부 제조사에 맡기는 방식입니다. 달바는 위탁생산 100%라 설비투자가 매출의 0.1%, 차입금 0으로 '반도체급 마진(OPM 19.5%)'을 냈습니다.
  - term: 매출총이익률(GPM)
    body: 매출에서 원가를 뺀 이익의 비율입니다. 달바는 76%로 화장품치고 비정상적으로 높은데, 미스트 단일 제품 + 위탁생산 구조의 결과입니다.
  relatedNews:
  - title: 상장 1주년 달바글로벌, 해외 성장 발판 삼아 '매출 1조' 정조준
    source: daily.hankooki.com
    date: '2026-06-11'
    url: https://daily.hankooki.com/news/articleView.html?idxno=1374961
    track: naver
    description: 네이버 보관 뉴스 기준. 해외 성장 가속 — 카드가 본 '북미가 러시아를 넘는 시점'과 같은 축의 성장 스토리입니다.
  - title: "[특징주] 달바글로벌, 실적 성장 기대감에 상승…증권가 가이던스 상향"
    source: ebn.co.kr
    date: '2026-06-26'
    url: https://www.ebn.co.kr/news/articleView.html?idxno=1714102
    track: naver
    description: 네이버 보관 뉴스 기준. 실적 성장 기대 — 카드가 말한 '반도체급 마진'이 이어지는지의 최신 시각입니다.
  pinnedComment: 투자 판단이 아닙니다. 재무 숫자는 dartlab 전자공시 실측(2025 연간)입니다. 진출국 수·해외 매장수·골드애플 순위는 회사 공시·외부 정보이며, 러시아 200억달러 시장규모·로레알 Luxe 25% 등도 외부 인용입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
      화장품인데 반도체 마진이 나왔다
      [[공장 0개, 미스트 하나로 5,000만병]]
    sub: |-
      영업이익률 19.5% · 매출총이익률 75.9%
      금융차입 0% · 위탁생산 100%
      종목코드 483650 달바글로벌
    image: mist-product
  ...
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[해외 비중 7% → 63%, 4년 만에]]
    sub: |-
      해외 비중 7%(2021) → 63%(2025)
      러시아 29% · 일본 22% (해외 매출 믹스)
      골드애플 럭셔리 3위 · 진출 40개국 · 매장 3,000개+
    image: russia-beauty
  - layout: editorialStat
    kicker: 5A인데 수익성·현금흐름 D
    bigNumber: '224'
    unit: 억원
    context: |-
      영업이익 1,015억인데 영업 밖에서 약 224억 증발
      상장 일회성 비용 + 환율 손실
      영업CF 685억 = OI의 67%만 현금 전환
    image: product-detail
  - layout: editorialBeat
    kicker: 계속 열어볼 숫자
    line: |-
      판관비율 56.4%가 50% 밑으로 내려가는가
      [[북미가 러시아를 넘는 시점이 분기점]]
    sub: |-
      자기자본수익률 39.8% · Piotroski 7/9 · 순현금 200억→442억
      D가 B로 바뀌면, 1조까지 버틸 수 있는 구조인가
...
전종목 횡단분석을 돌리면 가끔 설명이 안 되는 숫자가 나온다. 영업이익률 19.5%, 매출총이익률 76%. 화장품인데 반도체 마진이다. 코스피 2,700개 종목 중 이 조합을 가진 회사는 손에 꼽는다.
...
**5개 A.** Piotroski **7/9**. 그런데 수익성 D? 현금흐름 D? 5개 A와 2개 D가 공존한다. **"왜 이렇게 잘 버는데 수익성과 현금흐름이 D인가?"** 이 모순이 관통선이다.
...
2024년 영업CF **0.5억**. 이익이 275억인데 현금이 거의 안 들어왔다. 2025년도 685억/1,015억 = **67%**만 현금으로 전환. Piotroski에서 "CF > 순이익" 불통과.
...
달바글로벌은 dartlab이 **데이터에서 먼저 발견한 회사**다. 2,700개 종목을 스캔했을 때 영업이익률 19.5%, 매총이익률 76%, 금융차입 0%라는 조합이 튀어나왔다. 파고 들어갔더니 공장 없이 미스트 하나로 5,000만병을 팔고, 러시아에서 럭셔리 3위에 올라간 회사가 있었다.

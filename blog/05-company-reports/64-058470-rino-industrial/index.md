...
carousel:
  ...
  explainers:
  - term: 포고핀
    body: 반도체 칩을 검사할 때 칩과 시험장비를 잇는 길이 5mm짜리 금속 핀입니다. 1만 번 쓰면 버리는 소모품이라 경기와 무관하게 라인이 돌면 계속 주문됩니다 — 40% 이익률의 비결입니다.
  - term: 영업이익률
    body: 매출에서 본업으로 남긴 이익 비율입니다. 리노는 반도체 불황이던 2024년에도 44.8%를 지켜, 경쟁사가 적자일 때 홀로 고수익을 냈습니다.
  relatedNews:
  - title: "[경제타임스] '꿈의 수익률' 46%…리노공업, AI 반도체 소켓 독주"
    source: ket.kr
    date: '2026-02-12'
    url: https://ket.kr/news/article.html?no=37839
    track: naver
    description: 카드가 본 40%대 이익률의 최신 확인 — AI 반도체 테스트 소켓에서 리노가 독주하는 국면입니다.
  - title: "[중견기업 해부] '코스닥 시총 6위' 리노공업…AI 반도체 수요 타고 신공장 승부수"
    source: v.daum.net
    date: '2026-04-23'
    url: https://v.daum.net/v/20260423060238327
    track: naver
    description: 카드의 관전 포인트 그대로 — AI 칩 테스트 수요가 이 독점을 키울지, 신공장 증설로 응답하는 흐름입니다.

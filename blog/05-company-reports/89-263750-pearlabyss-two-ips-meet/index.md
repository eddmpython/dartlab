...
출처: `dartlab.Company('263750').panel('IS'/'BS'/'CF')` · DART 사업보고서·분기보고서 (2017Q3~2025.12).
...
`c.panel()` 는 분기별 사업보고서·분기보고서 본문이 chapter 단위로 stack 된 DataFrame 이다. 1 막의 붉은사막 정의 인용, 3 막의 CCP 인수 본문, 8 막의 차기작 (도깨비) 언급 — 모두 위 한 줄로 재현된다.

...
<HFDataLink code="OKLO" kind="edgar" />
...
여기서 주의할 점이 있다. dartlab에서 `c.panel("IS")`를 실행하면 2024~2025년 IS 상세 항목이 null로 나올 수 있다. 이유는 CIK(SEC 고유 기업번호) 전환 때문이다. Oklo는 원래 AltC Acquisition Corp(기업인수목적회사)이라는 SPAC(Special Purpose Acquisition Company, 기업인수목적회사)의 CIK를 쓰다가, 합병 완료 후 Oklo Inc.로 CIK가 전환됐다. SEC XBRL 데이터에서 이 전환이 반영되는 데 지연이 있다.
...
| 설비투자(설비투자) | 미미 | $350~450M |
| **합계 현금 유출** | **~$106M** | **$430~550M** |

영업에서 태우는 돈($80~100M)은 FY2025과 비슷하다. 문제는 **설비투자(설비투자, Capital Expenditure — 건물·설비·토지에 투자하는 돈)가 $350~450M**이라는 것이다. INL 부지 착공, 연료 인프라 투자, 제조 준비 등이 시작되면 현금 유출이 급증한다.
...
| 매출 $0 | SEC 10-K FY2025 | `c.panel("IS")` |
...
| 현금 $410M | SEC 10-K BS | `c.panel("BS")` |
| 총자산 $1,246M | SEC 10-K BS | `c.panel("BS")` |
| 총부채 $40.6M | SEC 10-K BS | `c.panel("BS")` |
| 자본 $1,205.6M | SEC 10-K BS | `c.panel("BS")` |
| APIC $1,401.3M | SEC 10-K BS | `c.panel("BS")` |
| 이익잉여금 -$199.3M | SEC 10-K BS | `c.panel("BS")` |
...
| 2026 가이던스 $350~450M 설비투자 | FY2025 earnings call | IR 프레젠테이션 |

...
![매출 100원이 순이익 0.34원이 될 때까지 4단계 — 매출원가 82.12원 + 판관비 19.15원이 빠지면 영업이익 5.69원, 거기서 금융비용 4.67원 + 법인세 1.41원이 더 빠지면 순이익 0.34원. 영업이익의 94%가 금융비용 + 법인세로 상쇄된다.](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/60/606a5f50fb2fd554c6ef6d60f490107aefb7b7d5c1b864d450735ce6d50d0d3f.svg)

2023년 LG에너지솔루션의 매출은 **33.75조원**이었다. 회사가 만들어진 이래 가장 큰 숫자. 영업이익률은 **6.41%**, 영업이익 절대값으로는 **2.16조원**을 찍었다. 그 해 순이익은 **1.64조원**이었다.

2년이 지난 2025년 결산. 매출은 **23.67조원**으로 **10조원 증발**했다. -29.9%. 일반적으로 이 정도 매출이 빠지면 영업이익률도 따라 무너진다. 같은 이차전지 업종 [삼성SDI (#68)](/blog/006400-samsung-sdi)는 실제로 매출 -41.5%에 영업이익률은 **-12.98%**로 적자 전환했다.

그런데 LG에너지솔루션은 영업이익률 **+5.69%**를 찍고 **1.35조원 흑자**로 끝났다. 2023년 대비 매출은 10조 빠졌는데 영업이익은 2024년 0.58조에서 2025년 1.35조로 **2.3배** 늘었다.
...
![4년 궤적을 한 화면에 — 매출은 2023년 33.75조 피크 후 23.67조까지 -29.9%, 영업이익률은 6.41% 피크 → 2.25% 저점 → 5.69% V자 반등, 순이익은 1.64조에서 0.08조로 20분의 1.](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/48/488227e57ae27b4bbaf8cc723e8d8bc7d9f9769441af4ade7f5df62811a68d22.svg)
...
![매출총이익률 V자 반등의 3엔진 — 2024 13.29% 저점에서 2025 17.88%로 +4.59%p 반등. 엔진 1 재고 소진(2022Q4 7조 → 2025Q4 4.35조), 엔진 2 LFP 전환(0 → 15%), 엔진 3 IRA AMPC 약 1.5조.](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/3e/3ea7bf181625fbb40437b04307615193c041b48525ab5ffa3f5742e550a01020.svg)
...
**셋째, 해외 운영비 증가**. 북미 공장 가동률 미달에 따른 **유지비 과다 부담**. 2024~2025 온타리오 Nextstar Energy(Stellantis JV), 애리조나 Queen Creek 단독공장, 홀랜드(미시간) 등 가동률이 계획 대비 **50~70% 수준**에 머물면서 공장당 고정비가 판관비에 집중 반영됐다. [현대글로비스 (#15)](/blog/086280-hyundai-glovis)에서 다룬 "캡티브 물량이 있어도 가동률 미달이 마진을 결정한다"는 논리가 여기에도 적용된다.
...
합계 **약 550 GWh 규모의 공식·추진 용량**. 이 규모는 세계 2위 수준 (1위 CATL 약 670 GWh — [SNE Research 2025년 1월 글로벌 용량 순위](https://www.sneresearch.com/)). 실제 가동 가능 용량은 **300~400 GWh** 수준으로 추정. [HD현대일렉트릭 (#08)](/blog/267260-hd-hyundai-electric)의 "수주잔고 메커니즘"과 유사하게, 용량은 선제 투자됐지만 매출화는 시간차를 두고 반영된다.

![LG에너지솔루션 글로벌 공장 지형 — 한국 오창 34GWh, 중국 난징 105GWh, 폴란드 브로츠와프 86GWh, 미국 홀랜드 + 얼티엄셀즈(GM JV) + Queen Creek + HAEL(현대차 JV) 합 약 243GWh, 캐나다 Nextstar Energy(Stellantis JV) 49GWh, 인도네시아 HLI Green Power(현대차 JV) 33GWh. 총 550GWh.](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/61/6180944c7b765ff7c9e0ca84e7695a505fb5a4a6453167605c1a17d0a100a764.svg)
...
**둘째, CAPEX 타이밍의 차이**. 삼성SDI는 **Stellantis JV (Starplus Energy, 인디애나)**를 2023~2024년에 집중 준공. 그런데 Stellantis가 2024년부터 미국 EV 라인업 축소를 선언하면서 **가동 목표 23 → 15GWh로 하향** ([삼성SDI (#68)](/blog/006400-samsung-sdi) 본문 참조). 공장은 다 지었는데 가동할 차가 줄어든 최악의 타이밍. LG엔솔은 **GM·현대차 JV**가 분산돼 있어 한 고객의 감속이 전체를 무너뜨리지 않았다.
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| **LG에너지솔루션** | 373220 | 23.67 | **+5.69** | 37.83 | 129.0 | 11.99 | **10.9** | 6.54 |
...
![이차전지 5사 2025년 비교 — LG엔솔만 OPM +5.69% 흑자, 삼성SDI -12.98% 적자, SK이노베이션 부채비율 194% 고위험, 포스코퓨처엠 주의, 에코프로비엠 단기비중 100% 고위험. LG엔솔은 마진·단기 만기구조 모두 5사 중 가장 건전.](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/71/7109797d6cd1aa365a66187fdfef67c013478c8e15a150ac0c920a7cfdebdb8d.svg)

### 주주환원 — 배터리 4사 모두 배당 0

LG에너지솔루션은 2023~2025년 3년 연속 배당 0원. 2022 상장 직후 **1.14조 배당**을 한 번 지급한 후 정지. 삼성SDI·SK이노베이션·포스코퓨처엠·에코프로비엠 **모두 2025년 배당 없음 또는 최소 수준**.

**이차전지 섹터 전체가 주주환원 유예 모드**. CAPEX가 매출의 30~50%에 달하는 자본집약 업종 특성상 이익이 전부 재투자된다. 배당은 사이클이 정점을 지나고 CAPEX가 내려앉은 뒤에나 가능한 구조. [에코프로 (#26)](/blog/086520-ecopro)의 양극재 사이클과 [뉴스케일파워 (#44)](/blog/SMR-nuscale-power)의 SMR 사이클이 같은 맥락 — **에너지 전환 업종은 전부 "졸업장은 땄는데 취업은 아직"인 구간**에 있다.
...
![다음 12~24개월 추적 5개 — 분기 매출 6조+ 복귀, 매출총이익률 20%+ 안정, IRA AMPC 정책 변화, 이자보상배율 3배+ 복귀, LFP 라인 확대 공시. 5개 모두 긍정 = 첫 사이클 완성, 하나라도 미달 = 두 번째 계곡 진입 신호.](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/f4/f4ef6989f91e45227d27562ae3e2baa54fc60234741162cd81f61e71000d105c.svg)
...
![사이클 판단 트리 — 현재(2025) 매출 23.67조·OPM 5.69%·ICR 1.2배. 2026~2027 3조건(분기 매출 6조+·GPM 20%+·ICR 3배+) 동시 충족 시 첫 사이클 완성, 하나라도 미달 시 두 번째 계곡 진입 가능.](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/41/41bc3e64be1d607f77c9db97cea63d21523a698890b3adb39f1dc82fc56a8c7a.svg)
...
- ⚠️ **dartlab `reinvestment.capex` 2023 = 0 원인**: CF 분기 원본을 보면 2021~2023 "유형자산의 취득"이 **음수(−)** 로 표시(현금 유출)되다 2024~2025는 **양수(+)** 로 전환. 엔진이 양수 연도만 합산해 2023이 0으로 나온 것. 절대값 기준 2023 약 16.98조 (Q4 결측으로 완전치는 아님). 본문에는 이 이슈를 이미 검증표에 명시
- 📰 **공장 지형·고객·AMPC 금액**: 사업보고서 II장 원문과 회사 IR 발표에서 확인했으나 **구체 금액 단위 (예: 2024 AMPC 1.25조) 는 업계 추정·IR 발표 단위 차이 존재** — 정확한 연간 실수혜액은 IRS Form 3800 개별 공시 필요
- ⚠️ **외부 URL**: Cox Automotive·ACEA·SMM·Reuters·European Commission 링크는 도메인은 존재하나 **세부 페이지 URL 정확성은 접속 검증 생략**

**수치 정정**: 본문 중 **"약 $", "약 억원", "추정"** 표기 항목은 사업보고서 주석 원문 교차 없이 게시된 부분. 핵심 관통선("매출 -30%인데 OPM 반등 · 영업이익 → 순이익 94% 감소")은 dartlab 실측 기준 유지.

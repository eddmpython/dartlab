...
tags:
  ...
  - 재무분석
ai:
  verdict: "CEO 3명 교체 동안 매출 $5.7B→$4.9B 역성장. GPM 47%인데 OPM 4%. 판관비가 이익을 먹는다. 창업자 Plank이 의결권 66.5%로 돌아왔다."
  direction: 턴어라운드
  confidence: 낮음
  archetype: 턴어라운드
  strengths:
    - "매출총이익률 47% — Nike(41%)보다 높다"
    - "창업자 Kevin Plank 복귀 + SKU 25% 축소"
    - "현금 $1B 보유, 무배당 구조"
  weaknesses:
    - "매출 역성장 $5.7B→$4.9B (FY2025)"
    - "영업이익률 4% — 판관비 구조 미해결"
    - "Curry Brand 분리 — 스타 얼굴 상실"

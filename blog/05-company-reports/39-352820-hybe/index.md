...
carousel:
  ...
  explainers:
  - term: 멀티 레이블
    body: BTS 외에 세븐틴·투어스·앤팀 등 여러 아티스트를 거느린 구조입니다. 한 팀의 공백을 다른 팀이 메워, BTS 공백에도 매출이 성장했습니다.
  - term: 위버스(팬덤 플랫폼)
    body: 굿즈·멤버십·앱 결제를 모으는 팬 플랫폼입니다. 공연장 밖에서도 반복 결제가 남는지를 보는 핵심 지표입니다.
  relatedNews:
  - title: "\"BTS에 앤팀까지\"…하이브, 日 오리콘 '상반기 차트' 휩쓸었다"
    source: sportsseoul.com
    date: '2026-06-26'
    url: https://www.sportsseoul.com/news/read/1619111?ref=naver
    track: naver
    description: 네이버 보관 뉴스 기준. 여러 아티스트의 글로벌 흥행 — '한 팀에 의존하지 않는 팬덤 매출'을 보여줍니다.
  - title: 하이브 투어스, 케이스포돔서 아시아 투어 출발
    source: newsis.com
    date: '2026-06-26'
    url: https://www.newsis.com/view/NISX20260626_0003685417
    track: naver
    description: 네이버 보관 뉴스 기준. 공연 투어 재개 — 카드가 말한 '공연 매출이 회복되는지' 관전 포인트입니다.

...
date: 2026-06-14
description: "코로나 특수 앞에서 곡괭이 장수의 손익은 매출과 마진이 다른 모양으로 움직인다. dartlab 실측 8개 연도로 매출 계단·마진 스파이크를 가르고, PPD라는 '산 것'과 코로나가 '벌어준 것'을 데이터 기반으로 분리한다."
category: company-reports
series: company-reports
seriesOrder: 138
thumbnail: /avatar-chart.png
ogImage: https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/6a/6a10eeedcee8774fc4f42233fab8e4d0df9640a8a6c119a8b303cd63a98d6007.webp
cardPreview: https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/44/44ae668cb04255e35c09efebdd1b93aa1c27c5c2c0a82615bb6c1c57a0630b61.webp
tags:
  - "써모피셔"
  - "TMO"
  - "곡괭이장수"
...
> **데이터 기준**: 2026-06-14 dartlab 실측 — Thermo Fisher Scientific(TMO) **미국 연결(USD)** 기준, 분기 데이터를 역년(calendar year)으로 합산. 세그먼트·제품별·인수 기여 분해 등 손익 밖 항목은 **SEC 10-K/10-Q와 회사 IR 공시**로 분리한다.
>
...
![연구실의 장비와 시약 — 누가 무엇을 연구하든 그 위에서 돌아가는 도구들이 써모피셔의 사업이다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/af/af109365a46645abb644bd9999c4bcae2925093cc035abe143c92099d0787ea9.webp)
...
![매출(계단)과 영업이익률(스파이크)을 한 화면에 겹친 이중축 — 같은 코로나 특수인데 두 선의 모양이 다르다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/02/02ea2a8671b18a07949ff8cf3fa953b1c6ded22767cc595371fcf5c1ec09cefd.svg)
...
![영업이익률만 떼어낸 선차트 — 15.5%에서 25.6%로 솟았다가 16%대로 되돌아온 스파이크의 궤적](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/e7/e731e41dce5f660a7f480bc94587ad87cd044e46afe207607b70229151f27c87.svg)
...
![곡괭이와 삽 — 누가 금을 캐든 도구를 파는 자리, 그 자리의 마진은 수요가 솟을 때 비대칭적으로 솟는다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/55/55952d61d75ec06b99984548bc8342f870ea747348f77f291c59690a5e4feee1.webp)

그런데 이 영업 레버리지에는 반드시 붙여야 할 경고가 있다. 레버리지는 양방향으로 작동한다. 고정비 위에서 수요가 솟을 때 마진이 비대칭적으로 *올라가듯*, 수요가 빠질 때는 마진이 비대칭적으로 *내려간다*. 매출이 줄면 매출은 비례해서 줄지만, 고정비는 그만큼 빨리 줄지 않기 때문에 마진은 매출보다 더 빨리 빠진다. 한번 늘린 인력과 설비를 수요가 빠졌다고 곧바로 같은 속도로 줄일 수는 없기 때문이다. 곡괭이 장수의 마진이 매출보다 먼저·더 크게 솟았다는 말은, 빠질 때도 매출보다 먼저·더 크게 빠진다는 뜻이기도 하다. 이 비대칭은 호황의 미덕이자 정상화의 고통이다.
...
![연도별 매출 막대차트 — 2022→2023의 실제 감소($44.91B→$42.86B)를 강조](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/af/affeac9928a0d4022e1a681f2082d7203e1c95e984d0e7aabd34228ad8010a1b.svg)
...
문제는 이 글의 검증 데이터가 8개 연도의 손익·현금흐름 행뿐이라는 것이다. 8개 행만으로는 '코로나 특수 소멸'과 '바이오텍 자금 경색'과 '재고 조정'을 분리해 각각 몇 달러씩 책임이 있는지 가를 수 없다. 그래서 이 글은 2022→2023 하락을 '코로나 특수 소멸이 주된 동인일 가능성이 높지만, 그것만은 아니며 손익 8개 행으로는 분리 불가능하다'고 있는 그대로 적는다. 인과를 단정하는 대신 손익 밖 서사로 표기한다.
...
![세 개의 체크포인트(2019 25.5B/18.0% → 2021 39.2B/25.6% → 2025 44.6B/17.4%) — 매출은 남고 마진은 떠났다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/59/5961efc14e3d9fdd41cac7b67e0a0f176ebc4dfd44cb2f896c542e1e7b5c3606.svg)
...
이렇게 두 주장을 갈라놓으면 관통선이 비로소 선명해진다. 마진은 코로나가 솟구치게 했다가 도로 가져갔다(8개 행이 증명). 매출 바닥은 영구히 높아졌지만, 그 상당 부분은 코로나가 벌어준 게 아니라 PPD를 사서 올린 것이다(외부 맥락으로만 말할 수 있음). 매출은 남고, 마진은 떠났고, 남은 매출의 상당 부분은 사들인 것이다.
...
먼저 절대 이익부터 있는 그대로 말해야 한다. 마진율은 코로나 이전 밴드로 돌아왔지만, 회사는 더 커졌다. 2025년 영업이익 $7.75B와 순이익 $6.70B는 2019년($4.59B / $3.70B)을 크게 웃돈다. 영업이익은 8년 전 2018년($3.78B)의 두 배가 넘고, 순이익도 2018년($2.94B)의 두 배를 넘어섰다. 마진율의 '정상화'를 회사의 '제자리'로 읽으면 오독이다 — 비율은 내렸지만 절대 이익은 회복됐고, 더 큰 매출 base 위에서 벌고 있다. 같은 17%라도 $25B 위의 17%와 $44B 위의 17%는 절대 금액이 다르다.

![빠져나가는 파도 — 특수는 떠났지만 해변(매출 바닥)은 더 높은 자리에 남았다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/b0/b0e7f0d8281c688730129d1669200ed811cd39bfc77391dd93f936aa8c866295.webp)
...
이 글이 말할 수 있는 것과 없는 것의 경계도 분명하게 정리한다. 8개 연도의 손익·현금흐름 행은 마진의 솟음과 정상화를 강하게 증명한다 — OPM 궤적도, 증분 영업이익률도, 2021→2023의 마진 역주행도 데이터 안에서 닫힌다. 그러나 8개 행은 매출 base의 유기적 성장과 M&A 기여를 분해하지 못하고, 2022→2023 하락에서 코로나 특수 소멸과 바이오텍 자금 경색·재고 조정을 가르지 못하며, 2025년 영업현금흐름 둔화의 원인도 알지 못한다. 그 경계 밖의 이야기는 SEC 10-Q/10-K와 회사 IR 공시의 몫이다. 곡괭이 장수를 읽을 때, 데이터가 닫는 자리와 공식 공시가 여는 자리를 가르는 것 — 그것이 이 글의 마지막 도구다.

---

## 공시 / Filings

- 최신 분기 공시: [Thermo Fisher Scientific 2026 Q1 Form 10-Q, quarter ended 2026-03-28](https://www.sec.gov/Archives/edgar/data/97745/000009774526000092/tmo-20260328.htm)
- 최신 연간 공시: [Thermo Fisher Scientific FY2025 Form 10-K, year ended 2025-12-31](https://www.sec.gov/Archives/edgar/data/97745/000009774526000018/tmo-20251231.htm)
- PPD 인수 종결: [Thermo Fisher completes PPD acquisition](https://ir.thermofisher.com/investors/news-events/news/news-details/2021/Thermo-Fisher-Scientific-Completes-Acquisition-of-PPD-Inc/default.aspx)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 매출액 | 24.36 | 25.54 | 32.22 | 39.21 | 44.91 | 42.86 | 42.88 | 44.56 |
...
| 항목 ($B) | 2018 | 2019 | 2020 | 2021 | 2022 | 2023 | 2024 | 2025 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 영업활동현금흐름 | 4.54 | 4.97 | 8.29 | 9.31 | 9.15 | 8.41 | 8.67 | 7.82 |

| 보조 비율 | 2018 | 2019 | 2020 | 2021 | 2022 | 2023 | 2024 | 2025 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 영업이익률(OPM) | 15.5% | 18.0% | 24.2% | 25.6% | 18.7% | 16.0% | 17.1% | 17.4% |
| 순이익률(NPM) | 12.1% | 14.5% | 19.8% | 19.7% | 15.5% | 13.9% | 14.8% | 15.0% |
...
본문 인용 수치를 dartlab 호출과 공식 공시로 검증한다. 📅 dartlab 실측 2026-06-20 · TMO 미국 연결(USD)·분기 합산 기준.

| 본문 수치 | 출처 / 호출 | 판정 |
|---|---|---|
| 매출 2018 24.36B → 2025 44.56B(+83%) | `c.select("IS", ["sales"], freq="Y")` | 실측 |
| 영업이익률 2018 15.5% → 2021 25.6% → 2025 17.4% | 영업이익÷매출 | 실측 |
| 2019→2021 매출 +13.67B, 영업이익 +5.44B | `c.select("IS", ["sales","operating_profit"], freq="Y")` | 실측 |
| 2021→2023 매출 +3.65B, 영업이익 -3.17B | `c.select("IS", ["sales","operating_profit"], freq="Y")` | 실측 |
| 2025 영업활동현금흐름 7.82B | `c.select("CF", ["operating_cashflow"], freq="Y")` | 실측 |
| 2026 Q1 매출 11.005B, 영업이익 1.863B, 귀속순이익 1.651B | [2026 Q1 10-Q](https://www.sec.gov/Archives/edgar/data/97745/000009774526000092/tmo-20260328.htm) | 공식 공시 |
| 2026 Q1 Life Sciences Solutions 매출 2.636B, Laboratory Products and Biopharma Services 매출 6.036B | 2026 Q1 10-Q segment revenue table | 공식 공시 |
| 2026 Q1 Clinical research 매출 2.128B vs 2025 Q1 1.939B | 2026 Q1 10-Q revenue disaggregation table | 공식 공시 |
| PPD 인수 종결, 현금 매입가 17.4B | [Thermo Fisher IR release](https://ir.thermofisher.com/investors/news-events/news/news-details/2021/Thermo-Fisher-Scientific-Completes-Acquisition-of-PPD-Inc/default.aspx) | 공식 회사 공시 |

분해 한계: PPD 인수 금액, 세그먼트별 매출, clinical research 회복은 손익 전체 표가 아니라 공식 공시의 세부 표에서 온다. dartlab 연결이 직접 증명하는 것은 매출 계단, 마진 스파이크와 정상화, OCF 둔화까지이고, 유기 성장·M&A·코로나 특수 소멸의 몫은 연결 손익만으로 나누지 않는다.

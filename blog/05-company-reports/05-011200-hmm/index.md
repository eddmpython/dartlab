...
carousel:
  ...
  explainers:
  - term: SCFI 운임지수
    body: 상하이컨테이너운임지수 — 컨테이너 운임 수준을 보는 대표 지표입니다. HMM 이익이 이 운임 사이클에 따라 크게 출렁입니다.
  - term: 베타·R²
    body: 주가가 시장(코스피)을 얼마나 따라가는지 보는 지표입니다. HMM은 R²가 10%라 주가의 90%가 시장과 무관한 자기 사이클로 움직입니다.
  relatedNews:
  - title: HMM, 5척 중 4척은 호르무즈 해협 통과…통행료 변수에 촉각
    source: lkp.news
    date: '2026-06-26'
    url: http://www.lkp.news/news/articleView.html?idxno=81246
    track: naver
    description: 네이버 보관 뉴스 기준. 호르무즈·항로 변수 — 카드가 말한 '주가를 정하는 외부 변수(운임·홍해)'의 실제 사례입니다.
  - title: 휴전 흔들리자 다시 긴장…중동 리스크에 떠는 해운·항공업계
    source: asiatoday.co.kr
    date: '2026-06-28'
    url: https://www.asiatoday.co.kr/kn/view.php?key=20260628010009713
    track: naver
    description: 네이버 보관 뉴스 기준. 중동 리스크가 운임을 흔드는 구도 — HMM 사이클이 외부 변수에 좌우됨을 보여줍니다.
...
> 같은 시리즈: [SK하이닉스](/blog/000660-skhynix) · [삼양식품](/blog/003230-samyang-foods) · [두산에너빌리티](/blog/034020-doosan-enerbility) · [알테오젠](/blog/196170-alteogen) · HMM · [셀트리온](/blog/068270-celltrion) · [한화에어로스페이스](/blog/012450-hanwha-aerospace) · [HD현대일렉트릭](/blog/267260-hd-hyundai-electric) · [고려아연](/blog/010130-korea-zinc) · [에이피알](/blog/278470-apr) · [기업이야기 시리즈 전체](/blog/series/company-reports)



<HFDataLink code="011200" />
...
### 2년 연속 영업이익률 53% — 한국 상장사 역사에 없는 숫자

...
carousel:
  ...
  explainers:
  - term: 영업이익률(OPM)
    body: 매출에서 영업이익이 남는 비율입니다. CJ대한통운은 4.14%로 현대글로비스(7.01%)의 약 6할 — 규모는 1위지만 수익성은 절반 수준입니다.
  - term: 순차입금
    body: 전체 빚에서 보유 현금을 뺀 실질 부채입니다. 2013년 인수 차입의 그림자로 금융비용이 영업이익의 51%를 가져가, 순차입금 1.6조가 1조 아래로 내려가야 구조가 풀립니다.
  relatedNews:
  - title: '[택배 & Now] CJ대한통운, 세계은행그룹과 개발도상국 공급망 혁신 논의'
    source: ebn.co.kr
    date: '2026-06-25'
    url: https://www.ebn.co.kr/news/articleView.html?idxno=1713944
    track: naver
    description: 네이버 보관 뉴스 기준. 글로벌 사업 확장 — 카드가 말한 '글로벌 수익성 개선' 효율 동력입니다.
  - title: 반복·위험 작업은 로봇 사원에 맡긴다…자동화 속도 내는 물류 기업들
    source: biz.chosun.com
    date: '2026-06-26'
    url: https://biz.chosun.com/industry/company/2026/06/26/SYUS4X5RXJBZNALLB62N4XQF3M/
    track: naver
    description: 네이버 보관 뉴스 기준. 물류 자동화 — 카드가 말한 '매출이 아니라 효율에서 온 이익'의 원천입니다.

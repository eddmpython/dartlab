...
date: 2026-04-09
description: "75년 동업 파탄. 자사주 방어 2.3조. 부채비율 25%에서 94.7%로. 50년 만에 첫 분기 순손실. 그런데 2025년 영업이익은 사상 최대 1.2조. 경영권 전쟁이 재무제표에 남긴 흔적을 dartlab으로 뜯어본다."
...
ai:
  ...
  dataAsOf: "2026-04-09"
carousel:
  title: 고려아연은 사상 최대를 찍고 50년 만에 첫 적자를 봤다
  caption: |-
    고려아연은 2025년 매출 16.6조, 영업이익 1.2조로 사상 최대를 찍었습니다. 그런데 바로 직전, 2024년 4분기엔 50년 만에 첫 순손실을 봤습니다. 사업이 망해서가 아니라, 경영권을 지키는 데 2조3천억을 썼기 때문입니다.

    봐야 할 건 세 가지입니다. 95%까지 뛴 부채비율이 어디까지 내려오는가. 영업이익으로 이자를 겨우 2번 갚는 구조가 풀리는가. 그리고 사명은 '아연'이지만 매출의 절반을 책임지는 금·은 값이 꺾여도 이 실적이 버티는가.

    전쟁은 끝났습니다. 이제 재무제표가 전쟁 전으로 돌아갈 수 있는지가 다음 질문입니다.
  explainers:
  - term: 부채비율
    body: 자본 대비 빚의 비율입니다. 고려아연은 경영권 방어에 2.3조를 쓰며 25%에서 95%로 급등했고, 이게 어디까지 내려오는지가 회복의 척도입니다.
  - term: 이자보상배율
    body: 영업이익으로 이자를 몇 배 갚을 수 있는지 보는 지표입니다. 고려아연은 겨우 2배라, 늘어난 빚의 이자 부담이 풀리는지가 관전 포인트입니다.
  relatedNews:
  - title: '[K-산업 돋보기] 고려아연, 영풍·MBK 지배구조 지적에도 국내외 기관 긍정'
    source: metroseoul.co.kr
    date: '2026-06-28'
    url: http://www.metroseoul.co.kr/article/20260628500254
    track: naver
    description: 네이버 보관 뉴스 기준. 경영권 분쟁의 현재 — 카드가 말한 '전쟁이 끝났는가'를 둘러싼 최신 국면입니다.
  - title: 美 의회 실무대표단, '핵심광물 허브' 고려아연 온산제련소 방문
    source: newspim.com
    date: '2026-06-26'
    url: https://www.newspim.com/news/view/20260626000892
    track: naver
    description: 네이버 보관 뉴스 기준. 본업(제련) 건재 — 카드가 말한 '사업이 망해서가 아니다'를 뒷받침합니다.
  pinnedComment: 투자 판단이 아닙니다. 부채비율 회복 속도, 이자보상배율, 금·은 매출 비중 — 이 세 가지를 분기마다 봐야 합니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
  ...
  - layout: editorialStat
    ...
    unit: '%'
    context: |-
      돌멩이 하나에서 아연·금·은·안티모니 등 22종 금속을 뽑는다.
      제련수수료(TC)가 3년 만에 71% 폭락해 해외 경쟁사가 멈출 때,
      고려아연은 부산물로 사상 최대를 찍었다.
  ...
  - layout: editorialStat
    ...
    unit: 배
    context: |-
      중국이 수출통제를 걸자 안티모니 값이 1년 만에 $1.5만 → $6만.
      국내 유일 생산 기업 고려아연의 안티모니 영업이익 523억,
      전년의 10배가 됐다.
    image: antimony
  - layout: editorialBeat
    kicker: 경영권의 가격표
    line: |-
      ...
      [[94.7%]], 1년 만에
    sub: |-
      자사주로 경영권을 방어하는 데 2조3천억.
      단기차입금은 6천억에서 3.3조로 5.4배.
      50년 무차입 전통이 한 번의 공개매수로 무너졌다.
    image: research-lab
  - layout: editorialStat
    kicker: 영업이익은 올랐는데
    bigNumber: '−63'
    ...
    context: |-
      영업이익 +10%, 순이익 −63%.
      이자비용 3배 + 수수료 2배가 영업에서 번 돈을 잡아먹었다.
      경영권을 지키는 비용은 손익계산서 맨 밑줄에 찍힌다.
...
> 같은 시리즈: [SK하이닉스](/blog/000660-skhynix) · [삼양식품](/blog/003230-samyang-foods) · [두산에너빌리티](/blog/034020-doosan-enerbility) · [알테오젠](/blog/196170-alteogen) · [HMM](/blog/011200-hmm) · [셀트리온](/blog/068270-celltrion) · [한화에어로스페이스](/blog/012450-hanwha-aerospace) · [HD현대일렉트릭](/blog/267260-hd-hyundai-electric) · 고려아연 · [에이피알](/blog/278470-apr) · [기업이야기 시리즈 전체](/blog/series/company-reports)


<HFDataLink code="010130" />
...
2024년 4분기, 순손실 **-2,457억원**. 창사 50년 역사상 처음이다. 사업이 망해서 적자가 난 게 아니다. 경영권 방어에 2조3천억을 쏟아부었고, 부채비율 25%의 요새가 1년 만에 94.7%로 무너졌다.
...
부채비율 **25%에서 94.7%**. 1년 만에. 50년간 쌓아온 무차입 경영의 전통이 1번의 공개매수로 무너졌다.
...
Piotroski F-Score **4/9**. 총자산수익률 개선 X, CF>순이익 X, 장기부채 감소 X, 자산회전율 개선 X. 4개 항목이 불통과. 재무 건전성 신호가 **절반 이상 빨간불**이다.
...
### 매출 16.6조(+37.6%), 영업이익 1.2조(+70%) — 금은이 밀어올렸다
...
재무제표에 이 10조가 어떻게 찍히는가. 크루서블 유증 2.8조가 완료되면 자본이 커진다 — 부채비율이 내려갈 수 있다. 동시에 테네시 건설 설비투자가 2027~2029년에 걸쳐 찍힌다 — 차입이 더 늘어날 수 있다. **경영권 전쟁의 비용은 끝나지 않았다. 전쟁 후유증이 미국 제련소라는 형태로 재무제표에 계속 찍힌다.** 이 투자가 매출로 돌아오는 건 2030년 이후다.

---

## 10막 — 7막의 빚이 현금흐름에 찍혔다

### 잉여현금흐름 2년 연속 대규모 마이너스 — 자사주 상환 + 테네시 설비투자
...
**잉여현금흐름이 2년 연속 대규모 마이너스.** 영업이익은 사상 최대인데 현금이 나가고 있다. 2024년 -6,142억, 2025년 -15,712억.

왜? 두 가지가 겹쳤다. **첫째 — 자사주 매입 차입금 상환.** 2조3천억을 빌려서 자사주를 샀고, 그 빚을 갚고 있다. **둘째 — 테네시 제련소 투자.** 설비투자가 대규모로 나가기 시작했다. 사업에서 번 돈이 경영권 방어 빚 상환 + 미래 투자에 전부 빨려 들어가는 구조.
...
dartlab DCF 가정: WACC 9.2%, 영구성장률 2%, 직전 5년 평균 잉여현금흐름 기준. 경영권 프리미엄·전략광물 프리미엄은 DCF에 반영되지 않는다 — 이것이 괴리의 핵심이다. 28만원은 "아연 제련소"로서의 가치이고, 148만원은 시장이 보는 "전략광물 플랫폼 + 경영권"의 가치다.
...
**4. 테네시 제련소 착공/진행** — 10.9조 투자의 타임라인. 설비투자가 언제 어떤 규모로 찍히는가. 차입이 더 늘어나는가.

**5. 크루서블 유증 후 지분 구조** — 최윤범 우호 45.5% 확보 시 경영권 완전 안정. 그때 재무제표가 "전쟁 전"으로 돌아갈 수 있는가.

---

사명에 '아연'이 박혀 있지만 이 회사를 먹여 살리는 건 이미 은이다. 75년 동업을 끝내는 데 2조3천억이 들었다. 부채비율 25%에서 94.7%. 50년 만에 첫 순손실. 모든 숫자가 전쟁 전과 다르다.
...
| 부채비율 24.9%→94.7%, 단기차입 5.4배 | dartlab 실측 |

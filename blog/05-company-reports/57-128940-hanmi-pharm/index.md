...
ai:
  ...
  dataAsOf: "2026-04-19"
carousel:
  title: 4번 기술수출 반환당한 회사가 영업이익 사상 최대로
  caption: |-
    한미약품은 2025년 영업이익 2,578억, 순이익 1,871억으로 둘 다 사상 최대를 찍었습니다. 놀라운 건 이 회사가 9년 사이 글로벌 라이선스 계약을 네 번 반환당했다는 점입니다 — 사노피·베링거·얀센·GSK, 총 $54억이 공중분해됐습니다.
  ...
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[반환됐다]]
    sub: |-
      사노피 $39억, 베링거 $7.3억, 얀센 $9.15억, GSK까지.
      2016년 베링거 반환엔 주가가 하루 −18%.
      신약 개발의 운명이다.
    image: research-lab
  - layout: editorialStat
    ...
    unit: '% R&D/매출'
    context: |-
      사노피 반환 직후, R&D를 매출의 34.6%(3,724억)까지 태웠다.
      그해 영업이익은 490억으로 추락.
      한국 제약 평균 R&D 비율(6~8%)의 5배.
    image: research-lab
  - layout: editorialBeat
    kicker: 그래도 안 망한 이유
    line: |-
      ...
      [[57% 10년]]
    sub: |-
      에소메졸·아모잘탄 같은 개량신약 6~7개가 하단을 받쳤다.
      원가율 30%대 제품이 매출의 60% —
      R&D를 태워도 회사가 흔들리지 않는 바닥.
    image: hanmi-factory-palm
  - layout: editorialStat
    kicker: 5년의 회수
    bigNumber: '5.3'
    unit: 배
    context: |-
      영업이익 490억(2020) → 2,578억(2025).
      태운 R&D가 롤베돈 FDA 승인·로열티로 돌아오기 시작했다.
      부채비율도 132%에서 50%로 절반.

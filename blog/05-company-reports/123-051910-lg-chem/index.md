...
ai:
  ...
  dataAsOf: "2026-06-14"
carousel:
  title: 영업이익은 올랐는데, 주인 몫은 왜 더 깊이 꺼졌나
  caption: |-
    LG화학 2025년 연결 영업이익은 1.19조, 전년 0.92조보다 올랐습니다. 보통은 좋은 신호죠. 그런데 같은 해 주주 귀속 순익(지배주주순익)은 -1.82조, 전년 -0.69조에서 적자가 약 2.6배 깊어졌습니다. 한 손익표에서 두 화살표가 정반대로 갈라집니다.

    그 거리의 정체는 뺄셈 하나입니다. 2025년 총순익 -0.98조인데 지배순익 -1.82조 — 차액 +0.84조(2024년은 +1.21조)가 비지배지분 귀속분입니다. 상장 자회사를 100% 인식한 뒤 소수주주 몫을 빼면 '주인 몫'이 더 깊은 적자가 됩니다. 분식이 아니라 정상 연결회계입니다.

    관전 포인트는 차액의 추이입니다. 2024 +1.21조 → 2025 +0.84조로 이미 좁혀졌고, 2026 차액이 더 줄면 신호입니다. 단, 차액=비지배 몫까지만 — 특정 자회사로 환산하지 않습니다(81.84% 보유·NAV 디스카운트는 전부 외부).
  explainers:
  - term: 지배주주순익 vs 총순익
    body: 총순익에서 상장 자회사의 소수주주 몫(비지배지분)을 뺀 것이 '주인 몫(지배순익)'입니다. 자회사 적자를 100% 반영한 뒤 빼면 주인 몫이 더 깊은 적자가 됩니다.
  - term: 비지배지분
    body: 자회사 지분 중 모회사가 갖지 않은 부분입니다. 이 몫만큼 차감돼, 영업이익과 지배순익이 정반대로 갈렸습니다(분식 아닌 정상 연결회계).
  relatedNews:
  - title: 에틸렌 스프레드 두 달 새 절반으로…석화업계 하반기 역마진 공포
    source: biz.heraldcorp.com
    date: '2026-06-28'
    url: https://biz.heraldcorp.com/article/10789682?ref=naver
    track: naver
    description: 네이버 보관 뉴스 기준. 본업(석유화학) 마진 악화 — 적자가 깊어진 배경의 한 축입니다.
  - title: LG화학, 신용도 흔들…현금창출력이 '관건'
    source: daily.hankooki.com
    date: '2026-06-25'
    url: https://daily.hankooki.com/news/articleView.html?idxno=1379926
    track: naver
    description: 네이버 보관 뉴스 기준. 재무·현금 부담 — 손익표 두 화살표가 갈리는 카드 논제의 재무 맥락입니다.
  pinnedComment: 투자 판단이 아닙니다. 연결 영업이익·지배순익·총순익·영업CF·차액은 dartlab 연결 실측(2026-06-14), 81.84% 보유·물적분할·시총 역전·NAV 디스카운트는 외부 인용입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
      ...
      [[주인 몫은 더 깊이 꺼졌다]]
    sub: |-
      LG화학 (051910) 연결 손익 한 장
      영업이익 한 줄로는 못 읽는 한 해
    image: petrochem-battery
  ...
  - layout: editorialBeat
    kicker: 차액에 이름 붙이기
    line: |-
      총순익 -0.98조인데 지배순익 -1.82조
      [[차액 +0.84조 = 비지배지분 귀속분]]
    sub: |-
      2024년 차액은 +1.21조였다. 100% 인식 뒤 소수주주 몫을 빼면 주인 몫이 더 깊은 적자가 된다 — 분식이 아니라 정상 연결회계.
    image: nav-discount
  - layout: editorialBeat
    kicker: 못 박는 한계
    line: |-
      '곧 LG엔솔 18.2%분'으로 등치하면
      [[2024 차액 1.21조÷0.182≈6.65조 — 반증된다]]
    sub: |-
      (앞 장 2025 차액 0.84조가 아니라 2024 차액 1.21조로 검산.) 자회사 순익 규모상 불가능한 값. 차액엔 다수 종속회사 비지배지분과 본업 손익이 섞인다.
    image: petrochem-battery
  - layout: editorialBeat
    kicker: 멈추는 자리 · 다음에 볼 지표
    line: |-
      내부가 증명하는 건 '연결-지배 괴리'까지
      [[다음 신호는 차액의 추이다]]
    sub: |-
      2024 +1.21조 → 2025 +0.84조. 2026 차액이 더 줄면 신호. 시총 역전·NAV 디스카운트 해소는 외부의 몫 — 매수 시그널로 오독 금지.
    image: two-companies
---
...
![연결 영업이익은 오르고(파랑) 지배주주순익은 더 깊이 꺼졌다(빨강)](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/b0/b0d3d2b4cec8affcb3b72c1d7c99244d3305da6aac81150416c9d418cce29acd.svg)
...
![연결 OPM 사이클 — 2021 11.8% 정점 이전에 2018→2021 +123% 상승이 선행했다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/34/348f56f0c927042e79e52354f453ff5b8d152a1f0317b2ceff141495fb38bb92.svg)
...
![차액(총순익 - 지배순익)이 비지배지분 귀속분 — 단, LG엔솔 18.2%분과 등치는 산술로 반증된다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/aa/aa8f954591f8c7e1e32643e1764844e0e774fbf868161765a57f9634169b32f0.svg)
...
![상장 자회사 손익이 100% 연결로 들어오고, 비지배지분만큼이 빠져 '주인 몫'이 된다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/3a/3a33fb8646ce0e17c3978d1d34c6cdffa23b61cb0f92399d3fcdab3d7b1a7397.svg)
...
![영업CF는 견고하나 연결 합산치 — '주인 몫 현금'이 아니다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/8d/8da511e45f7e6541a06c9a4f733979c1cd9e97fb1aee83326f2f744bd11f1277.svg)
...
![LG화학 — 2026년에 봐야 할 다섯 가지](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/cb/cb6b0643f3e7ddf43c2b37fa6b4786acf605e1f3ef9d4f40d3b0be193e770908.svg)

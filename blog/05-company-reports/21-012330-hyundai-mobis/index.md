...
ai:
  ...
  dataAsOf: "2026-04-12"
carousel:
  title: 같은 회사인데 연결 영업이익률 5.5%, 별도는 21% — 15%p 갭의 정체
  caption: |-
    현대모비스의 2025년 연결 영업이익률은 5.5%. 글로벌 부품사 평균 수준입니다. 그런데 별도로 보면 21%. 같은 회사의 두 숫자가 15%p 넘게 벌어집니다.

    갭의 정체는 AS(순정) 부품입니다. 매출의 30%인데 영업이익의 60~70%를 만듭니다. 같은 부품이 신차용은 1만 원, AS로 팔리면 3만 원. 차 한 대가 10~15년 부품 수요를 만들고, 도로 위 현대·기아차는 1억 대가 넘습니다.

    그런데 PBR은 0.67배. 덴소(1.5배)의 절반도 안 됩니다. 별도 21% 현금기계인데 글로벌 최저 평가. 이유는 재무가 아니라 순환출자입니다 — 모비스→현대차→기아→모비스 고리의 정점인데 정의선 회장 지분은 0.32%. 2018년 개편안이 엘리엇·국민연금 반대로 철회된 뒤 8년째 디스카운트입니다.
  explainers:
  - term: AS 부품(순정)
    body: 이미 팔린 차의 수리·교체 부품입니다. 같은 부품도 신차용보다 비싸게 팔려, 매출의 30%인데 영업이익의 60~70%를 만드는 독점 현금원입니다.
  - term: 순환출자
    body: 모비스→현대차→기아→모비스로 도는 지분 고리입니다. 그 정점이라 지배구조·승계 이슈로, 별도 21% 현금기계인데도 PBR 0.67배로 저평가됩니다.
  relatedNews:
  - title: 현대모비스, 로봇 핵심 부품 기업으로 '부상'…사업 재편 가속화
    source: hansbiz.co.kr
    date: '2026-06-25'
    url: http://www.hansbiz.co.kr/news/articleView.html?idxno=846428
    track: naver
    description: 네이버 보관 뉴스 기준. AS 부품 너머 로봇·전동화로의 사업 재편 — 현금기계가 다음 성장 축을 어디서 찾는지 보여줍니다.
  pinnedComment: 투자 판단이 아닙니다. 별도 영업이익률 21% 유지·연결 8% 이상·PBR 0.8배 — 이 세 숫자가 같이 나오는 날이 승계 퍼즐이 풀리는 신호입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
  ...
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[신차 1만, AS 3만]]
    sub: |-
      차 한 대가 10~15년 부품 수요를 만든다.
      도로 위 현대·기아차 1억 대 +
      순정 점유율 70~80%.
    image: auto-parts
  - layout: editorialStat
    kicker: 그런데 왜 PBR 0.67배인가
    bigNumber: '0.67'
    unit: 배 PBR
    context: |-
...
그런데 별도 재무제표를 열어보면 완전히 다른 회사가 나온다. 매출 16조 원, 영업이익 약 3.4조 원. 영업이익률 **약 21%**. 반도체 호황기 SK하이닉스에 근접하는 마진. 전 세계 자동차 부품회사 중 영업이익률 20%를 넘는 회사는 손에 꼽는다. 독일 콘티넨탈? 5%. 일본 덴소? 5.7%. 프랑스 발레오? 3%대. 21%는 부품사의 세계에서 말이 안 되는 숫자다.
...
**모듈 사업부.** 현대차와 기아에 자동차 모듈을 공급한다. 섀시 모듈(하체), 콕핏 모듈(운전석 통합 부품), 프런트엔드 모듈(앞부분), 그리고 최근 비중이 급증한 전동화 모듈(전기차 구동계, 배터리 시스템). 매출의 70% 내외를 차지하지만 마진은 얇다. 추정 영업이익률 3~5%. 왜? 그룹 캡티브 거래이기 때문이다. 현대차가 원가를 압박하고, 모비스는 납품한다. 독립된 갑을 관계가 아니라 그룹 내부 거래라 마진이 크게 나올 구조가 아니다.

**AS(After Service) 부품 사업부.** 매출의 30% 정도다. 그런데 이 쪽이 **영업이익의 60~70%를 만든다**. 숫자만 봐도 마진 차이가 짐작된다. 업계에서는 AS 부품 사업부의 영업이익률을 **20~25%**로 본다. 사업부별 수치는 공시되지 않지만, 별도 영업이익률 21%와 모듈 사업부 추정 마진을 역산하면 그림이 그려진다.
...
영업이익률이 11%에서 21%로 **10%p 올랐다**. 5년간의 일이다. 무슨 일이 있었나?
...
AS 부품은 한국에서 압도적이다. 그런데 해외에서는? 해외 시장에서는 현대/기아 차의 비중이 훨씬 작고(글로벌 점유율 8% 수준), 현지 딜러 인프라가 약하고, 비순정 부품과의 경쟁이 치열하다. 그래서 해외 AS 마진은 한국 수준이 안 나온다. 이게 연결 영업이익률을 희석하는 핵심 변수다.
...
덴소도 지분 구조가 비슷하다(도요타가 최대주주). 그런데 덴소 PBR은 1.5배. 모비스와 **2배 이상 차이**가 난다. 덴소가 모비스보다 마진이 낮은데도(덴소 영업이익률 5.7%, 모비스 연결 5.5% 비슷) 시장가치는 훨씬 높다. 이 갭을 설명하는 건 하나뿐이다. **지배구조 투명성**.
...
그런데 여기서 역설이 발생한다. **해외 비계열 수주가 늘어날수록 연결 영업이익률이 떨어진다.**
...
- 해외 비계열 수주 증가 → 연결 매출 성장 → **연결 영업이익률 하락**
- 별도 AS 매출 증가 → 별도 매출 성장 → **별도 영업이익률 상승**

2025년 연결 영업이익률 5.5%와 별도 영업이익률 21%가 동시에 나오는 이유다. 두 엔진이 서로 다른 방향으로 돌고 있다.
...
현대모비스의 실체는 두 개의 회사다. 하나는 **별도 영업이익률 21%의 독점 현금기계**(AS 부품). 또 하나는 **연결 영업이익률 5.5%의 평범한 글로벌 부품사**(해외 신차 모듈). 둘이 한 몸에 붙어 있다.
...
2. **별도/연결 갭 축소**: 해외 AS 시장이 의미 있게 열려서 연결 영업이익률이 8~10%로 올라가는 순간. PBR 0.8~0.9배. 주가 30~40% 상승.

둘 다 시간이 걸린다. 1번은 2~5년 정치의 영역. 2번은 2030년대 이후 해외 AS 성숙기.

그때까지 투자자가 받는 건 **배당(성향 35%+) + 자사주 소각 + 별도 영업이익률 21%의 현금 누적**이다. 이게 지루하지만 파괴적이지 않다. 다운사이드 리스크가 제한적이라는 뜻.

모비스를 한 문장으로 요약하면: **"순환출자 고리의 정점에 앉아 AS 부품 독점으로 현금을 쌓는 회사. 그 현금이 주주에게 언제 온전히 돌아올지 아무도 모른다."** 이게 재미있지만 답답한 회사인 이유다.

그래서 기준선.

**"별도 영업이익률 21% 유지 + 연결 영업이익률 8% 이상 + PBR 0.8배 이상. 이 세 숫자가 동시에 나오는 날이 승계 퍼즐이 풀리기 시작하는 신호다."**
...
모비스의 현금이 어떻게 쓰이는지 — 배당과 자본배분을 뜯어본다.

---

## 제6막: 배당과 자사주 — 3조를 벌어서 1조를 돌려주는 구조

### 배당 이력 5년 — 성향 35%, 수익률 3%

모비스의 배당 정책은 "보수적이지만 안정적"이다. 배당성향 30~40%, 수익률 2.5~3.5%. 화려하지 않다. [SK텔레콤](/blog/017670-skt)의 배당성향 143%(2021)이나 [HDC현대산업개발](/blog/294870-hdc-hyundai-dev)의 무배당과 비교하면 "중간"이다.

| 연도 | 주당 배당 | 배당성향 | 배당수익률 | 순이익(조) |
|---|---:|---:|---:|---:|
| 2021 | 4,000 | 32% | 1.8% | ~2.4 |
| 2022 | 4,000 | 25% | 2.0% | ~2.5 |
| 2023 | 5,000 | 30% | 2.4% | ~3.4 |
| 2024 | 6,000 | 35% | 2.8% | ~1.3 |
| 2025 | 7,000 | 35% | 3.1% | ~2.6 |

5년간 주당 배당이 4,000원에서 7,000원으로 75% 증가했다. 나쁘지 않다. 하지만 숫자 뒤를 보면 의문이 생긴다.

```python
import dartlab
c = dartlab.Company("012330")
c.analysis("financial", "자본배분")
# 배당성향 35% = 벌어들인 3조 중 약 1조만 주주에게
# 나머지 2조는 어디로?
```

### 2조는 어디로 갔나 — 잉여금 누적 vs 자사주

연간 2조 원이 주주에게 돌아가지 않고 회사에 남는다. 이 현금의 행방:

| 용도 | 금액(연간 추정) | 비고 |
|---|---:|---|
| 설비투자(CAPEX) | ~0.8조 | 전동화 모듈 공장 |
| R&D | ~0.5조 | 자율주행·전장 |
| 자사주 매입·소각 | ~0.3조 | 2024년 3,000억 소각 |
| 현금 누적 | ~0.4조 | 순현금 포지션 확대 |

**2024년 자사주 소각 3,000억 원.** 이건 긍정적 신호다. 자사주 소각은 주당 가치를 높인다. 하지만 3,000억은 전체 잉여금(~2조) 대비 15% 수준이다. "하는 편"이지 "열심히 하는 편"은 아니다.

### 잉여현금흐름 커버리지 — 배당은 충분히 감당 가능한가

모비스의 잉여현금흐름(FCF) 대비 배당 지급률을 보면:

| 연도 | 영업활동현금흐름(조) | 설비투자(조) | 잉여현금흐름(조) | 배당 총액(조) | 잉여현금흐름/배당 |
|---|---:|---:|---:|---:|---:|
| 2022 | 2.2 | 0.7 | 1.5 | 0.4 | 3.8x |
| 2023 | 5.3 | 0.8 | 4.5 | 0.5 | 9.0x |
| 2024 | 4.3 | 0.9 | 3.4 | 0.6 | 5.7x |
| 2025 | 4.5 | 1.0 | 3.5 | 0.7 | 5.0x |

잉여현금흐름이 배당의 4~9배. **배당을 2배로 올려도 잉여현금흐름이 감당한다.** 문제는 "할 수 있는가"가 아니라 "할 의향이 있는가"다. 순환출자 구조에서 모비스의 현금이 주주에게 과도하게 돌아가면, 그룹 전체의 재원이 줄어든다. 현대차와 기아가 모비스 현금에 의존하는 부분이 있다.

### 총주주환원율 — 글로벌 피어 대비

배당 + 자사주 소각을 합친 **총주주환원율(TSR)**로 글로벌 피어와 비교하면:

| 기업 | 배당수익률 | 자사주 소각/시총 | 총환원율 |
|---|---:|---:|---:|
| **현대모비스** | 3.1% | ~1.5% | **~4.6%** |
| 덴소 | 2.0% | 1.0% | ~3.0% |
| 마그나 | 3.5% | 2.0% | ~5.5% |
...
모비스의 총환원율 4.6%는 글로벌 피어 중 마그나(5.5%) 다음으로 높다. PBR 0.67배에 환원율 4.6% — 숫자만 보면 매력적이다. 하지만 이 환원율이 승계 이벤트 때 어떻게 바뀔지가 불확실성이다.

---

## 제7막: PBR 0.67배 — 글로벌 부품사 최저, 해소 조건은 하나

### 글로벌 부품사 밸류에이션 비교

PBR은 기업의 **자산가치 대비 시장이 매기는 가격**이다. 모비스 PBR 0.67배는 자산 1조를 6,700억에 산다는 뜻이다.

| 기업 | 국가 | PBR | PER | 영업이익률(연결) | 배당수익률 |
|---|---|---:|---:|---:|---:|
| **현대모비스** | 한국 | **0.67** | 6.5 | 5.5% | 3.1% |
| 덴소 | 일본 | 1.5 | 18 | 5.7% | 2.0% |
| 마그나 | 캐나다 | 1.1 | 8 | 4.1% | 3.5% |
| 콘티넨탈 | 독일 | 0.9 | 12 | 5.0% | 2.5% |
| ZF | 독일 | 1.2 | 10 | 4.5% | — |
| 발레오 | 프랑스 | 0.4 | 6 | 3.2% | 4.0% |

```python
c = dartlab.Company("012330")
c.analysis("financial", "종합평가")
# PBR 0.67: 글로벌 주요 부품사 중 발레오(프랑스, 0.4)에 이어 최하위권
# 발레오는 구조조정 중 — 모비스는 실적 양호한데도 할인
```

모비스보다 PBR이 낮은 회사는 **구조조정 중인 발레오(0.4)**뿐이다. 콘티넨탈(0.9), 마그나(1.1), 덴소(1.5) — 실적이 비슷하거나 못한 회사들이 모비스보다 PBR이 50~100% 높다.

### PBR 0.67의 원인 분해

| 디스카운트 요인 | 추정 영향 | 피어 대비 PBR 갭(배) |
|---|---:|---:|
| 한국 주식 할인(Korea Discount) | -0.15 | PBR 1.0 → 0.85 |
| 순환출자·승계 불확실성 | -0.10 | 0.85 → 0.75 |
| 연결 영업이익률 희석(해외 저마진) | -0.08 | 0.75 → 0.67 |
| **합계** | **-0.33** | **1.0 → 0.67** |

세 요인이 동시에 작용한다. Korea Discount는 모든 한국 대형주에 적용되는 구조적 할인이다. 순환출자·승계 불확실성은 모비스 특유의 할인이다. 연결 영업이익률 희석은 해외 법인의 구조적 저마진이다.

### 해소 조건 — 승계가 풀리면 얼마까지 가는가

세 디스카운트 중 **유일하게 해소 가능한 것이 순환출자·승계 불확실성**이다. Korea Discount와 해외 법인 저마진은 단기간에 바뀌지 않는다.

| 이벤트 | PBR 영향 | 가능 시점 |
|---|---:|---|
| 승계 구조 확정 (순환출자 해소) | +0.15~0.25 | 2~5년 |
| 밸류업 프로그램 참여 (자사주 확대) | +0.05~0.10 | 1~2년 |
| 해외 법인 수익성 개선 | +0.05~0.10 | 3~5년 |
| **낙관 시나리오 합계** | **PBR 0.67 → 1.0+** | — |

PBR 1.0배면 시총 약 27조. 현재 시총 18조 대비 **+50%.** 여기에 연간 배당(주당 7,000원, 수익률 3%)을 더하면 5년간 총 수익률 65%+. 년평균 11%.

하지만 이건 **승계가 풀린다는 전제**다. 풀리지 않으면 PBR 0.6~0.7 박스에 8년 더 갇힌다. 2018년부터 이미 8년. 2033년까지 16년이 될 수도 있다.

### 한 문장 요약

모비스는 **"별도 영업이익률 21%의 현금기계 + 배당 3% + 자사주 소각"이 PBR 0.67배에 살 수 있는 회사**다. 싸게 살 수 있는 이유는 하나: 정의선 승계가 언제 어떻게 풀릴지 아무도 모른다. 이 불확실성을 감내할 수 있으면 사고, 없으면 말라. 재무적으로는 답이 나와 있지만, 지배구조가 숫자를 덮고 있다.
...
| 본문 수치 | 출처 |
|---|---|
| 연결 매출 61조, 영업이익률 5.5% | dartlab (DART 사업보고서) |
| 별도 매출 16조, 영업이익률 21% | dartlab (DART 별도 재무제표) |
...
> **면책**: 이 보고서는 공시 기반 실측 데이터와 공개 보도를 토대로 한 분석적 기록이며, 투자 권유가 아닙니다. 모든 수치는 작성 시점 기준이며, 투자 판단의 책임은 독자에게 있습니다.


---

<CompanyFinancials code="012330" />

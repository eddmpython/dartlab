...
date: 2026-06-14
description: "FY20부터 FY25까지 매출은 18.8% 늘었는데 영업이익은 30.2% 늘었다. 이익이 매출을 앞지른 그 비대칭이 가격결정력의 진짜 자국이다. 단 사상 최고 마진을 찍은 FY25는 '가격을 더 올려서'가 아닐 수 있는 국면 전환 위의 숫자다 — 그 경계까지만 있는 그대로 읽는다."
...
ai:
  ...
  dataAsOf: "2026-06-14"
carousel:
  title: P&G — 매출은 제자리인데 이익만 앞서간 5년
  caption: |-
    "성장주는 매출부터 본다"는 상식, P&G에선 틀립니다. FY20→FY25 매출은 +18.8% 느는 동안 영업이익은 +30.2% 늘었습니다. 이익이 매출보다 약 1.6배 빨리 자란 거죠.
  ...
  - layout: editorialStat
    kicker: FY20 → FY25 영업이익 성장
    bigNumber: '+30.2'
    unit: '%'
    context: |-
      매출은 같은 기간 +18.8%
      이익이 매출보다 약 1.6배 빨리 자랐다
      가격을 올려도 안 떠나는 힘(가격결정력)의 자국
    image: cleaning
  - layout: editorialBeat
    kicker: 비대칭은 어디에 찍혔나 — GPM
    line: |-
      매출총이익률 FY22 47.4% 저점에서
      51.2%로 [[3.8%p 되돌아왔다]]
    sub: |-
      가격만의 힘이 아니다 — 원가완화와 겹친 되돌림 (FY25)
    image: personal-care
  - layout: editorialStat
    kicker: 영업이익률(OPM) FY25
    bigNumber: '24.3'
    unit: '%'
    context: |-
      5년 중 최고지만 FY21 23.6% 대비 +0.7%p
      '극적 확장'이 아니라 '밴드 상단 갱신'
      비대칭의 무게는 매출총이익 단에 실렸다
    image: supermarket-shelf
  - layout: editorialBeat
    kicker: 최대 함정 — FY25
    line: |-
      ...
      [[영업이익만 +1.90B 뛰었다]]
    sub: |-
      가격으로 단정하면 비약 — 7,000명 감원(외부)이 겹친 국면
    image: cleaning
  - layout: editorialBeat
    kicker: 결론 + 다음에 볼 지표
    line: |-
      ...
      [[무한히 끌 수는 없다]]
    sub: |-
      다음: FY26 매출 회복 속 OPM 24%대 방어 여부
    image: personal-care
---
...
![매출은 +18.8%인데 영업이익은 +30.2% — 이익이 매출을 앞지른 비대칭](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/45/4549cf93d5d42bf7d4d1ec871a6576a9e090444bccaf4c2e7e95c37c4090236f.svg)

관통선은 하나다. **"매출은 거의 제자리에 가까운데 이익만 앞서간 이 회사는, 무엇으로 그 차이를 만들었고 — 그 힘은 어디까지가 진짜인가?"** 답을 *경계까지만* 분명히 쓴다. 먼저 주의 포인트 하나를 박고 들어간다. FY19의 영업이익률 8.1%는 P&G의 실력이 아니라 **질레트 영업권·무형자산 손상**(외부 인용: 약 $8B, 일회성·비현금) 때문이다. 그래서 추세선에서 FY19를 빼고, 정상화 기준점은 **FY20**으로 둔다.
...
매출은 FY20 70.95B에서 FY25 84.28B로 **+18.8%**, 영업이익은 15.71B에서 20.45B로 **+30.2%**. 이익이 매출보다 1.6배 빠르다. 이것이 관통선의 1차 증거다. 유의 단서를 동행한다 — 기준점 FY20은 FY19 손상 *직후*라 회복분이 일부 끼는 base effect가 있다. 그래서 FY19를 anchor로 쓰지 않고 FY20을 기준점으로 못 박는 것이다.
...
OPM은 FY20 22.1%에서 FY25 **24.3%**로 올라 5년 중 최고를 갱신했다. 다만 짚어 둘 것이 있다 — FY21에 이미 23.6%였으니 FY25 24.3%는 그보다 **0.7%p** 높을 뿐이다. '극적 확장'이 아니라 '밴드 상단 갱신'까지가 정확한 표현이다. 중간 FY22~FY24는 22.1~22.2% 밴드에 머물렀다.

![OPM은 22~24% 밴드, 진짜 주인공은 GPM이 47.4%에서 51.2%로 되돌아온 곡선](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/73/736f044f9632ca2f68ee373766285ccbfbac44911dabf693b6b0278e519ed66b.svg)
...
![매출총이익률이 FY22 47.4% 저점에서 FY25 51.2%로 3.8%p 되돌아왔다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/a8/a8e209b5fbfcd5c13c96da823b5c04db7d3969941a498dc5e111cc275cc8892f.svg)
...
![FY24 organic +4%는 전량 가격 — 가격을 올려도 물량이 안 빠졌다 (외부 인용)](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/7f/7f12e39fc133b9e142e0167c985f16e21eaa19ed6b0dfc71a1fe3461e942de32.svg)
...
![FY25는 매출 정체(+0.24B) 위에 이익만 뛴 해 — 가격 아닌 비용 이야기일 위험](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/37/376255d9dcebda4779dc7637c4b0a9166ad653414d6198103ed4392855eb20ca.svg)
...
**왜 마지막이 단정이 아니라 경계인가.** 가격결정력은 실재하지만 마진을 무한히 끌 수 없고, '왜'는 검증선 끝에서 멈춰야 과장이 없기 때문이다.
...
![P&G — 2026년에 봐야 할 다섯 가지](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/b5/b52227cf3c5ac44928bf6b68d4ac109b9ca3d85b7504d4476affd34d771a9626.svg)

---

## 재무제표 — 최근 7개년 (dartlab 연결, $B)

> 미국 연결(USD)·회계연도(6월말) 합산 기준. FY19는 질레트 손상으로 영업이익이 왜곡됐다(추세 기준점 제외). dartlab에서 직접 확인:
> ```python
> import dartlab
> c = dartlab.Company("PG")
...
이 표를 한 줄로 읽으면 이렇다 — **매출 행이 +18.8% 오르는 동안 영업이익 행이 +30.2% 올라 둘 사이가 벌어진다.** 그 틈의 정체는 GPM 행에 있다(FY22 47.4% → FY25 51.2%). 그리고 가장 주목해서 봐야 할 칸은 FY24→FY25다 — 매출은 0.24B 늘었는데 영업이익이 1.90B 늘었다. 매출·이익 행만 보면 평범한 성장이지만, GPM의 *되돌림*과 매출 정체 위의 이익 점프를 겹쳐 보면 이건 '많이 판 회사'가 아니라 '비싸게 팔고도 안 떠난, 그리고 비용을 깎은' 회사의 손익이다(가격 vs 비용의 분해는 외부).

...
ai:
  ...
  dataAsOf: "2026-04-12"
carousel:
  title: 한 분기에 5,524억을 털어낸 건설사 — GS건설 빅배스의 진짜 의미
  caption: |-
    2023년 4분기, GS건설 영업손실 -4,189억. 상반기까지 흑자(Q1 +1,750억·Q2 +130억)였던 회사가 Q3 -1,575억으로 검단 손실이 시작됐고, Q4에 5,524억 일회성 비용을 한 번에 몰아 털었습니다. 검단 자이 지하주차장이 무너진 대가였습니다(입주 전·야간이라 인명피해 0).

    반전은 그 다음입니다. 2023년 연간 -3,879억 적자에서 2024년 +2,860억으로 바로 흑전. 인명피해가 있던 HDC현산은 손실을 3년(2022~24)에 나눠 반영(~4,100억, 외부 집계)하며 흑전·정상화까지 4년이 걸린 반면, GS는 한 분기에 몰아 털고 1년 만에 돌아섰습니다. 인명피해 유무가 역설적으로 전략 선택지를 갈랐습니다.

    관전 포인트: 2024년 흑자의 일부는 과거 충당금 환입입니다. 진짜 회복인지 보려면 환입이 소진된 뒤에도 영업이익률 5%대가 유지되는지, 2026~2027년 검단 재시공 완공이 무사한지를 봐야 합니다.
  explainers:
  - term: 빅배스(big bath)
    body: 부실을 한 분기에 몰아서 한꺼번에 털어내는 회계 전략입니다. GS건설은 검단 손실 5,524억을 2023년 4분기에 다 반영하고 1년 만에 흑자로 돌아섰습니다.
  - term: 충당금 환입
    body: 미리 쌓아둔 손실 대비 자금이 예상보다 적게 쓰여 이익으로 되돌아오는 것입니다. 2024년 흑자의 일부라, 환입이 끝난 뒤에도 이익률이 유지되는지가 진짜 회복의 시험대입니다.
  relatedNews:
  - title: 10대 건설사, 상반기 수주액 26조 육박…상반기 도시정비 승자는
    source: sisajournal-e.com
    date: '2026-06-25'
    url: https://www.sisajournal-e.com/news/articleView.html?idxno=421990
    track: naver
    description: 네이버 보관 뉴스 기준. 도시정비 수주 회복 — 카드가 물은 '진짜 회복'을 떠받칠 신규 일감입니다.
  - title: 20조 쓸어담은 정비 큰손들…3사 동반 '10조' 신기원 열릴까
    source: mediapen.com
    date: '2026-06-26'
    url: https://www.mediapen.com/news/view/1106646
    track: naver
    description: 네이버 보관 뉴스 기준. 정비 수주 호황 — 빅배스 이후 외형 회복의 배경입니다.
  pinnedComment: 투자 판단이 아닙니다. 분기·연간 영업이익과 일회성 비용은 DART·사업보고서 기준 dartlab 실측, HDC 분산 반영 ~4,100억과 시평 순위는 외부 인용입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
  ...
  - layout: editorialStat
    kicker: 2023 Q4 일회성 비용
    bigNumber: '5,524'
    unit: 억 원
    context: |-
      빅배스 = 부실을 한 분기에 몰아 털기
      검단 17개 동 전면 재시공·
      타 현장 보강·영업정지 충당까지 반영
    image: site-control
  - layout: editorialStat
    kicker: 2023 Q4 영업이익
    bigNumber: '-4,189'
    ...
    context: |-
      5,524억을 몰아 털어낸 결과
      Q3 -1,575억으로 손실이 시작된 뒤
      Q4에 본격 빅배스로 몰았다
    image: engineering-detail
  - layout: editorialBeat
    kicker: 반전 — 왜 한 번에?
    line: |-
      인명피해 0명인데 17개 동 전면 재시공
      [[자금 여력이 있어서 "선택"한 빅배스]]
    sub: |-
      HDC현산(6명 사망)은 빅배스 불가
      손실을 3년(2022~24)에 나눠 반영(~4,100억, 외부)
    image: project-site
  - layout: editorialStat
    kicker: 회복 속도 — 흑전까지
    bigNumber: '1'
  ...
  - layout: editorialBeat
    kicker: 다음에 볼 지표
    line: |-
      2024 흑자엔 충당금 환입이 섞여 있다
      [[환입 소진 뒤에도 OPM 5%대 유지되나]]
    sub: |-
      2025 3Q 누적 +1,621억(+130% YoY)·OPM 약 5.0%
      검단 재시공 2026~2027 완공이 마지막 시험대
    image: engineering-detail
---

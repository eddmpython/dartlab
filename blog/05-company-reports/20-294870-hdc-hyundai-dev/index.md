...
ai:
  ...
  dataAsOf: "2026-04-12"
carousel:
  title: 2,500억 날리고 6명 사망 사고까지, 그런데 살아남았다
  caption: |-
    HDC현대산업개발은 5년 동안 회사가 없어져도 이상하지 않을 일을 겪었습니다. 2019년 아시아나 2.5조 인수가 코로나로 깨지며 계약금 2,500억이 전액 증발했고(2025년 대법원 확정), 2022년엔 화정아이파크 39층이 무너져 6명이 죽었습니다. 브랜드 평판은 꼴찌였습니다.
  ...
  - layout: editorial
    ...
    line: |-
      ...
      그런데 [[살아남았다]]
    sub: |-
      계약금 2,500억 전액 증발, 39층 아파트 연쇄 붕괴,
      브랜드 평판 꼴찌. 회사가 없어져도 이상하지 않았다.
    image: hwajeong-collapse
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[무너진 아파트]]
    sub: |-
      2019년 아시아나 2.5조 인수가 코로나로 깨지며
      계약금 2,500억 증발(2025 대법원 확정).
      2022년 화정아이파크 39층이 무너져 6명 사망.
    image: hwajeong-collapse
  - layout: editorialStat
    ...
    unit: '% 영업이익률'
    context: |-
      영업이익 2,486억(+34.7%), 건설 빅4 중 영업이익률 1위.
      같은 해 현대건설은 1.2조 적자, 대우건설은 이익 −39%.
      업계가 초토화된 한가운데서 HDC현산만 이익이 늘었다.
    image: project-site
  - layout: editorialBeat
    kicker: 살아남은 이유
    line: |-
      ...
      [[돈이었다]]
    sub: |-
      자체개발 비중 55% — 자기 땅에 짓고 분양해 마진이 남는다.
      도급 수주가 막힌 2년을 자체 분양 현금으로 버텼다.
      도급 100% 의존이었다면 PF 사태 때 무너졌다.
    image: site-control
  - layout: editorialBeat
    kicker: 분노 관리
    line: |-
    ...
    sub: |-
      8개 동 전면 해체 후 재시공.
      '화정아이파크'를 '센테니얼 아이파크'로 개명 —
      아이파크는 살리고, 사고 단지명만 지웠다.
    image: iparkrebuild
  - layout: editorial
    line: |-
      진짜 시험대는
    ...
    sub: |-
      재시공한 센테니얼 아이파크 준공일.
      입주가 순조롭고 하자가 없으면 턴어라운드 완성.
      문제가 또 생기면 다시 바닥으로 — 브랜드는 두 번은 못 산다.
    image: project-site
---
...
2022년 HDC현대산업개발의 영업이익률은 **3.5%.** 매출은 3조 3천억 원대를 유지했는데 영업이익은 1,164억 원에 그쳤다. 원인은 두 가지였다.
...
그리고 2024년, 더 결정적인 수를 뒀다. **"화정아이파크"라는 단지명을 버리고, "광주 센테니얼 아이파크(Centennial Ipark)"로 개명**했다. 센테니얼(Centennial)은 "100년"이라는 뜻이다. "100년 프리미엄 단지"를 표방한 리브랜딩이었다.
...
| 건설사 | 매출 | 영업이익 | YoY | 영업이익률 | 기준 |
|---|---:|---:|---:|---:|:---:|
| 현대건설 | 32.7조 | **-1.22조 (적자)** | 적자전환 | -3.7% | 2024 |
| 대우건설 | 10.4조 | 4,031억 | -39% | 3.9% | 2024 |
| GS건설 | 약 12조 | 2,860억 | 흑자전환 | 2.4% | 2024 |
| **HDC현산** | **4.15조** | **2,486억** | **+34.7%** | **6.0%** | 2025 |

이 표를 보면 뭐가 이상한지 금방 보인다. **빅4 중 영업이익률이 가장 높은 회사가 HDC현산이다.** 매출은 가장 작지만, 효율은 가장 좋다.

현대건설은 해외 플랜트 손실(사우디 카란·마르잔 등)과 국내 주택 원가 상승으로 1조 넘는 적자를 냈다. 대우건설은 국내 주택 현장 원가율 악화로 이익이 40% 꺾였다. GS건설은 2023년 검단 지하주차장 붕괴 사고 이후 구조조정 중이다. 흑자 전환했지만 영업이익률 2%대에 불과하다.
...
한 가지만 실패했어도 지금 같은 영업이익률 6.0%는 안 나왔다. 특히 첫 번째(자체개발 자금력)가 없었다면 2022~2023년 도급 공백을 버티지 못하고 PF 사태 때 다른 건설사들처럼 무너졌을 것이다.
...
만약 입주가 순조롭고, 안전 점검이 통과되고, 다른 지역 아이파크 분양에도 선순환이 일어나면, HDC현산의 턴어라운드는 완성된다. 영업이익률 8%대 진입이 가능해진다.
...
**오너 리스크는 HDC현산 투자에서 지울 수 없는 변수다.** 2025년 재무제표가 좋아도, 다음 M&A 베팅이 실패하거나 또 다른 현장 사고가 터지면 지금의 회복은 다시 무너질 수 있다. 시장이 영업이익률 6.0%에도 HDC현산 PER을 유사 회사 대비 할인해서 매기는 이유 중 하나가 이것이다.
...
HDC현산은 **자체개발 자금력이라는 해자**로 시간을 벌었다. 그 시간 동안 브랜드 리브랜딩(센테니얼), 조직 재설계(10년 만의 구조조정), 안전 체계 재구축을 했다. 이 과정이 2025년 도시정비 4.8조 수주와 영업이익률 6.0%로 돌아왔다.

하지만 회복은 아직 끝나지 않았다. 진짜 시험대는 **2026년 2월, 센테니얼 아이파크 재시공 준공일**이다. 입주민이 다시 그 건물에 들어가는 순간, 이 회사의 턴어라운드가 완성되거나 무너진다. 준공 후 1~2년 안에 구조 문제가 재발하지 않고, 타 지역 아이파크 분양이 정상화되면 영업이익률 8%대 진입이 가능하다. 반대로 한 번 더 문제가 생기면 이 회사는 다시 바닥으로 간다. 브랜드는 한 번은 살아날 수 있지만, 두 번은 어렵다.
...
1. **영업이익률 8%+.** 2025년 6.0%에서 2026~2027년 8%대로 올라가는지. 올라가면 자체개발 사이클이 정상 궤도에 들어섰다는 뜻이다. 못 올라가면 2025년이 일시적 반등이다.
...
건설사의 체력은 수주잔고와 원가 관리에서 나온다. 다음 막에서 HDC현산의 비용구조를 뜯어본다.

---

## 6막: 원가구조의 비밀 — 자체개발이 마진을 만드는 메커니즘

### 매출원가율 85.7% — 도급 vs 자체개발의 근본 차이

건설사의 매출원가에는 **토지비, 자재비, 노무비, 외주비**가 들어간다. 도급 사업(남의 땅에 지어주기)에서는 원가의 90%+ 가 자재+노무+외주비다. 마진은 고작 3~5%에 그친다. 반면 자체개발은 토지를 싸게 확보하면 분양가와 원가 사이 갭이 15~25%까지 벌어진다.

HDC현산의 2025년 매출원가율은 약 85.7%. 건설 빅4 평균(88~92%)보다 낮다.

| 건설사 | 매출원가율(최근 연간) | 주력 사업 | 자체개발 비중 |
|---|---:|---|---:|
| 현대건설 | 97%+ | 해외 플랜트 + 국내 도급 | ~15% |
| 대우건설 | 90% | 국내 도급 + 자체개발 | ~30% |
| GS건설 | 93% | 국내 도급 + 해외 | ~20% |
| **HDC현산** | **85.7%** | 수도권 자체개발 + 도시정비 | **~55%** |

```python
c = dartlab.Company("294870")
c.analysis("financial", "비용구조")
# costRatio history: 매출원가율 85.7% (2025)
# 판관비율 4.4% (판관비/매출)
```

**자체개발 비중 55%가 원가율 85.7%를 만든다.** 자기 땅에 자기가 짓고 자기가 분양하면, 중간 마진이 전부 회사에 남는다. 반면 현대건설은 해외 EPC(설계-조달-시공)에서 원가 초과가 반복되고, 대우건설은 국내 도급에서 건자재 인플레이션을 흡수하지 못했다.

### 판관비율 4.4% — 사고 비용이 아직 떨어지고 있다

판관비의 구성이 흥미롭다. 2022~2024년 HDC현산의 판관비에는 화정 사고 관련 **법률비용, 컨설팅 수수료, 안전관리 인건비 증가분**이 포함돼 있었다. 2025년 판관비(매출 대비)는 4.4%(1,807억/41,470억)로, 2022년(6.1%)보다 낮아졌으나 사고 이전 수준으로의 회귀는 계속 진행 중이다.

| 연도 | 판관비율(판관비/매출) | 사고 관련 비용(추정) |
|------|------:|---:|
| 2021 | 6.5% | — |
| 2022 | 6.1% | 수백억 |
| 2023 | 4.4% | 축소 |
...
센테니얼 아이파크 준공(2026.2)이 끝나면 사고 관련 추가 비용은 소멸한다. 판관비 절감과 원가율 개선이 맞물리면 영업이익률 7~8%대 진입이 가능하다.

### 운전자본과 선수금 — 분양 현금의 리듬

자체개발 건설사의 현금흐름은 **분양 일정**에 종속된다. 분양이 시작되면 선수금(계약금)이 들어오고, 준공 후 잔금이 들어온다. 이 리듬이 운전자본에 찍힌다.

```python
c.analysis("financial", "현금흐름")
# 선수금 변동: 자체개발 분양 시점에 양(+), 인도 시점에 음(-)
```

2025년 영업활동현금흐름은 28억 원으로, 전년(3,144억)에서 사실상 소멸했다. 분양 계약금 유입과 공사비 지출 시점이 어긋나면서 현금이 일시적으로 묶인 결과다. 2026~2027년에 이 단지들이 준공되면서 잔금이 들어오면 현금흐름은 개선될 여지가 있으나, 그 사이 신규 분양 파이프라인이 받쳐주지 못하면 회복이 더딜 수 있다.

**한 문장: HDC현산의 원가 우위는 "도급이 아니라 자체개발을 하는 회사"라는 구조적 선택에서 나온다. 이 구조가 빅4 중 유일한 6%+ 영업이익률을 만든다.**

---

## 7막: PER 6배의 의미 — 싸게 살 수 있는 건 이유가 있다

### 건설 빅4 밸류에이션 비교

HDC현산의 2025년 PER은 약 6배. PBR은 0.5배 수준이다. 싸 보인다. 하지만 건설업은 원래 싼 섹터다. 비교가 필요하다.

| 건설사 | PER | PBR | 영업이익률 | 사이클 포지션 |
|---|---:|---:|---:|---|
| 현대건설 | 적자(N/A) | 0.3 | -3.7% | 저점 |
| 대우건설 | 7.2 | 0.6 | 3.9% | 중립 |
| GS건설 | 9.5 | 0.4 | 2.4% | 회복 초입 |
| **HDC현산** | **6.0** | **0.5** | **6.0%** | **회복 가속** |
| DL이앤씨 | 8.8 | 0.5 | 4.1% | 중립 |

영업이익률 대비 PER이 가장 낮은 회사가 HDC현산이다. 수익성은 1위인데 밸류에이션은 최하위급. 시장이 "이 회사의 이익은 지속 가능한가?"에 의문을 갖고 있다는 뜻이다.

```python
c.analysis("financial", "종합평가")
# scorecard: 재무건전성과 수익성은 상위, 하지만 '신뢰 리스크' 반영은 PER에만 있다
```

### 디스카운트의 원인 — 세 가지 할인

시장이 HDC현산에 매기는 할인은 세 가지다.

| 할인 요인 | 추정 할인폭 | 해소 조건 |
|---|---:|---|
| 사고 리스크 (재발 우려) | -20~30% | 센테니얼 준공 + 2년 무하자 |
| 오너 리스크 (정몽규 판단력) | -10~15% | M&A 없이 3년 안정 경영 |
| 건설업종 할인 (PF 사태 공포) | -15~20% | 업종 전체 수주 회복 |

세 가지 할인이 동시에 적용되면서 PER 6배가 만들어졌다. 역으로, 세 할인이 하나씩 해소되면 PER은 8~10배 레인지로 올라갈 수 있다.

### NAV 방식 — 수주잔고 기반 적정가치

건설사의 가치는 PER보다 **수주잔고 + 분양 파이프라인**으로 평가하는 게 맞다. HDC현산의 수주잔고를 분해하면:

| 구분 | 금액 | 인식 시기 | 마진(추정) |
|---|---:|---|---:|
| 도시정비 수주잔고 | ~9.2조 | 2026~2030 | 8~12% |
| 자체개발 분양예정 | ~3.5조 | 2026~2028 | 15~20% |
| 도급 수주잔고 | ~2.8조 | 2026~2027 | 3~5% |
| **합계** | **~15.5조** | — | **가중평균 ~9%** |

수주잔고 15.5조 × 평균 마진 9% = 향후 영업이익 잠재력 ~1.4조. 현재 시총 1.1조 대비 이익 잠재력이 이미 시총을 넘는다. 물론 이건 모든 수주가 정상 실행된다는 전제다. 공기 지연, 원가 초과, 미분양 — 어디서든 차질이 날 수 있다.

### 시나리오별 적정 주가 레인지

| 시나리오 | 연간 영업이익률 | PER 적용 | 시총 레인지 |
|---|---:|---:|---:|
| 비관 (사고 재발) | 3~4% | 5x | 0.6~0.8조 |
| 기본 (현행 유지) | 6~7% | 7x | 1.5~1.8조 |
| 낙관 (할인 해소) | 8~9% | 9x | 2.5~3.0조 |

현재 시총 ~1.1조. 기본 시나리오 기준으로도 30~60% 저평가 상태다. 하지만 비관 시나리오(사고 재발)면 현 수준이 적정이다. **이 회사의 주가는 재무제표가 아니라 "다음 사고가 나느냐"에 달려 있다.**

[SK하이닉스](/blog/000660-skhynix)의 가치평가가 메모리 사이클에 달렸듯, HDC현산의 가치평가는 "안전 이력"에 달려 있다. 숫자가 아니라 신뢰의 가격이다.
...
| 본문 수치 | 출처 |
|---|---|
| 2025 매출 41,470억(4.15조), 영업이익 2,486억 (+34.7%), 당기순이익 1,581억 | dartlab 실측 |
...
| 정몽규 HDC 지분 33.68% | 더벨 |
| 축구협회장 4연임 2013~ | 위키 |
| 건설 빅4 최근 연간 영업이익률 (현대건설/대우/GS는 2024, HDC는 2025) | 건설사 실적 비교 |

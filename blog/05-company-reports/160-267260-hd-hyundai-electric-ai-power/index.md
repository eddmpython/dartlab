...
carousel:
  ...
  slides:
    ...
    - layout: editorialStat
      ...
      bigNumber: "24.4"
      unit: "% 영업이익률 유지"
      context: "OPM 20%대 중반 지속, 수주잔고의 고마진 매출 전환, 북미 수요, 운전자본 품질. 이 다섯 조건이 동시에 맞아야 한다."
      image: power-grid
    - layout: editorialBeat
      kicker: "결론"
      line: "비싼데도 계속\n[[들여다봐야 하는 종목]]"
...
![현재 가격은 좋은 회사라는 설명만으로는 부족한 구간에 들어와 있다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/fe/fef5d0270a43f5f83ceb7a3dec7070e7a443a6a4e1b583c21b074f03ce603393.svg)
...
### 적자에서 24%까지, 마진이 만들어진 5년

여기서 한 걸음 뒤로 가보자. 시장이 지금 값을 주는 24%대 영업이익률은 원래 이 회사의 얼굴이 아니었다. 2018년 이 회사의 영업이익률은 -5.2%였다. 2019년에는 -8.8%로 더 나빠졌다. 매출 1조 9천억을 넘게 팔고도 한 해에 1,006억을 까먹던 회사다. 그 회사가 2025년 영업이익률 24.4%, 2026년 1분기 24.9%를 찍는다.
...
| 2021 | 1.81조 | 13.0% | 0.5% |
| 2022 | 2.10조 | 16.0% | 6.3% |
| 2023 | 2.70조 | 22.6% | 11.7% |
| 2024 | 3.32조 | 31.4% | 20.1% |
| 2025 | 4.08조 | 34.1% | 24.4% |

이 표에서 진짜 봐야 할 숫자는 영업이익률이 아니라 매출총이익률이다. 매출총이익률은 매출에서 원가만 뺀 값이다. 판매비도, 연구개발비도, 감가상각도 건드리기 전의 순수한 제품 마진이다. 이 숫자가 2018년 7.9%에서 2025년 34.1%로 올랐다. 26%포인트다.

이 구분이 왜 중요한가. 영업이익률이 오르는 길은 두 갈래다. 하나는 매출이 늘어 고정비가 희석되는 길이고(오퍼레이팅 레버리지), 다른 하나는 제품 자체가 비싸게 팔리는 길이다(가격결정력). 앞의 것은 사이클이 꺾이면 같이 꺾인다. 뒤의 것은 구조에 가깝다. HD현대일렉트릭의 마진 개선은 매출총이익률에서 나왔다. 공장을 더 바쁘게 돌려서가 아니라, 같은 변압기를 더 비싸게 팔아서 만든 마진이라는 뜻이다.

오퍼레이팅 레버리지가 없었다는 말은 아니다. 2023년에서 2025년 사이 매출은 2.70조에서 4.08조로 51% 늘었는데, 영업이익은 3,151억에서 9,953억으로 216% 늘었다. 매출이 1% 늘 때 영업이익이 4% 넘게 늘어난 셈이다. 하지만 그 레버리지가 이만큼 세게 작동한 것도 결국 원가율이 함께 내려갔기 때문이다. 매출총이익률이 2018년 수준에 머물렀다면 같은 매출 성장에서 이 정도 이익은 나오지 않는다.

그래서 "24% 영업이익률이 버틸 수 있는가"라는 질문은 사실 "34% 매출총이익률이 버틸 수 있는가"라는 질문이다. 답은 앞에서 본 시간 독점에 달려 있다. 초고압 변압기를 지금 당장 납품할 수 있는 회사가 세계에 몇 곳뿐인 한, 이 원가율은 지켜진다. 경쟁사가 증설을 끝내고 고객이 가격을 세게 되묻기 시작하면, 가장 먼저 내려앉는 숫자도 이 매출총이익률이다. 다음 실적에서 영업이익률과 함께 매출총이익률을 같이 봐야 하는 이유다.

### 마진은 어느 제품에서, 어디로 팔려 나오나

그 34% 매출총이익률이 어느 제품에서 나오는지까지 내려가 보자. 사업보고서 매출 구성을 열면 답이 보인다.

| 사업부문 | 2024 | 2025 | 비중(2025) |
|---|---:|---:|---:|
| 전력기기(변압기·차단기) | 2.04조 | 2.84조 | 69.5% |
| 회전기기 | 0.54조 | 0.59조 | 14.4% |
| 배전기기 外 | 0.75조 | 0.66조 | 16.1% |

매출의 약 70%가 전력기기, 즉 변압기와 차단기다. 그리고 이 부문이 지난 한 해 동안 2.04조에서 2.84조로 39% 늘었다. 전체 매출 증가율 23%보다 훨씬 빠르다. 그 결과 전력기기 비중은 2024년 61%에서 2025년 70%로 뛰었다. 회사가 파는 물건의 무게중심이 더 비싼 제품 쪽으로 옮겨간 것이다.

이것이 앞에서 본 매출총이익률 상승(31%에서 34%)의 실물 원인이다. 마진은 회사 전체가 골고루 좋아져서 오른 것이 아니라, 마진이 가장 두꺼운 변압기의 비중이 커져서 올랐다. 그래서 "24%가 지속되는가"라는 질문은 다시 좁혀진다. 전력기기 비중이 70%를 지키거나 더 높아지는가. 그 비중이 흔들리면 평균 마진도 같이 흔들린다.

파는 곳도 한쪽으로 쏠려 있다. 2025년 매출의 77%가 수출이었고, 2026년 1분기에는 80.7%까지 올라갔다. 국내 비중은 20%밖에 안 된다. 회사 IR과 업계 보도에 따르면 이 수출의 상당 부분이 북미 데이터센터와 노후 전력망 교체 수요다(북미 세부 비중은 사업보고서에 분리되지 않아 외부 자료 기준이다). 즉 이 회사의 이익은 "미국이 변압기를 얼마나 사느냐"에 크게 묶여 있다. 강점이자 집중 리스크다. 미국 전력 투자가 이어지는 한 마진은 두껍지만, 그 수요가 흔들리면 매출의 80%가 같은 방향으로 움직인다.

참고로 사업보고서 기준 수주잔고는 2026년 3월 말 11.44조원이다(수주총액 12.47조에서 기납품 1.04조를 뺀 값). 앞에서 본 IR 기준 78.88억달러와 집계 기준은 다르지만, 두 숫자 모두 2년치가 넘는 일감을 가리킨다.
...
![2025년의 높은 이익률이 2026년 1분기에도 유지되는지가 가격의 핵심이다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/34/3437bcfe63ca078ce742dde2d951bc73be0204c871eded3170aeadf9743d8476.svg)
...
Q1을 놓고 실망과 환호가 갈리는 이유는, 분기 하나의 마진을 신호로 읽기 때문이다. 그런데 분기를 여러 개 늘어놓으면 그림이 달라진다. 2025년 네 분기의 영업이익률은 21.5%, 23.1%, 24.8%, 27.6%였다. 그리고 2026년 1분기가 24.9%다. 다섯 분기 연속 20%대 마진이다.

이 연속성이 중요하다. 한 분기의 높은 마진은 일회성일 수 있다. 환율, 일회성 정산, 특정 프로젝트의 인식 시점 같은 것들이다. 하지만 다섯 분기가 모두 20%대 중반이면, 그것은 운이 아니라 구조다. 같은 기간 분기 매출은 9,062억에서 1.16조 사이에서 출렁였다. 매출이 그렇게 흔들리는데도 마진은 20%대를 지켰다. 매출이 어디로 튀든 원가율이 버텼다는 뜻이다. 이 반복성이 "Q1 매출이 전분기보다 낮았다"는 사실보다 무겁다. 시장이 이 회사에 값을 주는 근거는 분기 매출의 방향이 아니라, 매출이 흔들려도 마진이 무너지지 않는다는 바로 그 반복성이기 때문이다.
...
수주잔고가 크다는 말은 감이 잘 안 온다. 매출로 환산해 보면 크기가 손에 잡힌다. 2026년 1분기 수주잔고 78.88억달러는 한화로 10조 원을 넘는다. 2025년 연간 매출이 4.08조였으니, 지금 손에 든 일감만으로 2년 반 넘게 공장을 돌릴 수 있다는 뜻이다. 전력기기처럼 납품에 몇 년이 걸리는 산업에서 이 정도 가시성은 흔치 않다.

방향은 더 중요하다. 2025년 연간 신규 수주는 42.74억달러였다. 2026년은 1분기에만 17.97억달러를 받았다. 이 속도가 유지되면 연간 70억달러를 넘어선다. 지난해보다 60% 넘게 빠른 수주다. 수주잔고가 67.31억달러에서 78.88억달러로 한 분기 만에 11억달러 넘게 늘어난 것도 이 때문이다. 매출로 인식되는 속도보다 새 일감이 쌓이는 속도가 아직 더 빠르다.

그런데 바로 여기서 회사의 말과 시장의 바람이 갈린다. 회사는 "수익성 중심 선별 수주"를 말한다. 앞으로는 물량보다 마진을 보고 골라 받겠다는 뜻이다. 그러면 신규 수주 증가율은 지금보다 느려질 수 있다. 시장은 "더 많이"를 원하지만 회사는 "더 비싸게"를 택한다. 이 선택이 옳다면 수주 금액의 증가율은 둔해져도 매출총이익률은 지켜진다. 그래서 다음 분기 수주 공시는 금액만 볼 것이 아니라, 그 수주가 어떤 마진으로 들어왔는지를 함께 물어야 한다.

![수주잔고는 미래 매출을 설명하지만, 매출 인식까지 시간이 걸리는 느린 숫자다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/8a/8a7e2efae15bbd28ae4fa00cb3e05c2823dc5eace47df302d06a7a2963b1b7c8.svg)
...
![AI 반도체에서 전력망까지 이어지는 물리적 사슬](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/bd/bd8a940e8a440f7c6d4b3031d4bf513d282f15163ff08453bd24bfbe73ba935e.svg)
...
![앞으로 볼 리스크는 테마가 아니라 숫자의 질이다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/f6/f6fe190f24a475a941f894c1ec84c496fbb6b9e39cbfe4696179e08f92c74281.svg)
...
### 재고에 묶인 현금, 그리고 2년의 가뭄

이 회사의 현금흐름에는 글로 잘 드러나지 않는 장면이 하나 있다. 이익이 나는데 현금이 사라졌던 2년이다.

2022년 영업활동현금흐름은 -1,241억, 2023년은 -224억이었다. 두 해 모두 영업이익은 흑자였다. 각각 1,329억, 3,151억을 벌었다. 그런데 통장에는 현금이 들어오지 않았다. 돈은 재고로 갔다. 재고자산은 2021년 3,571억에서 2022년 6,278억, 2023년 8,497억으로 불었다. 수주가 쏟아지자 원자재를 미리 사서 쌓고, 만들다 만 변압기가 공장에 늘어난 것이다.

이것이 수주산업의 숙명이다. 주문이 들어오면 먼저 돈을 쓰고, 납품과 검수가 끝나야 돈을 받는다. 그 시차가 재고와 매출채권으로 잡힌다. 2024년이 되어서야 그 재고가 매출로 풀리며 영업활동현금흐름이 1.03조로 터졌다. 2025년에도 9,596억이 들어왔다. 앞에서 본 두꺼운 FCF는 이 2년의 가뭄을 지나온 뒤에 온 숫자다.

문제는 그 재고가 지금도 줄지 않는다는 것이다. 재고자산은 2024년 1.08조, 2025년 1.27조, 2026년 1분기 1.39조로 계속 늘고 있다. 매출 대비 재고 비율은 2021년 19.8%에서 2025년 31%로 올라섰다. 재고가 매출보다 빠르게 늘고 있다는 뜻이다. 지금은 수요가 강하니 이 재고가 "성장을 위한 재고"로 읽힌다. 하지만 수요가 한 박자 쉬는 순간, 같은 재고는 "팔리지 않은 재고"로 바뀐다. 그래서 다음 분기부터는 영업이익률만큼이나 재고와 영업활동현금흐름을 같이 봐야 한다. 2022년과 2023년처럼 이익은 나는데 현금이 안 들어오는 조합이 다시 나온다면, 그것이 이 회사의 가장 이른 경고음이다.

### 재무 체력은 이 이야기의 위험이 아니다

지금까지 짚은 위험은 전부 손익과 현금에 있었다. 마진이 유지되는가, 수주가 매출로 넘어오는가, 재고가 현금을 묶지 않는가. 그런데 이 회사에서 상대적으로 걱정을 덜어도 되는 것이 하나 있다. 재무 건전성이다.

dartlab의 신용 스코어는 HD현대일렉트릭에 dCR-AA 등급을 매긴다. 부채비율은 158%로 앞의 peer 표에 나온 네 회사 중 가장 낮고, 부도확률 추정치는 0.02% 수준이다. 엘에스일렉트릭(A), 효성중공업(A+), 일진전기(A-)보다 한 단계씩 위다. 이익률만 업종에서 가장 높은 것이 아니라, 재무 체력도 가장 두껍다는 뜻이다.

그래서 이 종목의 위험은 "회사가 흔들릴까"가 아니다. 그 질문은 이미 답이 나와 있다. 진짜 시험대는 "지금의 이익과 현금을 몇 년 더 반복할 수 있는가"다. 높은 가격을 정당화하는 싸움은 대차대조표에서 벌어지지 않는다. 그 싸움은 매출총이익률과 영업활동현금흐름, 즉 손익계산서와 현금흐름표에서 벌어진다. 앞에서 본 재고와 2년의 현금 가뭄이 다시 오지 않는 한, 이 회사의 재무는 높은 가격의 걸림돌이 아니라 오히려 방패에 가깝다.
...
숫자로 보면 이 차이는 더 분명해진다. 2026년 1분기 기준으로 네 회사를 나란히 놓으면 이렇다.

| 회사 | 매출(분기) | 영업이익 | 영업이익률 | dCR 등급 |
|---|---:|---:|---:|:---:|
| HD현대일렉트릭 | 1.04조 | 2,583억 | 24.9% | AA |
| 엘에스일렉트릭 | 1.38조 | 1,266억 | 9.2% | A |
| 효성중공업 | 1.36조 | 1,523억 | 11.2% | A+ |
| 일진전기 | 5,061억 | 508억 | 10.0% | A- |

눈에 걸리는 것은 매출이 아니라 마진이다. HD현대일렉트릭은 매출로는 세 번째다. 엘에스일렉트릭과 효성중공업이 각각 1.38조, 1.36조로 더 많이 판다. 그런데 영업이익은 HD현대일렉트릭이 2,583억으로 가장 크다. 매출 1위 회사보다 두 배 넘게 번다. 영업이익률로 보면 24.9% 대 9~11%, 두 배 반의 격차다.

이 표 한 장이 PER 50배의 이유를 절반 넘게 설명한다. 시장은 "전력기기 업종"을 사는 것이 아니라, 같은 전력 수요에서 가장 두꺼운 마진을 뽑아내는 회사를 골라 사는 것이다. 초고압 변압기에 집중한 HD현대일렉트릭과, 배전과 자동화와 건설이 섞인 나머지의 차이가 여기서 갈린다. 효성중공업의 11.2%에 건설 부문이 섞여 마진이 희석됐다는 점을 감안해도, 순수 전력기기 마진의 서열은 크게 바뀌지 않는다.

다만 이 프리미엄에는 대가가 있다. 제품이 초고압 변압기 한 곳에 몰려 있다는 것은, 그 한 제품의 사이클에 이익이 더 크게 흔들린다는 뜻이기도 하다. 엘에스일렉트릭은 마진은 낮아도 사업이 넓어 충격을 분산한다. HD현대일렉트릭은 마진은 높지만 한 곳에 걸려 있다. 높은 마진과 높은 집중은 같은 동전의 양면이다. 그래서 이 회사의 24.9%가 흔들린다면, 그것은 업종 전체의 문제가 아니라 초고압 변압기라는 한 제품의 문제일 가능성이 크다.
...
| 매출총이익률 | 7.9%(2018) → 34.1%(2025) → 34.9%(2026Q1) | dartlab 실측(DART) |
| 영업이익률 | -5.2%(2018) → 24.4%(2025) → 24.9%(2026Q1) | dartlab 실측(DART) |
| 오퍼레이팅 레버리지 | 2023→2025 매출 +51%, 영업이익 +216% | dartlab 실측(DART) |
| 사업부문 매출(2025) | 전력기기 69.5% · 회전기기 14.4% · 배전기기 16.1% | dartlab 사업보고서 실측 |
| 전력기기 비중 | 61%(2024) → 70%(2025) | dartlab 사업보고서 실측 |
| 수출 비중 | 77%(2025) → 80.7%(2026Q1) | dartlab 사업보고서 실측 |
| 수주잔고(사업보고서) | 11.44조(2026.03.31, 수주총액 12.47조 - 기납품 1.04조) | dartlab 사업보고서 실측 |
| 재고자산 | 3,571억(2021) → 1.27조(2025) → 1.39조(2026Q1) | dartlab 실측(DART) |
| 영업활동현금흐름 | -1,241억(2022), -224억(2023), 1.03조(2024), 9,596억(2025) | dartlab 실측(DART) |
| 분기 영업이익률(2025) | 21.5% · 23.1% · 24.8% · 27.6% | dartlab 실측(DART) |
| Peer 영업이익률(2026Q1) | HD현대 24.9% · 엘에스일렉트릭 9.2% · 효성중공업 11.2% · 일진전기 10.0% | dartlab PeerCompareN |
| 수주잔고 runway | 78.88억달러(약 10조+) = 2025년 매출 4.08조의 2.5년치+ | 회사 IR + dartlab |
| 신규수주 | 42.74억달러(2025) → 17.97억달러(2026Q1) | 회사 IR |
| 재무건전성 | dCR-AA, 부채비율 158%(peer 최저), 부도확률 0.02% | dartlab PeerCompareN |

...
ai:
  ...
  dataAsOf: "2026-06-13"
carousel:
  title: 13배 컸는데 왜 마진은 안 깎였나
  caption: |-
    파마리서치는 매출이 2017년 396억에서 2025년 5,363억으로 13.5배 컸습니다. 그런데 영업이익률을 40%대로 지켰습니다. 미용·고마진 회사는 크면 마진을 잃는 게 법칙인데(휴메딕스 42%→25%, 메디톡스 50%→7%) 이 회사만 안 잃었습니다.

    비결은 '제품'이 아니라 연어 정소에서 국산화한 한 분자(PDRN)를 쥔 채, 같은 소재를 미용(리쥬란)에서 정형(콘쥬란)으로 갈아끼운 데 있습니다. 받을 돈(매출채권/매출)조차 38%에서 8%로 줄이며 컸습니다.

    단, 성장 비용을 없앤 게 아니라 위치를 옮겼습니다 — 재고는 16배로 늘었고, 비유동부채가 새로 생겼습니다. 봐야 할 건 '안 무너진 대가가 어디 쌓였나'입니다.
  explainers:
  - term: PDRN
    body: 연어 정소에서 뽑아 국산화한 피부·조직 재생 물질입니다. 파마리서치는 이 한 분자를 미용(리쥬란)에서 정형(콘쥬란)으로 갈아끼우며 고마진을 지켰습니다.
  - term: 영업이익률
    body: 매출에서 영업이익이 남는 비율입니다. 파마리서치는 매출이 13배 크는 내내 40%대를 지켰는데, '미용 회사는 크면 마진을 잃는다'는 통념을 깬 점이 핵심입니다.
  relatedNews:
  - title: "리쥬란 찾는 외국인 늘었다…의료관광 확대에 파마리서치 목표가↑"
    source: sedaily.com
    date: '2026-06-25'
    url: https://www.sedaily.com/article/20059876?ref=naver
    track: naver
    description: 네이버 보관 뉴스 기준. 리쥬란 수요 확대 — 카드가 말한 '40% 마진'을 떠받치는 매출 동력입니다.
  - title: 파마리서치 리쥬란코스메틱, '포어 타이트닝 크림' 출시
    source: pinpointnews.co.kr
    date: '2026-06-24'
    url: https://www.pinpointnews.co.kr/news/articleView.html?idxno=462597
    track: naver
    description: 네이버 보관 뉴스 기준. 리쥬란 라인 확장 — 카드가 짚은 '같은 소재를 갈아끼우는' 전략의 사례입니다.
  pinnedComment: 투자 판단이 아닙니다. 영업이익률 40% 유지, 재고 회전(매출보다 빠른 재고 증가), 인적분할·지주사 전환 같은 자본정책 변수 — 이 셋을 봐야 합니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
      ...
      [[마진은 안 깎였다]]
    sub: |-
      미용 회사는 크면 마진을 잃는 게 이 바닥의 법칙.
      파마리서치만 매출이 13배 크는 내내 영업이익률 40%를 지켰다.
    image: salmon
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[마진을 잃는다]]
    sub: |-
      휴메딕스는 매출 5배 크는 동안 영업이익률 42%→25%,
      메디톡스는 50%→7%로 무너졌다.
      빨리 크려면 가격을 깎고 외상을 떠안기 때문이다.
    image: rejuran-clinic
  - layout: editorialStat
    kicker: 매출 13배, 그런데
    bigNumber: '40'
    unit: '% 영업이익률'
    context: |-
      매출 396억(2017) → 5,363억(2025), 13.5배.
      그 내내 영업이익률을 30~40%대로 지켰다.
      (단조 상승은 아니다 — 진동했지만 추세적으로 무너지지 않았다.)
    image: gmp-factory
  - layout: editorialBeat
    kicker: 비결
    line: |-
      ...
      [[갈아끼웠다]]
    sub: |-
      연어 정소에서 국산화한 한 분자(PDRN)를 쥔 채,
      미용(리쥬란)에서 정형(콘쥬란)으로 매출 무게중심을 옮겼다.
      한 시장이 가격경쟁에 들어가기 전에 인접 진료실로.
    image: salmon
  - layout: editorialStat
    kicker: 외상도 안 깔았다
    bigNumber: 38→8
    unit: '% 매출채권/매출'
    context: |-
      보통 고성장 미용사는 병의원에 밀어넣고 매출채권이 먼저 분다.
      파마리서치는 반대 — 받을 돈 비율을 38%에서 8%로 줄이며 컸다.
      성장의 청구서가 한 장도 안 날아온 것처럼.
    image: rejuran-clinic
  - layout: editorialBeat
    kicker: 단, 공짜는 아니다
    line: |-
      ...
      [[위치를 옮겼다]]
    sub: |-
      재고는 매출(13.6배)보다 빠른 16배로 늘었고,
      2024년부터 비유동부채 2,034억이 등장했다.
      외상 대신 재고·자본정책으로 위험이 이동했다.
    image: gmp-factory
  - layout: editorial
    line: |-
      질문은 마진이 아니라
...
![파마리서치 — 13배 크는 내내 마진을 안 내준 회사](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/40/40b734134fe4f171a2fb91c4fd7b7c922fbb5f593e0067c89b46035846667321.svg)
...
![같은 분자(PDRN)를 미용(리쥬란)에서 정형(콘쥬란)으로 갈아끼우기](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/13/1338f57193c02af018feeb983223652b7daa68f843eaa99da4120e0f29ec56c8.svg)
...
![파마리서치 — 안 날아온 청구서(매출채권)와 날아온 청구서(재고)](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/e9/e9dc4d6e8fa97012387f7f6e7cd664bf0e0ad4207ef1373e1a48c16395cbdf17.svg)
...
![같은 출발선, 8년 뒤 갈라진 영업이익률 — 파마 40% vs 휴메 25% vs 메디 7%](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/66/661b7266a021ea26c74b2934f240dae6f756bc1545be787855a34d489f013654.svg)
...
![파마리서치 — 2026년에 봐야 할 다섯 가지](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/42/428a69d3f52d1e447b3b738659cf335b46b5f1fde72be1d8c6cc1b586dc794d8.svg)

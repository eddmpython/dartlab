...
ogImage: https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/5c/5c224dc1a4a3f1ca77ca2b0487dc5a0b7339e66f24b54ca578f351ccc22d988f.webp
cardPreview: https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/18/18c0d8c6fc2756b1fb0aaa6d8aaa84ed3c214d7efccc34e1de00c556074aa05d.webp
youtubeId: ""
ai:
...
| 영업이익률(영업이익률) | **-2,188%** | -375% | -1,209% | -1,050% | — |
...
![NuScale VOYGR 소형모듈원전 설계 모델 — NRC 설계인증을 받은 세계 유일의 SMR, 77MWe 경수로 모듈](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/41/41e4d67992d6514037ee9cd9e33dec1b4d3a0419e143a27c3d76ae48fad54f41.webp)
...
아이다호 프로젝트의 초기 추정 비용은 $5.3B였다. DOE(에너지부)가 $1.35B를 지원하겠다고 약속했고, 2023년 8월 건설 신청까지 마쳤다. 그런데 프로젝트 비용 추정치가 $5.3B에서 $9.3B로 75% 상승했다. MWh당 발전 단가(균등화발전비용, Levelized Cost of Energy — 발전소 전체 수명에 걸친 평균 발전 원가)가 $58 → $89로 뛰어올랐다.
...
![데이터센터 전력 공급을 위한 원자력 발전소 — AI 연산 수요가 불러온 24시간 무탄소 기저 전력의 필요성](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/0e/0e7f1e4b227af0f290017dcd8b02bd7d82367c02fc2741b16b53d03efe1a3981.webp)
...
|---|---:|---:|---:|---:|
| 영업활동현금흐름 (영업활동현금흐름) | **-348** | -110 | -144 | -67 |
| 투자활동현금흐름 | -768 | 20 | 49 | -104 |
| 재무활동현금흐름 | **+1,370** | 98 | 7 | 263 |
| 잉여현금흐름 (잉여현금흐름) | **-350** | -108 | -160 | -170 |
...
dartlab 신용등급은 dCR-A. health 점수는 84다. 적자 회사가 A등급을 받은 이유는 단순하다 — 현금이 많다. 부채비율(부채/자본)은 49.5%로 낮고, 유동비율(유동자산/유동부채)은 4배 이상이다. 이자보상배율(이자보상배율, 영업이익으로 이자를 몇 번 갚을 수 있는가)은 마이너스지만, 차입금 자체가 거의 없어서 단기 부도 위험은 낮다.
...
뉴스케일의 영업손실 -$689.6M이 OKLO의 -$210.4M보다 3.3배 크다. 하지만 그 대부분은 SBC(주식보상비용)다. 현금 소진 기준으로 보면 뉴스케일 영업활동현금흐름 -$348M, OKLO 영업활동현금흐름 -$110M 수준이다. 뉴스케일이 더 많이 태우는 이유는 엔지니어 450명의 인건비 + R&D $45.5M이 있기 때문이다. 설계인증을 유지하고 차기 프로젝트를 준비하는 비용이다.
...
2. **분기 영업활동현금흐름 추이**: -$348M/년에서 줄어드는지. SBC 제외 실질 현금 소진이 핵심.
3. **추가 유상증자 여부**: $500M 이하로 떨어지면 추가 조달 불가피. 희석 규모가 관건.
4. **균등화발전비용 견적**: 차기 프로젝트에서 $58~89/MWh 범위의 어디에서 제안하는가.
...
첫째, **균등화발전비용의 현실적 인하**. $89/MWh를 $60 이하로 낮추려면 모듈 표준화와 대량 생산이 필수다. [두산에너빌리티(#03)](/blog/034020-doosan-enerbility)가 공급 파트너로 참여하는 이유가 여기 있다 — 한국 중공업의 대량 생산 역량이 SMR 원가를 낮출 수 있다.
...
| 2025 영업활동현금흐름 -$348M | `c.select("CF",["영업활동현금흐름"])` 분기 합산 | 실측 |
| 2025 재무CF +$1,370M | `c.select("CF",["재무활동현금흐름"])` 분기 합산 | 실측 |
| 2025 잉여현금흐름 -$350M | 영업활동현금흐름 - 설비투자 계산 | 실측 |
...
| 초기 균등화발전비용 $58/MWh → $89/MWh | 외부: 산업 보도 + NuScale IR | 공개 자료 |

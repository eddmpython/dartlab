...
carousel:
  ...
  explainers:
  - term: DOL(영업레버리지)
    body: 매출이 1% 변할 때 영업이익이 몇 % 변하는지 보는 배율입니다. LG생활건강은 9.4배라, 매출이 조금만 회복돼도 이익이 크게 튀고 반대로 빠지면 크게 무너지는 구간입니다.
  - term: 매출총이익률(GPM)
    body: 매출에서 원가를 뺀 이익의 비율입니다. 화장품은 본래 고마진이라, 이 50% 라인 회복이 '사이클 회복이냐 모델 종료냐'를 가릅니다.
  relatedNews:
  - title: 한국 안방까지 진격한 'C뷰티'…색조 시장 판도 흔든다
    source: mhns.co.kr
    date: '2026-06-26'
    url: https://www.mhns.co.kr/news/articleView.html?idxno=751500
    track: naver
    description: 네이버 보관 뉴스 기준. 중국 화장품의 한국 침투 — 카드가 말한 '화장품 본체 위기'를 둘러싼 경쟁 압력입니다.
  - title: 바르는 화장품 다음은…웰니스 품는 K뷰티
    source: m-i.kr
    date: '2026-06-28'
    url: https://www.m-i.kr/news/articleView.html?idxno=1385582
    track: naver
    description: 네이버 보관 뉴스 기준. K뷰티 모델 전환 흐름 — 카드가 던진 '사이클 회복이냐 모델 종료냐'의 산업 배경입니다.

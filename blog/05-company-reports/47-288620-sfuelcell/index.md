...
ai:
  ...
  dataAsOf: "2026-04-18"
carousel:
  title: 같은 탈탄소 적자인데 — 하나는 현금 6억, 하나는 1.8조
  caption: |-
    수소연료전지를 만드는 에스퓨얼셀(288620). 2025년 매출원가율 127.2%, 영업이익률 -95.1%, 현금은 단 6억원. 물건을 팔수록 27원씩 밑지는 구조다.

    그런데 같은 "탈탄소 적자"인 뉴스케일파워(SMR)는 적자 비율이 23배 큰데(-2,188%) 현금이 1.8조원이다(별도 블로그 #44 교차·외부). 차이는 한 장 — NRC 설계인증이라는 진입장벽이다. 인증이 있으면 시장은 "기다려볼게"라 하고, 없으면 "지금 돈 벌어"라 한다.

    관전 포인트는 분기 매출 100억 회복 여부. 현재 약 40억. 100억을 넘겨 매출원가율이 100% 아래로 내려와야 구조 정상화의 최소 조건이 충족된다. 둘 다 없으면 유상증자는 시간을 살 뿐 턴어라운드가 아니다.
  explainers:
  - term: 매출원가율
    body: 매출에서 원가가 차지하는 비율입니다. 에스퓨얼셀은 127%(팔수록 27원 손실)에 현금이 6억뿐이라, 분기 매출 100억 회복이 구조 정상화의 최소 조건입니다.
  - term: 설계인증(진입장벽)
    body: 발전 설비가 시장에 들어가려면 받아야 하는 규제 인증입니다. 인증이 있으면 시장이 적자를 기다려주고(뉴스케일 NRC), 없으면 '지금 돈 벌라'고 합니다 — 에스퓨얼셀과의 차이입니다.
  relatedNews:
  - title: 에스퓨얼셀, 사명 '에스프리즘'으로 변경…데이터센터 사업 확대 선언
    source: asiae.co.kr
    date: '2026-04-29'
    url: https://view.asiae.co.kr/article/2026042914193204027
    track: naver
    description: 네이버 보관 뉴스 기준. 사명 변경·데이터센터 전환 — 카드가 본 '적자 구조 탈출' 시도의 방향입니다.
  - title: 에스프리즘, '블룸에너지가 증명한' 데이터센터 연료전지 수혜 기대
    source: newsprime.co.kr
    date: '2026-05-08'
    url: http://www.newsprime.co.kr/news/article.html?no=732729
    track: naver
    description: 네이버 보관 뉴스 기준. 데이터센터 연료전지 시장 — 카드가 말한 '분기 매출 100억 회복'을 가를 수요처 후보입니다.
  pinnedComment: 투자 판단이 아닙니다. 에스퓨얼셀 수치는 dartlab 실측(2026-04-18), 뉴스케일 비교 수치는 별도 블로그 #44 교차 인용입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
      ...
      [[매출원가율 127.2%]]
    sub: |-
      매출 470억(2020) → 158억(2025)
      4년간 312억이 증발했다
      영업이익률 -95.1%, 현금 단 6억
    image: fuelcell-plant
  - layout: editorialStat
    ...
    context: |-
      100원짜리를 팔면 원가가 127원
      2022년 68.8% → 2025년 127.2%
      3년 만에 원가가 매출을 추월했다
    image: production-site
  - layout: editorialBeat
    kicker: 매출의 붕괴
    line: |-
      470억(2020)이 158억(2025)으로
      [[4년간 312억이 증발]]했다
    sub: |-
      매출이 반토막 나면 고정비가 회사를 삼킨다.
      같은 기간 영업이익 +21억 → -150억.
    image: product-detail
  - layout: editorialStat
    kicker: 부실 위험 — Altman Z
    bigNumber: '0.20'
    unit: 점
    context: |-
      1.81 미만이면 위험, 0.20은 부실 구간 한가운데
      이자보상배율 -3.86배 (번 돈으로 이자도 못 갚음)
      종합평가 8개 중 4개 F, 신용등급 dCR-BB-
    image: control-room
  - layout: editorialBeat
    kicker: 인증의 차이 — 같은 적자, 다른 운명
    line: |-
      뉴스케일에는 NRC 설계인증이 있다
      [[에스퓨얼셀에는 빌려 쓰는 라이선스뿐]]
    sub: |-
      인증이라는 진입장벽이 있으면 시장은 현금 1.8조(외부)를 맡기고 기다린다.
      GS칼텍스 라이선스는 기술 소유가 아니라 사용 계약 — 경쟁자가 있다.
    image: smr-contrast
  - layout: editorialBeat
    kicker: 다음에 볼 숫자
    line: |-
      분기 매출 40억 → 100억
      [[100억을 넘겨야 원가율이 100% 아래로]]
    sub: |-
      현금 6억 + 순차입금 235억. 자금 조달은 시간을 사는 것일 뿐.
      매출이 안 돌아오면 3년 뒤 같은 자리에 선다.
    image: fuelcell-plant
---

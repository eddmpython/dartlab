...
ai:
  ...
  dataAsOf: "2026-06-13"
carousel:
  title: 세계 최초를 두 번 만들고도 영업이익 60%가 사라진 이유
  caption: |-
    아모레퍼시픽은 세상에 없던 걸 두 번 처음 만들었습니다. 1966년 세계 최초 한방 화장품, 2008년 세계 최초 쿠션. 그런데 2016년 영업이익 8,481억이 2025년 3,358억으로, 60%가 사라졌습니다.

    이상한 건 제품은 멀쩡했다는 점입니다. 원가 빼고 남는 비율(매출총이익률)은 2025년에도 72.3%. 무너진 건 만드는 힘이 아니라 '파는 길'이었습니다 — 2014년 '별그대' 이후 중국이 잠깐 열어준 따이공·면세 채널. 회사가 닦은 길이 아니었고, 2016년 사드 한 방에 분기 영업이익률은 22.75%에서 7.77%로 한 해 안에 1/3이 됐습니다.

    지금은 북미(라네즈·코스알엑스)로 새 문을 내며 3년 연속 회복 중이지만, 영업이익은 여전히 정점의 40%입니다. 봐야 할 건 매출 기사가 아니라 두 줄입니다 — 매출총이익률 72%대를 지키면서 판관비성 부담률이 64%대에서 내려오는가. 그게 '남이 열어준 문'과 '자기 문'을 가릅니다.
  explainers:
  - term: 따이공·면세 채널
    body: 중국 보따리상과 면세점을 통한 판매입니다. 회사가 닦은 길이 아니라 외부가 잠깐 열어준 채널이라, 사드 이후 무너지며 이익이 급감했습니다.
  - term: 매출총이익률 vs 판관비
    body: 원가를 빼고 남는 비율(72%)은 그대로인데 파는 데 드는 비용(판관비)이 커서 영업이익이 무너졌습니다. 이 둘의 간격이 좁혀지는지가 핵심입니다.
  relatedNews:
  - title: 2분기 연속 두자릿수 성장…북미·유럽 K-뷰티 성과, 코스알엑스 턴어라운드
    source: greened.kr
    date: '2026-06-26'
    url: https://www.greened.kr/news/articleView.html?idxno=343455
    track: naver
    description: 네이버 보관 뉴스 기준. 북미·유럽 새 채널 성과 — 카드가 말한 '북미로 새 문을 내며 회복'을 보여줍니다.
  - title: "\"1년간 1500조각 맞췄다\"…왕실유산 되살린 설화수의 '빅 픽처'"
    source: joongang.co.kr
    date: '2026-06-27'
    url: https://www.joongang.co.kr/article/25440353
    track: naver
    description: 네이버 보관 뉴스 기준. 설화수 브랜드 재건 — '제품(만드는 힘)은 멀쩡하다'는 카드 논제와 닿습니다.
  pinnedComment: 투자 판단이 아닙니다. 따이공·면세 비중, 설화수 중국 매출은 외부 추정치입니다. 핵심은 매출총이익률(실측 72.3%)과 영업이익률(실측 7.9%)의 간격이 좁혀지는지입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
  ...
  - layout: editorialStat
    kicker: 2016년 7월, 사드
    bigNumber: 22.75→7.77
    unit: '% 분기 영업이익률'
    context: |-
      사드 발표를 전후로 같은 해 안에서 1/3로.
      외부 충격이 손익에 박히는 데
      걸린 시간은 1년이 아니라 한 분기.
    image: dutyfree-counter
  - layout: editorialStat
...
![아모레퍼시픽 — 만드는 손은 멀쩡한데 파는 길이 무너진 9년](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/13/1322ec4f72690712d78c7913fabbde33e87bec678484f814b28f6fba41489dfc.svg)
...
![아모레퍼시픽 90년 타임라인 — 발명은 안에서, 폭발과 붕괴는 밖에서](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/15/15950f0bc2f560a9ca89a3908490879a45cb0af3618afa640e9fbe1b8d694e5d.svg)
...
![2016년 — 같은 해, 두 길이 동시에 무너지다](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/ee/ee1e99289b26c240a609da160fea87aa24e33a72104ebf6150b7be9835178231.svg)
...
![매출총이익률보다 영업이익률이 훨씬 크게 무너진 9년](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/a1/a1f6ec467b291623deaf4ce523c9313e4617c769ed9141b0c626620481b94d05.svg)
...
여기서 분명히 선을 긋는다. 이것이 "중국 로컬이 아모레의 시장을 *빼앗았다*"는 인과인지, 아니면 아모레의 가격·유통·현지화 대응이 늦은 *내부 실패*인지, 공시 데이터만으로는 가를 수 없다. 분명한 것은 **관찰된 아이러니** 하나다 — 세계 최초로 그 카테고리를 *발명한* 회사가, 정작 그 카테고리의 가장 큰 시장에서는 주인공이 아니었다. 발명은 또 안에서 일어났고, 과실은 또 밖에서 결정됐다. 한국 화장품의 '만드는 힘' 자체는 [콜마](/blog/161890-kolmar) 같은 위탁생산(ODM) 기업이 세계에 증명하고 있다 — 약했던 것은 늘 만드는 힘이 아니라 그것을 자기 이름으로 파는 길이었다.
...
![아모레퍼시픽 — 2026년에 봐야 할 다섯 가지](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/9d/9d995efc9857427bb572ac5825e5eba8196edbf1d1db15d332c851dda8a422a0.svg)

...
ai:
  ...
  dataAsOf: "2026-04-11"
carousel:
  title: 물류회사 장부에 로봇과 경쟁사의 차가 숨어있다 — 현대글로비스
  caption: |-
    물류업에서 영업이익 2조를 찍는 회사는 없다. CJ대한통운 1위가 5,500억인데, 현대글로비스는 2조 730억. 영업이익률 7.0%로 CJ(4.4%)의 1.6배다. 박리다매 산업에서 어떻게 이 마진이 나왔을까?

    이익 엔진이 물류가 아니라 배였다. 매출의 18%에 불과한 해운(PCC선)이 이익의 36%를 만든다. PCC선 용선료가 $35,000에서 $110,000으로 3배 뛰는 동안, 98척 선대 전부의 수입이 같이 뛰었다. 게다가 비계열 물량이 2021년 22%에서 2025년 55%로 역전 — 현대차 경쟁사 BYD의 차까지 실어 나르며 마진을 키웠다.

    관전 포인트는 장부 밖에 묻힌 가치다. 보스턴다이내믹스 지분 11.25%가 시장가 3.3조인데 장부엔 1,350억으로 잡혀있다. 다음에 볼 지표 — PCC선 운임의 방향, BYD의 자체 선대 확보 속도, 그리고 PBR 1.1배의 지배구조 디스카운트.
  explainers:
  - term: PCC선(자동차운반선)
  ...
  - title: "'중동 리스크' 장기화…해운업계 \"시장 예측보다 대응력이 중요\""
    ...
    track: naver
    description: 네이버 보관 뉴스 기준. 해운 운임 변동성 — 카드가 본 'PCC선 운임의 방향'을 흔드는 외부 변수입니다.
  pinnedComment: 투자 판단이 아닙니다. 재무 수치(매출·영업이익·OPM·비계열 비중·지분율·PBR)는 dartlab 실측 및 본문 표 기준이며, 보스턴다이내믹스 기업가치·PCC선 용선료(운임)는 외부/업계 추정치입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
      ...
      [[이익 엔진은 물류가 아니라 배였다]]
    sub: |-
      매출 29.6조 · 영업이익 2조 730억
      매출 18%짜리 사업부가 이익의 36%
      그게 무슨 사업부일까?
    image: pcc-ship
  ...
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[해운이 진짜 엔진이었다]]
    sub: |-
      해운 추정 영업이익률 13.8% — 유통(4.1%)의 3.4배.
      2024년 대비 해운 영업이익 104% 폭증.
    image: car-carrier
  - layout: editorialStat
    kicker: PCC선 일일 용선료
    bigNumber: '110,000'
    unit: 달러/일
    context: |-
      2023년 초 $35,000 → 2024년 말 $110,000
      3.1배 — 컨테이너선도 보기 힘든 상승
      98척 전부의 수입이 같이 뛰었다 (6,500CEU·외부 추정)
    image: fleet-control
  - layout: editorialBeat
    kicker: 캡티브를 넘다
    line: |-
      ...
      [[경쟁사 BYD의 차를 실어 나른다]]
    sub: |-
      2021년 22%였던 비계열 물량이 2025년 55%로 역전.
      시장 운임 상승분이 그대로 이익에 꽂히는 구조.
    image: customer-context
  - layout: editorialStat
    kicker: 보스턴다이내믹스 지분 11.25% (시장가치=외부 추정)
    bigNumber: '3.3'
    unit: 조원
    context: |-
      장부가 1,350억 vs 시장가치 3.3조 — 약 3.2조 갭
      물류회사 장부에 숨은 로봇 지분, PBR은 1.1배
      8년째 지배구조 디스카운트
      다음에 볼 지표 — 운임 방향 · BYD 자체 선대 · 정의선의 다음 수
...
매출 추이를 그려보면 꺾이는 구간이 없다. 5년간 매출 21.78조에서 29.57조로 올랐다. 매년 성장했다. 그런데 영업이익의 기울기가 매출보다 훨씬 가파르다. 2021년 1조 1,262억이던 영업이익이 2025년 2조 730억이 됐다. 매출은 1.36배인데 이익은 **1.83배**다.

### 매출 1.36배인데 이익 1.83배 — 비대칭 성장의 정체

다음은 연결 기준 5년 실적이다.

| 연도 | 매출 | 영업이익 | 영업이익률 |
|:---:|:---:|:---:|:---:|
| 2021 | 21.78조 | 1조 1,262억 | 5.2% |
| 2022 | 26.98조 | 1조 7,985억 | 6.7% |
| 2023 | 25.68조 | 1조 5,540억 | 6.1% |
| 2024 | 28.41조 | 1조 7,529억 | 6.2% |
| **2025** | **29.57조** | **2조 730억** | **7.0%** |

### 영업이익률 5.2% → 7.0% — 물류업 마진 1.8%p는 구조 변화 없이 불가능

영업이익률이 5.2%에서 7.0%로 1.8%p 상승했다. 물류업에서 마진 1.8%p는 구조적 변화가 아니면 불가능한 수치다. 이 변화의 진원지는 손익계산서의 사업부별 명세서에 숨어 있다.
...
이것이 영업이익률 5.2%에서 7.0%로 점프한 진짜 메커니즘이다. 비계열 비중이 올라갈수록, 시장 운임 상승분이 이익에 바로 꽂힌다. 캡티브만 하던 시절에는 운임 호황이 와도 이익이 별로 안 늘었다. 비계열이 절반을 넘기니까, 운임 호황이 **직접** 이익으로 전환되기 시작한 것이다.
...
### 연간 잉여 영업활동현금흐름 1.9조 — 9조 중 대부분은 자체 현금으로 커버

**9조가 무모한 도박인가?** 결론부터 — 아니다. 연간 영업활동현금흐름 2.5조에서 유지보수와 배당을 빼면 잉여 현금이 연 1.9조. 5년이면 9.5조. 9조 중 대부분은 자체 현금으로 커버되고, 차입 수요는 제한적이다. 숫자로 따져보자:

| 항목 | 연간 규모 | 5년 누적 |
|------|----------|---------|
| 영업CF (영업활동현금흐름) | ~2.5조 | ~12.5조 |
| 유지보수 설비투자 | ~0.4조 | ~2.0조 |
| 배당 | ~0.2조 | ~1.0조 |
| **잉여 영업활동현금흐름** | **~1.9조** | **~9.5조** |

9조 투자 중 상당 부분은 영업활동현금흐름으로 커버되고, 나머지 차입은 물류업 평균 범위다. **이 투자는 도박이 아니라 캐시플로우 기반의 확장이다.** 다만 영업활동현금흐름 2.5조가 유지되려면 PCC 운임이 급락하지 않아야 한다 — 이것이 리스크다.
...
운임 $110,000이 $35,000으로 되돌아가면? 해운 영업이익률 13.8%가 5% 이하로 떨어지고, 전사 영업이익률도 7%에서 5% 대로 회귀한다. 2021년(5.2%) 수준이다. 해운이 이익의 36%를 차지하는 구조는, 반대로 해운이 꺾이면 전체가 흔들리는 구조이기도 하다.

...
youtubeId: ""
ai:
  verdict: "오로라월드는 봉제완구·캐릭터 IP로 주가가 1년 새 4배 올랐지만, 재무제표를 열면 장난감 회사가 아니라 자산이 무거운 회사가 나온다. 자산총계 6,002억의 66%가 비유동자산이고, 그중 임대 목적 투자부동산만 1,274억으로 시가총액(약 2,300억)의 55%, 영업용 유형자산까지 더한 부동산성 자산 3,484억은 시총의 1.5배다. 이 자산은 2020~2023년 빚으로 지어졌다(부채 3.8배, 부채비율 2023년 274% 정점, capex 2023년 706억). 순이익이 매년 널뛰는 이유는 단순한 이자 부담이 아니라, 영업이익 아래에 파인 '영업외 골'(세전-영업이익)이 -86(2022)에서 -225(2024)로 깊어졌다가 -133(2025)으로 출렁이기 때문이다. 2024년 붕괴 268억의 84%가 이 골, 16%가 세금이었다(유효세율 50.6%가 작은 세전 85억을 반토막). 골이 순수 이자벽이 아닌 근거는 2024→2025 빚을 순상환했는데도 골이 얕아진 점(환율 유력하나 재무제표 미분리로 미확인). 여기에 성장할수록 운전자본이 현금을 삼켜 2026년 1분기 매출 사상 최대에도 영업현금흐름은 사실상 0이었다. 다만 투자 사이클은 2023년 정점을 지나 2025년 처음으로 빚을 순상환하기 시작했다. 그래서 이 회사의 다음 장은 인형 매출이 아니라, 시총만큼 쌓은 이 무거운 자산이 스스로 현금을 벌고 영업외 골이 얕아지느냐로 갈린다."
  direction: "점검"
  confidence: "중간"
...
빚으로 자산을 지으면 이자 청구서가 따라붙는다. 하지만 오로라의 순이익이 매년 크게 널을 뛰는 이유를 '이자 탓'으로만 뭉개면 절반은 틀린다. 계산기를 실제로 두드려보면 범인은 이자보다 넓고, 그 크기가 해마다 달라진다.

장면 하나를 보자. 2024년 오로라의 영업이익은 310억원이었는데 순이익은 42억원. 영업으로 번 돈의 87%가 주주 몫으로 내려오기 전에 사라졌다. 이 붕괴를 두 조각으로 나눌 수 있다. 세전이익은 순이익에 법인세를 더한 값이니, 거꾸로 되짚으면 2024년 세전이익은 85억원, 법인세가 43억원이었다. 그러면 영업이익 310억에서 세전이익 85억까지 무려 225억원이 증발한 셈인데, 이 구간이 바로 영업이익 아래에 파인 '영업외 골'이다. 즉 2024년 붕괴 268억원의 84%(225억)는 이 영업외 골이 냈고, 나머지 16%(43억)만 법인세가 냈다. 흔히 말하는 '세율 탓'도, '이자 탓'도 이 서열을 정확히 담지 못한다.

그럼 이 225억원짜리 골은 무엇인가. 물론 4,000억원대 부채의 이자가 여기 깔린다. 하지만 이 골을 '이자벽'으로만 부르면 설명되지 않는 것이 하나 있다. 골의 깊이가 해마다 출렁인다는 점이다. 영업외 골은 2022년 86억, 2023년 191억, 2024년 225억으로 깊어졌다가 2025년 133억으로 다시 얕아졌다. 여기서 결정적인 반례가 나온다. 2024년에서 2025년으로 넘어갈 때 오로라는 오히려 빚을 더 늘리지 않고 처음으로 갚기 시작했는데(재무활동현금흐름 +73억에서 -47억으로), 그런데도 골은 얕아졌다. 골이 순수한 이자벽이라면 빚이 늘지 않을 때 골도 그대로여야 하는데, 오히려 얕아진 것이다. 이 말은 골의 깊이 변동이 이자가 아니라 다른 항목에서 온다는 뜻이다. 수출 비중이 큰 회사라 환율 손익이 유력한 후보이지만, 회사가 재무제표에서 이 골의 이자와 환율을 나누어 밝히지 않아 여기서부터는 확인이 아니라 추정이다. 이 글이 정직하게 열어두는 유일한 여백이 이 칸이다.

법인세의 역할도 정확히 짚어야 한다. 2024년 유효세율은 50.6%로 이례적으로 높았다. 하지만 이 50%가 붕괴의 절반을 냈다는 뜻은 아니다. 이미 영업외 골에 빠져 쪼그라든 세전이익 85억원을, 그 절반인 43억원의 세금이 다시 깎아 42억원을 남긴 것이다. 금액으로는 작지만(붕괴의 16%), 이 43억원이 결정적인 순간을 만들었다. 2024년 영업이익(310억)은 2023년(284억)보다 컸는데도 순이익(42억)은 2023년(61억)보다 작아졌다. 골이 더 깊어지고 세율까지 급등하면서, 영업이 더 잘된 해에 순이익이 더 나빠지는 역전이 일어난 것이다. 세금은 크기로는 조연이지만 순서를 바꾼 조연이다.

그래서 2025년의 반등도 '수확'이 아니라 산술로 읽어야 한다. 순이익은 42억에서 210억으로 168억 늘었는데, 이를 분해하면 영업이익이 135억 늘었고, 영업외 골이 92억 얕아졌으며, 법인세가 59억 더 나갔다. 세 힘의 합이다. 2025년 순이익 210억은 무거운 몸을 성공적으로 거둔 수확이 아니라, 영업이 좋아진 위에 골이 얕아지고 세금이 는 결과의 측정값일 뿐이다. 그러니 이 회사의 아랫줄은 하락에서 회복으로 가는 그래프가 아니라, 구조적 바닥(이자) 위에서 출렁이는 항(환율 유력)과 세금이 겹쳐 만든 널뛰기 그래프다.

```python
c.select("IS", ["영업이익", "법인세비용차감전순이익", "법인세비용", "당기순이익"], freq="Y")
# 2024: 영업이익 310 -> 영업외 골 -225 -> 세전 85 -> 법인세 43(유효 50.6%) -> 순이익 42
# 영업외 골(세전-영업): 2022 -86 / 2023 -191 / 2024 -225 / 2025 -133 (고정 아닌 출렁임)
```

이 분해가 밸류에이션으로 이어진다. 주가를 순이익과 견주는 PER로 이 회사를 재려 하면, 분모인 순이익이 매년 5배씩 출렁이기 때문에 배수가 아무 의미를 갖지 못한다. 2024년 순이익 42억으로 잰 PER과 2025년 210억으로 잰 PER은 다섯 배가 차이 난다. 같은 회사인데 이익 기준 밸류에이션이 해마다 뒤집히는 것이다. 그래서 오로라 같은 회사는 널뛰는 순이익보다, 그보다 안정적으로 우상향하는 영업이익(148억에서 445억으로 널뛰지 않고 커졌다)이 얼마나 두꺼워지는지, 그리고 그 아래 영업외 골이 얕아지는지를 함께 봐야 한다. 순이익 한 줄만 보고 사면, 환율이 유리했던 해를 실력으로 착각하기 쉽다.

정리하면, 오로라의 순이익이 몇 년째 눌려 있던 것을 단순한 실적 부진으로 읽으면 틀린다. 매출과 영업이익은 잘 나왔지만, 그 이익이 출렁이는 영업외 골과 세금이라는 두 문을 지나며 얇아졌다. 그 골의 바닥에는 무거운 몸을 짓느라 진 빚의 이자가 깔려 있고, 그 위에서 출렁이는 항은 확인되지 않는다. 그리고 골을 얕게 만드는 확실한 길 하나는 빚을 줄이는 것인데, 그것이 가능해지려면 앞서 본 투자 건설기가 끝나야 한다. 뒤에서 볼 대목이 바로 그 지점이다.
...
이 회사의 다음 장은 인형이 얼마나 더 팔리느냐가 아니라, 시가총액만큼 쌓아 올린 이 무거운 자산이 스스로 현금을 벌어 빚을 갚기 시작하느냐에서 갈린다. 그 답은 매출 증가율이 아니라 재무상태표와 현금흐름표의 몇 줄에 있다. 다음 공시에서 이 네 가지를 순서대로 보면 된다.

먼저, 영업외 골의 정체다. 앞에서 이 글이 유일하게 열어둔 여백이 영업이익 아래 골(2024년 -225억, 2025년 -133억)의 이자와 환율 몫이었다. 손익계산서 주석에는 이자비용과 외환손익이 실제 금액으로 나온다. 그 두 줄을 보면 골의 출렁임이 정말 환율에서 왔는지, 아니면 다른 데서 왔는지가 확인된다. 이것이 순이익 널뛰기를 이해하는 마지막 열쇠다.

그다음, 영업현금흐름이 순이익을 따라오는가. 이것이 가장 중요한 한 줄이다. 성장하는 분기에도 영업현금흐름이 순이익에 붙어 있으면, 오로라가 드디어 성장과 현금창출을 동시에 해내는 것이고, 그때 비로소 이익이 '진짜 내 것'이 된다. 반대로 매출이 뛰는 분기마다 현금이 다시 0이나 마이너스로 빠지면, 성장의 과실이 여전히 재고와 외상으로 흘러 들어가는 것이다. 좋은 실적 뉴스가 나온 분기에 현금흐름표를 함께 열어봐야 하는 이유가 여기 있다. 매출과 이익만 보면 화려하지만, 그 화려함이 통장까지 오는지는 현금흐름표에만 적혀 있다.

이어서, 부채비율과 유동비율이 계속 개선되는가. 부채비율 226%가 더 내려오고 재무활동의 순상환이 여러 분기 이어지면, 투자 사이클이 끝나고 회사가 자기 힘으로 몸을 가볍게 만드는 것이다. 여기에 유동비율이 1에 다가가면 단기 유동성의 빠듯함도 풀린다. 반대로 부채비율이 다시 오르기 시작하면, 성장을 여전히 빚으로 사는 것이고, 앞서 본 이자의 그림자가 다시 짙어진다.

마지막으로, 투자부동산 1,274억원이 현금을 만드는가. 이것이 이 회사의 정체를 가르는 질문이다. 이 부동산이 임대수익이나 매각으로 실제 현금을 만들어내면, 시가총액을 받치던 숨은 자산이 진짜 자산으로 바뀌는 순간이다. 그때 오로라는 인형 사업과 부동산 수익을 함께 가진 튼튼한 회사가 된다. 그러나 이 부동산이 장부에만 있는 닻으로 남으면, 그것은 인형 사업에 쓰이지 못한 채 이자만 먹는 무게로 남는다. 같은 1,274억원이 방석이 될지 닻이 될지는, 그 부동산이 현금을 만드느냐에 달렸다.

뒤의 세 가지(현금·부채·부동산)는 사실 하나의 질문이다. 무거운 자산을 짊어진 회사가 그 무게를 스스로 감당하며 가벼워지고 있는가. 세 지표가 함께 좋아지면(현금이 이익을 따라오고, 빚이 줄고, 부동산이 현금을 만들면) 오로라는 빚으로 지은 자산을 성공적으로 자기 것으로 만든 회사가 된다. 셋 중 하나라도 어긋나면(현금이 다시 마르거나, 빚이 다시 늘거나, 부동산이 계속 잠자면) 그 무게는 짐으로 남는다. 흥미로운 점은, 이 판단에 매출 성장률이나 캐릭터 인기 같은 화려한 지표가 하나도 들어가지 않는다는 것이다. 오로라의 다음은 얼마나 잘 파느냐가 아니라, 이미 벌어들인 것을 얼마나 잘 회수하고 정리하느냐로 결정된다. 성장주의 얼굴을 하고 있지만, 실제 관전 포인트는 자산 정리에 가까운 회사인 것이다.
...
| 2024 붕괴 분해 | 영업이익 310 → 영업외 골 -225(붕괴의 84%) → 세전 85 → 법인세 -43(유효 50.6%, 16%) → 순이익 42 | 세전=순이익+법인세 항등식, dartlab panel IS |
| 영업외 골(세전−영업이익) | -86(2022) / -191(2023) / -225(2024) / -133(2025) | dartlab panel IS, 고정 아닌 출렁임 |
| 2024→2025 순이익 +168 분해 | 영업이익 +135, 골 얕아짐 +92, 법인세 -59 | dartlab panel IS |

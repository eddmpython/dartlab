...
ai:
  ...
  dataAsOf: "2026-04-12"
carousel:
  title: 석유화학 빅4 중 유일하게 흑자인 이유
  caption: |-
    2024년 한국 석유화학 빅4 중 LG화학·롯데케미칼·한화솔루션이 모두 적자를 낼 때, 금호석유화학만 영업이익 2,728억 흑자였습니다. 같은 중국 공급과잉, 같은 에틸렌 스프레드 붕괴를 맞고도요.

    이유는 '없는 것'들입니다. NCC(석유화학의 심장)가 없어 에틸렌 붕괴를 피했고, 무리한 M&A를 안 해 부채비율이 36%(빅4 최저)입니다. 형 박삼구가 대우건설 인수로 그룹을 무너뜨릴 때 쫓겨난 박찬구의 회사만 살아남았고, 조카 박철완이 4년 표 대결에서 다 졌지만 그 압박이 주주환원 40%를 정착시켰습니다.

    이 회사의 역사는 덧셈이 아니라 뺄셈입니다. 정상 마진은 9.7%, 영업이익률 8% 회복이 사이클 중간을 넘는 신호입니다.
  explainers:
  - term: NCC(나프타 분해설비)
    body: 석유에서 에틸렌 등 기초 원료를 뽑는 거대 설비입니다. '석유화학의 심장'이지만, 금호석화는 이걸 안 가져 에틸렌 가격 붕괴를 피했습니다.
  - term: 합성고무 스프레드
    body: 제품(NB라텍스·SSBR) 값에서 원료값을 뺀 마진입니다. 금호석화 실적의 핵심으로, 이게 강해지면 영업이익률이 회복됩니다.
  relatedNews:
  - title: "[더벨] '실질적 무차입' 금호석화, 우량등급 진입 청신호"
    source: thebell.co.kr
    date: '2026-06-23'
    url: https://www.thebell.co.kr/free/content/ArticleView.asp?key=202606181810191840106313
    track: naver
    description: 네이버 보관 뉴스 기준. 실질적 무차입 재무 — 카드가 말한 '부채비율 빅4 최저, 뺄셈의 역사'를 확인합니다.
  - title: 금호석화, 합성고무 스프레드 강세에 실적↑…업종 최선호주 (NH)
    source: mt.co.kr
    date: '2026-06-26'
    url: https://www.mt.co.kr/stock/2026/06/26/2026062607332719030
    track: naver
    description: 네이버 보관 뉴스 기준. 합성고무 마진 강세 — 카드가 본 'NB라텍스·SSBR, 영업이익률 8% 회복'의 진행입니다.
  pinnedComment: 투자 판단이 아닙니다. 영업이익률 8% 회복, NB라텍스 세계 1위 점유율(중국 증설 위협), EV 타이어 SSBR 성장 — 이 셋을 봐야 합니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
      ...
      [[유일하게 흑자]]
    sub: |-
      LG화학·롯데케미칼·한화솔루션 다 적자.
      같은 중국 공급과잉을 맞고도 금호석화만 영업이익 2,728억.
    image: petrochemical-plant
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[없다]]
    sub: |-
      NCC는 석유화학의 심장 — 가진 회사는 에틸렌 붕괴에 직격됐다.
      금호석화는 NCC가 없어 원료를 사다 쓴다.
      약점으로 여겨지던 게 불황의 방패가 됐다.
    image: petrochemical-plant
  - layout: editorialStat
    ...
    unit: '% 부채비율'
    context: |-
      빅4 평균 부채비율 80~150%인데 금호석화는 36%.
      NCC 증설도, 무리한 인수도 안 한 결과가 자본으로 쌓였다.
      사이클 바닥에서 부도 위험 0.
  ...
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[살아남았다]]
    sub: |-
      형 박삼구가 대우건설·대한통운 10.6조 인수로 그룹을 무너뜨릴 때,
      반대하다 해임된 박찬구의 금호석화만 계열분리로 생존.
      그룹 자원이 인수에 쏠려 NCC를 못 지은 게 오히려 방패가 됐다.
    image: research-lab
  - layout: editorialBeat
    kicker: 조카의 난
    line: |-
      ...
      [[주주환원을 남겼다]]
    sub: |-
      조카 박철완이 4년간 표 대결을 벌이며 다 졌지만,
      그 압박에 주주환원율 40%·자사주 13% 소각이 정착됐다.
      패배자가 만든 구조적 유산.
    image: nb-latex
  - layout: editorial
    line: |-
      ...
      [[이긴 것]]
    sub: |-
      NCC 안 지어 살고, M&A 안 해 안전하고, 조카가 못 이겨 환원이 남았다.
      정상 마진은 9.7% — 영업이익률 8% 회복이
      사이클 중간을 넘는 신호다.
    image: ev-tire
---
...
![빅4 비교](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/0a/0a859919d83ca6c460eed9603f140d707eca89ae5afba8c5c512b8d3f6fb91f5.svg)
...
![사업구조](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/87/875931bcbc354b98996b7568906acad9d46b1ea1f0b1123f4e3698bb6551156c.svg)
...
![형제의 난 타임라인](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/3e/3ecc0044c2c768980b101595f3610ddb4760d39e64939a896df59942b35b225b.svg)
...
![제품 매출 구성](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/cf/cfc7b30b8c80451bef4966ea4586790a1569d9d6285704a85d81906fe3903e61.svg)
...
![조카의 난](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/54/541c91643437aa80fcb0d58fa5276f11ca4bd12b47fef4e8c87f99488594e3b4.svg)
...
투자자 입장에서 이 회사를 평가할 때 가장 중요한 숫자는 **영업이익률 9.7%**다. 왜 9.7%인가? 5년 데이터가 답한다:

| 연도 | 영업이익률 | 국면 |
|---|---:|---|
| 2020 | 14.8% | 회복 초입 |
| 2021 | **28.4%** | NB라텍스 피크 (비정상) |
| 2022 | 14.4% | 정상화 |
| 2023 | 5.7% | 사이클 하단 진입 |
| 2024 | **3.8%** | 사이클 바닥 |

5년 평균 **13.4%**. 하지만 2021년 코로나 특수(28.4%)를 빼면 평균 **9.7%**. 이것이 이 회사의 구조적 정상 마진이다. 현재 3.8%는 명백히 바닥이고 — 지금의 "빅4 유일 흑자"도 "남들보다 덜 나쁜 것"에 가깝다. **8%를 회복하는 분기가 오면 상승 사이클의 초입**이다. 그때 시장이 이 회사를 재평가할 것이다.
...
| 정상화 (영업이익률 8%) | 8.0% | 5,530억 | **4.4조** | +100% |
| 미니 호황 (영업이익률 15%) | 15% | 10,400억 | 8.3조 | +277% |
| NB라텍스 피크 재현 | 28% | 19,400억 | 15.5조 | 비현실적 (코로나 반복 필요) |

**정상 마진(8%) 회복 시 시총 4.4조.** 현재 시총 ~3조 대비 47% 업사이드. 이것이 사이클 주 투자의 핵심 로직이다 — "바닥은 확인됐고, 정상으로 돌아가면 50%+"라는 비대칭 베팅.
...
| **금호석유화학** | **7.2조** | **3.8%** | **36%** | **8x** | **X** | **NCC 없음 + 다운스트림** |

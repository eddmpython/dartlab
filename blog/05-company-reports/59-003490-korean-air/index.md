...
ai:
  ...
  dataAsOf: "2026-04-19"
carousel:
  title: "대한항공 — 10년을 걸어 아시아나를 삼켰는데 영업이익이 반토막 났다"
  caption: |
    2024년 12월 11일, 대한항공이 아시아나 인수를 완료했다. 통합 논의부터 11년, 발표부터 1,485일 걸린 한진그룹 사상 최대 M&A다. 그런데 통합 첫 해 성적표는 이상했다 — 매출은 +41% 폭증, 영업이익은 -47% 반토막.

    두 숫자가 정반대로 간 이유는 셋이 동시에 찍혔기 때문이다. 코로나 화물 슈퍼사이클이 정상으로 돌아오며 화물 단가가 $0.45에서 $0.22로 반토막(-5,500억), 마진 낮은 아시아나가 섞이며 가중평균이 희석(-3,000억), 통합 일회성 비용(-1,700억). 합쳐서 영업이익 -9,966억.

    그 전사가 더 극적이다. 2020년 코로나로 자본총계가 3,300억까지 쪼그라들어 자본잠식 직전. 유상증자 4.5조로 살아남았다. 그리고 산업은행 제안을 받아 13개국 경쟁당국 심사를 통과 — 미국엔 하와이안 항공 $1.9B 인수를, 유럽엔 12개 노선 양도를 내주고서야 합병을 마쳤다.

    합병일 하루에 자산 16.6조가 통째로 흡수돼 부채비율은 340%로 올랐다. 합병 전 12~15%였던 영업이익률은 4.4%로 내려앉았고, 2025Q1엔 2.9%까지 떨어졌다 — 그러나 분기로 보면 2.9%에서 5.5%로 회복 중이다.

    합병의 진짜 값은 규모에 있다. 매출 25조 × 영업이익률 7% = 1.75조. 합병 전 16.1조 × 11% = 1.77조. 이 두 숫자가 2026~2027년에 수렴할 때, 11년 합병의 값이 비로소 확정된다.
  explainers:
    - term: 화물 단가
      body: 비행기로 짐을 나르는 운임입니다. 코로나 때 $0.45로 치솟았다 $0.22로 반토막 나며, 통합 첫해 영업이익을 크게 끌어내렸습니다.
    - term: 부채비율
      body: 자본 대비 빚의 비율입니다. 아시아나 자산을 흡수하며 340%로 올라, 통합 시너지가 이를 상쇄하는지가 관건입니다.
  relatedNews:
    - title: 대한항공·아시아나항공 합병 인가…12월 17일 대한항공으로 통합
      source: zdnet.co.kr
      date: "2026-06-26"
      url: https://zdnet.co.kr/view/?no=20260626143116
      track: naver
      description: 네이버 보관 뉴스 기준. 아시아나 완전 통합 단계 — 카드가 말한 '11년 합병의 값이 수렴'하는 마지막 관문입니다.
    - title: 대한항공, 합병인가 넘어도 과제 산적…아시아나 '적자 흡수' 돌파구는
      source: bloter.net
      date: "2026-06-26"
      url: https://www.bloter.net/news/articleView.html?idxno=666677
      track: naver
      description: 네이버 보관 뉴스 기준. 마진 낮은 아시아나 흡수 과제 — 영업이익이 희석된 카드 논제와 직결됩니다.
  pinnedComment: |
  ...
  slides:
    - layout: editorial
      date: "2026.04.19"
      line: "10년을 걸어 아시아나를 삼켰는데\n영업이익은 [[반토막]] 났다"
      sub: "2024년 12월 통합 완료. 첫 해 매출은 +41% 폭증인데 영업이익은 -47%. 두 숫자가 정반대로 갔다."
    ...
    - layout: editorialStat
      ...
      bigNumber: "-9,966"
      unit: "억 영업이익 감소"
      context: "화물 정상화 -5,500, 아시아나 마진 희석 -3,000, 통합 비용 -1,700. 셋이 동시에 찍혔다."
      image: bg-dark-cloud-gradient
    - layout: editorialBeat
      kicker: "규제의 값"
      line: "13개국 심사와\n[[12개 노선 양도]]"
      sub: "1,485일 걸린 합병. 미국엔 하와이안 항공 $1.9B 인수를, 유럽 노선은 티웨이에 내주고서야 끝났다."
      image: bg-earth-globe-north-america
    - layout: editorialStat
      kicker: "통합 첫 해 손익"
      bigNumber: "4.4"
      unit: "%"
    ...
    - layout: editorialBeat
      kicker: "합병의 진짜 값"
      line: "매출은 [[1.78배]] 커졌다\n이익이 따라올 차례다"
      sub: "매출 25조 × 영업이익률 7% = 1.75조. 합병 전 16.1조 × 11% = 1.77조. 둘이 수렴할 때 값이 확정된다."
      image: bg-sky-gradient-split
---

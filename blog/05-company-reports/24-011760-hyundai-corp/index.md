...
ai:
  ...
  dataAsOf: "2026-04-12"
carousel:
  title: 매출 7.5조인데 영업이익률 1.85%? 현대코퍼레이션은 무역회사가 아니다
  caption: |-
    "종합상사 영업이익 4배 났다"는 기사를 봤다면 의심해야 한다. 현대코퍼레이션 2025년 영업이익은 1,401억, 전년(1,335억) 대비 실제로는 +5%. 그런데 매출은 7조 5,543억. 영업이익률 1.85%, 상사업계 최하위다.

    반전은 현금에 있다. 순이익 868억을 찍었는데 영업활동현금흐름은 -2,947억. 영업CF/순이익 -3.40. 벌었다는 이익의 3배 넘는 현금이 운전자본(매출채권·재고)에 묶여 빠져나갔다. 이 회사 이익의 진짜 출처는 무역 수수료가 아니라 자원 자회사를 연결로 끌어올린 것이다.

    관전 포인트: 부채비율 235%, PBR 0.5~0.7배. 시장은 아직 "상사주"로 본다. 다음 재무제표에서 자원 자회사 매출 비중 40% 돌파, 배당성향 30% 돌파, 그리고 영업CF가 플러스로 돌아서는지를 보라.
  explainers:
  - term: 영업현금흐름(OCF)
    body: 본업으로 실제 들어온 현금입니다. 현대코퍼레이션은 순이익 868억인데 OCF -2,947억 — 이익의 3배 넘는 현금이 운전자본에 묶여, 이익의 질이 의심됩니다.
  - term: 운전자본
    body: 매출채권·재고처럼 영업에 묶이는 돈입니다. 상사업은 거래대금이 크게 묶여, 매출 7.5조라도 현금이 안 돌면 이익이 장부에만 남습니다.
  relatedNews:
  - title: 현대코퍼레이션, 전쟁이 키운 '종합상사' 존재감…실적 성장 기대
    source: newsprime.co.kr
    date: '2026-06-18'
    url: http://www.newsprime.co.kr/news/article.html?no=737150
    track: naver
    description: 네이버 보관 뉴스 기준. 종합상사·자원 부문 부각 — 카드가 말한 '이익의 진짜 출처는 자원 자회사'와 같은 맥락입니다.
  - title: "[마켓인] 나신평, 현대코퍼레이션 신용등급 'A+' 상향"
    source: edaily.co.kr
    date: '2026-06-26'
    url: https://www.edaily.co.kr/news/newspath.asp?newsid=06143446645485656
    track: naver
    description: 네이버 보관 뉴스 기준. 신용등급 상향 — 카드가 본 '부채비율 235%' 부담이 개선되는 신호입니다.
  pinnedComment: 투자 판단이 아닙니다. 매출·영업이익·순이익·영업CF·부채비율·자본은 dartlab 실측(DART 연결), 부문 매출비중·자원 영업이익 기여·경쟁사 영업이익률·PBR·재계순위·지분율은 외부 IR/공시 근사 또는 역산 추정입니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
  ...
  - layout: editorialStat
    kicker: 2025 영업이익률 (연결)
    bigNumber: '1.85'
    unit: "%"
    context: |-
      매출 7조 5,543억에 영업이익 1,401억.
      포스코인터 ~5.5%, LX인터 ~4.2%(외부) 대비
      상사 4사 중 마진 최하위.
    image: trade-operations
  - layout: editorialBeat
    ...
    sub: |-
      순이익 868억을 찍은 해에
      영업활동현금흐름은 -2,947억.
    image: commodity-detail
  - layout: editorialStat
    kicker: 2025 영업CF / 순이익
    bigNumber: '-3.40'
    unit: 배
    context: |-
      순이익 868억 대비 영업CF -2,947억.
      이익은 회계로 찍히고
      현금은 매출채권·재고로 묶인다.
    image: logistics-site
  - layout: editorialBeat
    kicker: 이익의 진짜 출처
    line: |-
      무역이 매출 40%인데
  ...
  - layout: editorialStat
    ...
    unit: "%"
    context: |-
      부채 16,299 / 자본 6,948억. PBR 0.5~0.7배(시장데이터).
      다음에 볼 것 —
      자원 매출 40% 돌파·배당성향 30%·영업CF 플러스 전환.
    image: trade-port
---

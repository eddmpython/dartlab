...
ai:
  ...
  dataAsOf: "2026-05-06"
carousel:
  title: "한국콜마 — 매년 사상최대 영업이익이 영업외에서 새던 8년, 처음 본업이 이겼다"
  caption: |
    한국콜마는 손익계산서가 두 개인 회사다. 본업 ODM은 매년 사상 최대 영업이익을 찍는데, 그 아래 인수 회계가 매번 그 이익을 깎아왔다. 2025년 매출 2.72조, 영업이익 2,396억 — 둘 다 사상 최대다. 그런데 진짜 헤드라인은 따로 있다.

    시작은 2018년 4월이다. 화장품 ODM이 제약회사 CJ헬스케어를 1조 3,100억에 샀다. 자기 1년 매출에 가까운 돈으로. 자산은 하루아침에 3.27배, 무형자산은 19.8배로 부풀었다. 이 인수가 '두 번째 손익계산서'를 만들었다.

    그 대가가 매년 540억의 이자였다. 본업이 번 돈의 38%가 8년간 영업외에서 새 나갔고, 누적 약 -3,500억. 2022년엔 영업이익 733억 흑자가 금융비용·기타비용·평가손실·법인세 다섯 비용에 무너져 순이익 -41억 적자가 됐다.
  ...
  slides:
    - layout: editorial
      date: "2026.05.06"
      line: "매년 사상최대 영업이익이\n[[영업외에서 새던]] 8년"
      sub: "한국콜마는 손익계산서가 두 개다. 본업 ODM은 사상 최대인데, 8년간 인수 회계가 그 이익을 매번 깎았다."
      image: k-beauty-ampoule
    - layout: editorialStat
      kicker: "두 개의 손익계산서"
      bigNumber: "1.31"
      unit: "조 인수 · 2018"
      context: "화장품 ODM이 제약회사 CJ헬스케어를 샀다. 자기 1년 매출에 가까운 돈으로. 자산이 하루아침에 3.27배가 됐다."
      image: pharma-production
    - layout: editorialBeat
      kicker: "아래줄의 진실"
      line: "본업이 번 돈의 [[38%]]가\n영업외에서 새 나갔다"
      sub: "2018~2024년 7년 연속 영업외 음수, 누적 약 -3,500억. 가장 큰 범인은 1.1조 인수 차입의 이자다."
      image: bg-pharma-line
    - layout: editorialStat
      kicker: "매년 고정으로 빠지는 돈"
      bigNumber: "540"
      unit: "억 이자 · 매년"
    ...
    - layout: editorialBeat
      kicker: "마진의 V자"
      line: "매출원가율이\n[[4년 연속]] 좋아졌다"
      sub: "74.87%(2022 바닥) → 70.93%(2025). ROIC도 1.66%에서 7.40%로 — 6년 만에 처음 자본비용을 넘었다."
      image: bg-odm-cosmetic-line
    - layout: editorialStat
      kicker: "인수 사이클을 닫다"
      bigNumber: "12"
      unit: "%"
...
| 매출원가 | 6,438 | 10,009 | 11,085 | 9,268 | 11,582 | 13,969 | 15,775 | 17,531 | 19,310 |
...
| 금융비용 (이자) | **-437** | **-608** | -517 | -339 | **-595** | -586 | -540 | **-538** |
| 순금융 | -315 | -483 | -414 | -159 | -243 | -348 | -240 | -261 |
| 기타이익 | 28 | 42 | **+1,685** | 80 | 89 | 55 | 189 | 105 |
| 기타비용 | -58 | -103 | -277 | -90 | **-396** | **-757** | -612 | -129 |
| 공정가치측정금융자산 | 19 | -20 | -124 | -15 | **-290** | 6 | -31 | 112 |
| **영업외 합계 추정** | -326 | -564 | +870 | -184 | -840 | -1,044 | -694 | -271 |
...
한국콜마의 2025년 말 차입은 단기차입 7,441억 + 유동성사채 2,446억 = **9,887억으로 단기 비중 100%**다. 글로벌 12개 거래은행에 분산된 운영자금·시설자금 라인 — 하나·산업·수출입·농협·우리·신한·DBS — 으로 짜여있다 (개별 잔액은 검증표). 차환 위험은 분산했지만 매년 이자 협상을 12번 한다는 뜻이기도 하다. 2022~2023년 한국 기준금리 1.0% → 3.5% 인상 사이클에서 이자비용은 595 → 586 → 540억으로 안정 — 단기 차환 때마다 일부 부담을 갚으며 이전한 결과다.
...
**(억원, 1년치 합산)** 표시: **2019 이자 608억 = 영업이익 1,178억의 52%** · **2022 이자 595억 = 영업이익 733억의 81%** · **2025 이자 538억 = 영업이익 2,396억의 22%**.
...
**첫째, 금융비용 595억.** 인수 차입 이자의 평년치다. 이게 영업외 음수의 가장 큰 항목이다. 금융수익 352억이 그 일부를 상쇄하지만 순금융은 -243억이다.
...
| 2023 | 21,557 | 15,775 | 73.18% | +1.69%p |
...
두 시나리오는 양립한다. 매각 대금을 차입 상환과 본업 CAPEX에 동시 배분할 수 있다. 한국콜마의 2024 재무활동현금흐름 +40억 → 2025 +402억(다시 차입 추가)은 두 방향이 혼재함을 보여준다.

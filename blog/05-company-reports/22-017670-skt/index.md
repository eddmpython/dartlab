...
ai:
  ...
  dataAsOf: "2026-04-12"
carousel:
  title: 해킹 한 번이 8년 고배당 공식을 깬 통신사
  caption: |-
    SK텔레콤은 8년간 영업이익률 10%를 지킨 한국 대표 고배당주였습니다. 퇴직연금에 기본 편입되던 안정주였죠. 그 정체성이 2025년 4월 유심 해킹 한 번에 흔들렸습니다.

    2,500만 명(한국 인구 절반)의 유심 정보가 유출됐고, 무상 교체·소송·보안 투자로 한 해 5,000억+가 나갔습니다. 영업이익률은 6.3%로 떨어지고, 배당성향 143%는 사실상 0%가 됐습니다.

    이제 갈림길입니다. 통신 본업으로 돌아가 배당을 복원할지, AI(에이닷)로 전환할지. 2026년 영업이익률 8% 회복과 배당성향 50% 복원 — 이 둘이 정체성의 시험대입니다.
  explainers:
  - term: 배당성향
    body: 순이익 중 배당으로 나눠주는 비율입니다. SKT는 한때 143%(번 것보다 더 줌)였는데 유심 해킹 비용으로 사실상 0%가 됐고, 50% 복원이 정체성의 시험대입니다.
  - term: 영업이익률
    body: 매출에서 영업이익이 남는 비율입니다. SKT는 8년간 10%를 지킨 고배당주였는데, 해킹 비용 5,000억+로 6.3%까지 떨어졌습니다.
  relatedNews:
  - title: SK텔레콤, 실적에 AI까지 더했다…하반기 통신주 최선호 부상
    source: pinpointnews.co.kr
    date: '2026-06-28'
    url: https://www.pinpointnews.co.kr/news/articleView.html?idxno=463663
    track: naver
    description: 네이버 보관 뉴스 기준. 실적 회복·AI 동력 — 카드가 말한 'OPM 8% 회복이냐, AI 전환이냐' 갈림길의 최신 시각입니다.
  pinnedComment: 투자 판단이 아닙니다. 2026년 영업이익률 8%+ 회복, 배당성향 50%+ 복원, 에이닷 수익화 — 이 셋이 'SKT가 무엇인가'를 답합니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
      ...
      [[8년 공식]]을 깼다
    sub: |-
      8년간 영업이익률 10%를 지킨 고배당주.
      2025년 4월의 사건 하나로 그 공식이 무너졌다.
    image: hacking
  - layout: editorialBeat
    ...
    line: |-
      ...
      [[안정적]]
    sub: |-
      설비투자가 끝나면 현금이 쌓이고 배당으로 나간다.
      SKT는 이 공식을 가장 모범적으로 지켰다 —
      영업이익률 10%, KT·LGU+(6%)보다 높게.
    image: operations-center
  - layout: editorialStat
    kicker: 2025년 4월 유심 해킹
    bigNumber: '2,500'
    unit: 만명
    context: |-
      유출된 유심 정보가 2,500만 명 — 한국 인구의 절반.
      전 가입자 무상 교체, 위약금 면제, 소송 충당금.
      업계 추정 한 해 대응 비용 5,000억+.
    image: hacking
  - layout: editorialStat
    kicker: 한 해 만에
    bigNumber: '6.3'
    unit: '% 영업이익률'
    context: |-
      10.2%(2024) → 6.3%(2025), 4%p 증발.
      통신은 고정비 사업이라 매출 −4.7%가 영업이익 −41%로 증폭됐다.
      '해킹 전 1위, 해킹 후 평균'으로 내려왔다.
    image: operations-center
  - layout: editorialBeat
    kicker: 정체성이 흔들렸다
    line: |-
      ...
      [[사실상 0%]]
    sub: |-
      SKT를 보유한 이유가 배당 하나였던 투자자가 많았다.
      해킹 대응·소송·AI 투자에 현금이 필요해지자
      그 배당이 멈췄다.
    image: user-context
  - layout: editorialBeat
    kicker: 그래서 AI로?
    line: |-
      ...
      [[수익은 아직]]
    sub: |-
      AI 비서로 전환하려면 설비투자가 다시 늘어야 한다.
      그런데 설비투자가 늘면 배당이 줄어든다.
      고배당과 AI 전환은 구조적으로 부딪힌다.
    image: ai-pivot
  - layout: editorial
    line: |-
      고배당주인가
    ...
    sub: |-
      둘 다 하려는 게 가장 나쁜 선택.
      2026년 영업이익률 8% 회복 + 배당성향 50% 복원 —
      둘 다 못 하면 고배당 공식은 끝난 것이다.
    image: ai-pivot
---
...
그런데 2025년, 영업이익률이 **6.3%**로 떨어졌다. 8년 평균에서 거의 4%p가 증발했다. 순이익은 전년 대비 **-5%**. ROCE(투하자본이익률)는 10.2%에서 **4.3%**로 꺾였다.
...
# OCF:
#   2020: 4.8조  2021: 5.03조  2022: 5.16조
#   2023: 4.95조  2024: 5.09조
# FCF = OCF - CAPEX:
...
# revenue: 17.6조 → 17.9조 → 17.1조 (-4.5%)
# operatingProfit: 1.75조 → 1.82조 → 1.07조 (-41%)
# netProfit: 0.96조 → 0.39조 → 0.38조 (-5%)
# operatingMargin: 10.0% → 10.2% → 6.3%
```

영업이익 -41%, 순이익 -5%. 순이익 감소가 작은 이유는 2024년 이미 대규모 영업외 비용이 선반영돼 순이익 기저가 낮았기 때문이다.
...
# cfToNi 5y: [2.1, 5.4, 5.2, 12.9, 10.5]  ← 2025년 비정상 (OCF/연결순이익 기준)
# accrualRatio: 높음 (충당금 대량 계상)
# earnings_quality: poor (일회성 효과)
```

(cfToNi가 10.5로 높아진 건 영업CF가 안정적인 상황에서 순이익이 낮기 때문. 2024년에도 cfToNi가 12.9로 이미 높았다. 본질은 **비정상 상태**.)
...
KT와 LGU+는 배당을 꾸준히 올렸다. SKT만 2025년에 배당 삭감이 불가피하다. 배당 투자자가 SKT를 떠나면 KT와 LGU+로 이동한다. [경동나비엔](/blog/009450-kyungdong-navien)이 안정 배당으로 장기 투자자를 붙잡는 것처럼, 통신주는 배당 연속성이 주가의 바닥을 만든다. SKT는 그 바닥이 깨졌다.
...
2025년 PER이 34.5배로 뛴 건 순이익이 -5% 감소(-73% 아님)에 그쳤으나 절대 순이익이 낮게 유지됐기 때문이다. 이익이 줄면 PER이 기계적으로 올라간다. 이건 "비싸졌다"가 아니라 "이익이 비정상적으로 낮다"는 신호다.
...
| 영업레버리지 8.8 | dartlab |
| 매출 -4.7%, 영업이익 -41%, 순이익 -5% | dartlab (2024→2025) |
...
이 글은 dartlab 실측 데이터를 바탕으로 한 **기업이야기**다. 투자 권유가 아니다. 수치는 공개된 재무제표와 공시를 기준으로 하며, 해킹 비용 추정 및 충당금 배분은 작가의 분석이다. 실제 투자 판단은 본인의 책임이다.


---

<CompanyFinancials code="017670" />

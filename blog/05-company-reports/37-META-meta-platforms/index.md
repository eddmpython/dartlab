...
|---|---:|---:|---:|---:|---:|
| 설비투자 | **69.7** | 37.3 | 28.1 | 32.0 | 19.2 |
| 설비투자/매출 | **34.7%** | 22.6% | 20.8% | 27.4% | 16.3% |
| 영업활동현금흐름 | **115.8** | 91.3 | 71.1 | 50.5 | 57.7 |
| 잉여현금흐름(잉여현금흐름) | **46.1** | 54.1 | 43.0 | 18.5 | 38.5 |
...
Meta의 10-K에 따르면 설비투자의 대부분은 AI 학습·추론용 GPU 데이터센터, 네트워크 인프라, 서버 장비에 투입됐다([Meta 10-K, 2025](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001326801&type=10-K)). 구체적으로:
...
1. **감가상각비(과거에 산 설비 값을 매년 조금씩 비용으로 깎는 것)**: 3막에서 본 설비투자 $70B의 누적분이 매년 감가상각으로 돌아온다. 이것은 비용이지만 현금 유출이 아니다. 이미 3막에서 돈을 냈기 때문이다. Meta의 2025년 감가상각비는 약 $21.4B다([Meta 10-K, 2025 Cash Flow Statement](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001326801&type=10-K)).
...
| 당기순이익 | 60.5 | 62.4 | 39.1 | 23.2 | 39.4 |
| 영업활동현금흐름 | **115.8** | 91.3 | 71.1 | 50.5 | 57.7 |
| 영업활동현금흐름/NI | **191%** | 146% | 182% | 218% | 147% |
| 설비투자 | 69.7 | 37.3 | 28.1 | 32.0 | 19.2 |
| 잉여현금흐름(잉여현금흐름) | 46.1 | 54.1 | 43.0 | 18.5 | 38.5 |
...
R&D 비용 증가도 있지만 부차적이다. AI 모델 학습에 투입되는 연구개발비는 설비투자가 아니라 비용으로 처리된다. GPU 구매는 설비투자지만, 그 GPU를 돌려서 Llama 모델을 학습시키는 비용(전기, 인건비)은 R&D 비용이다. 현금흐름과 세금의 관계가 궁금하다면 [영업활동현금흐름 vs 당기순이익](/blog/operating-cash-flow-vs-net-income)에서 더 자세히 다뤘다.
...
배당성향 8.8%는 상징적 수준이다. $5.3B는 잉여현금흐름 $46.1B의 11.5%에 불과하다. 이 배당의 의미는 금액이 아니라 **시그널**이다. "우리는 이제 성장만 하는 회사가 아니라 주주에게 돌려주는 회사이기도 하다."
...
| 실패 항목 | 원인 | 심각도 |
|---|---|---|
| 총자산수익률 양수 | 총자산 급증($366B)으로 총자산수익률 분모 폭발 | 낮음 — 수익력 아닌 자산 구조 문제 |
| 총자산수익률 개선 | 같은 이유 — 자산 증가 속도 > 이익 증가 속도 | 낮음 |
...
2026년 1분기 10-Q에서 이미 확인되는 압박은 더 구체적이다. Cost of revenue는 $10.218B, R&D는 $17.699B까지 늘었고, 회사는 2026년 설비투자 범위를 $125B~$145B로 제시했다. 이 글은 공시 밖 장기 비용 숫자를 결론으로 쓰지 않고, 이미 공시에 찍힌 AI 인프라 비용 증가와 투자 규모를 리스크로 본다.
...
- 최신 분기 공시: [Meta Platforms 2026 Q1 Form 10-Q, quarter ended 2026-03-31](https://www.sec.gov/Archives/edgar/data/1326801/000162828026028526/meta-20260331.htm)
- 최신 연간 공시: [Meta Platforms FY2025 Form 10-K, year ended 2025-12-31](https://www.sec.gov/Archives/edgar/data/1326801/000162828026003942/meta-20251231.htm)
- 세그먼트 기준: 2026 Q1 10-Q의 Family of Apps / Reality Labs revenue and income from operations tables
...
|---|---:|---:|---:|---:|---:|---:|
| 매출액 | 86.0 | 117.9 | 116.6 | 134.9 | 164.5 | 201.0 |
| 영업이익 | 32.7 | 46.8 | 28.9 | 46.8 | 69.4 | 83.3 |
| 당기순이익 | 29.1 | 39.4 | 23.2 | 39.1 | 62.4 | 60.5 |
...
| 항목 ($B) | 2020 | 2021 | 2022 | 2023 | 2024 | 2025 |
|---|---:|---:|---:|---:|---:|---:|
| 영업활동현금흐름 | 38.7 | 57.7 | 50.5 | 71.1 | 91.3 | 115.8 |

| 보조 비율 | 2020 | 2021 | 2022 | 2023 | 2024 | 2025 |
|---|---:|---:|---:|---:|---:|---:|
| 영업이익률(OPM) | 38.0% | 39.7% | 24.8% | 34.7% | 42.2% | 41.4% |
| 순이익률(NPM) | 33.8% | 33.4% | 19.9% | 29.0% | 37.9% | 30.1% |

---

## 검증표

본문 인용 수치를 dartlab 호출과 공식 공시로 검증한다. 📅 dartlab 실측 2026-06-20 · META 미국 연결(USD)·분기 합산 기준.

| 본문 수치 | 출처 / 호출 | 판정 |
|---|---|---|
| 매출 2025 201.0B, 영업이익 83.3B, 순이익 60.5B | `c.select("IS", ["sales", "operating_profit", "net_income"], freq="Y")` | 실측 |
| 2025 영업이익률 41.4%, 순이익률 30.1% | 영업이익÷매출, 순이익÷매출 | 실측 |
| 2025 영업활동현금흐름 115.8B | `c.select("CF", ["operating_cashflow"], freq="Y")` | 실측 |
| 2026 Q1 매출 56.311B, Cost of revenue 10.218B, R&D 17.699B, 영업이익 22.872B, 순이익 26.773B | [2026 Q1 10-Q](https://www.sec.gov/Archives/edgar/data/1326801/000162828026028526/meta-20260331.htm) | 공식 공시 |
| 2026 Q1 Family of Apps 영업이익 26.900B, Reality Labs 영업손실 -4.028B | 2026 Q1 10-Q segment table | 공식 공시 |
| 2026 Q1 광고 노출 증가와 평균 광고 가격 +12%, FoA other revenue +375M(+74%) | 2026 Q1 10-Q MD&A revenue discussion | 공식 공시 |
| 2026 설비투자 범위 125B~145B, 2026 Q1 property and equipment purchases 19.00B | 2026 Q1 10-Q liquidity and capital resources | 공식 공시 |

분해 한계: dartlab 연결 재무제표는 광고 가격, AI 추천 품질, 데이터센터 단가, Reality Labs 제품별 손익을 분리하지 않는다. 공시가 직접 증명하는 것은 연결 매출·영업이익·현금흐름·세그먼트 손익·설비투자 규모다.

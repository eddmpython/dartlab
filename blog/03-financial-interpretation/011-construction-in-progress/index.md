...
![건설중인자산을 다섯 숫자로 점검하는 진행 점수판](./assets/011-cip-progress-scoreboard.svg)
...
반대로 가동률이 높고 현금지출이 분명하며, 이후 유형자산 전환과 감가상각 흡수 논리까지 보이면 `비용이 늘기 전에 읽어낸 투자`가 된다. 이 감각은 [`사업보고서 텍스트, 이렇게 읽는다`](/blog/reading-business-reports)에서 말한 읽기 순서와도 연결된다. 사업의 내용에서 나온 증설 설명을 숫자 다섯 개로 검증하는 셈이기 때문이다.
...
![산업별 건설중인자산 해석 비교 — 투자 리듬에 따라 같은 숫자도 다르게 읽힌다](./assets/011-cip-industry-comparison.svg)

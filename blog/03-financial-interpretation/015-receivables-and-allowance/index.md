...
이 글은 매출채권과 대손충당금을 통해 **이익의 질**을 읽는 방법을 정리한다. 손익계산서의 매출 성장, 재무상태표의 채권 증가, 현금흐름표의 괴리, 충당금 가정이 어떻게 연결되는지 실전적으로 설명한다. 운전자본 전체 감각이 필요하면 [`재고자산과 평가손실 읽는 법`](/blog/inventory-and-write-downs), 숫자와 본문 연결 감각이 필요하면 [`사업보고서에서 CEO 말보다 숫자가 중요한 순간`](/blog/when-numbers-matter-more-than-ceo-words)을 같이 보면 좋다.

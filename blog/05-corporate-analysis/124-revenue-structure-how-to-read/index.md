...
이 글은 "무엇으로 돈을 버는가"에 대한 답이었다. 다음 글에서는 "돈을 어디서 조달하는가" — [자금 구조](/blog/samsung-sdi-funding-structure)를 다룬다. 부채비율, 차입 만기, 이자보상배율, 부실 예측 지표를 통해 사업의 지속 가능성을 판단하는 프레임워크를 정리한다.

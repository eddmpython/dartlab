...
예를 들어 원재료 리스크가 강해졌는데 MD&A는 추상적으로만 설명한다면, `재고자산과 평가손실 읽는 법`이나 [`매출채권과 대손충당금 읽는 법`](/blog/receivables-and-allowance)처럼 운전자본 관련 숫자로 우회 검증할 수 있다. 리스크가 말보다 숫자에서 먼저 현실화되는 경우가 많기 때문이다.

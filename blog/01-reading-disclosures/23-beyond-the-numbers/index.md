...
c.panel("감사")          # 감사의견 — 숫자를 신뢰할 수 있는가
c.analysis("governance", "지배구조")   # 최대주주 — 누가 회사를 지배하는가
c.panel("임원")          # 임원 보수 — 경영진 인센티브 구조

c.panel("차입금")         # 차입금 주석 — 금리, 만기, 담보
c.panel("재고")          # 재고자산 주석 — 구성, 평가손실
c.panel("충당부채")       # 충당부채 주석 — 소송, 보증

c.panel("경영진단")       # 경영진단의견 — 경영진이 실적을 어떻게 설명하는가
c.panel("사업의 내용")     # 사업의 내용 — 시장 환경, 경쟁, 원재료
```

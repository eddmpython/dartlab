...
이 부분은 [`좋은 오너십과 위험한 오너십의 차이`](/blog/governance-red-flags)와 이어서 보면 훨씬 선명해진다. 025가 경고 신호를 보는 글이라면, 027은 그 신호를 좋은 구조와 비교하는 글이다.
...
이 질문 방식이 좋은 이유는 지배구조를 도덕 평가처럼 읽지 않게 만들어주기 때문이다. 실제 투자 판단에서는 "착한 회사인가"보다 "이 구조가 앞으로 누구 편으로 움직일 가능성이 큰가"가 더 중요하다. 그래서 [`좋은 오너십과 위험한 오너십의 차이`](/blog/governance-red-flags), [`임원 보수 공시는 무엇을 말해주나`](/blog/executive-pay-disclosure), [`주주환원 정책은 말과 숫자 중 무엇을 봐야 하나`](/blog/shareholder-return-what-matters)를 함께 보면 하나의 경고가 아니라 한 방향으로 기우는 구조를 읽게 된다.
...
- [좋은 오너십과 위험한 오너십의 차이](/blog/governance-red-flags)

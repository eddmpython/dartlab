...
여기서 추가로 봐야 할 포인트가 **감가상각비 추세**다. 이번 분기 감가상각비가 전 분기보다 늘었다면, 최근에 대규모 설비투자를 마쳤다는 뜻이다. 줄었다면, 오래된 설비의 상각이 끝나고 있다는 뜻이다. [감가상각비가 CAPEX 이후를 어떻게 말해주는지](/blog/capacity-utilization-capex)를 이해하면 이 흐름을 더 정밀하게 읽을 수 있다.

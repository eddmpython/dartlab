...
가장 중요한 문서다. 한국의 사업보고서와 가장 유사한 역할을 한다 (각 form을 실전에서 연결해 읽는 방법은 [10-K, 10-Q, 8-K, 20-F, 6-K, 13F를 한 번에 읽는 법](/blog/sec-filing-types-10k-10q-8k)에서 다룬다).
...
- [EDGAR 개별공시 원문, API로 어디까지 가져올 수 있나](/blog/edgar-individual-filing-api) — EDGAR 데이터를 프로그래밍으로 접근하는 방법

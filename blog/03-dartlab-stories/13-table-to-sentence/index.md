...
date: "2026-07-12"
description: "삼성전자 2026Q1 영업이익률 42.75%라는 숫자를 코드로 근거 문장으로 바꿀 때는 기간, 표, 분자, 분모, 한계를 함께 써야 한다. dartlab panel IS 출력에서 매출액 133.873조원과 영업이익 57.233조원을 확인하고 초보자도 그대로 따라 쓸 수 있는 근거 문장으로 바꾼다."
...
이번 편은 숫자를 멋진 말로 포장하는 편이 아니다. 표에서 본 숫자를 근거가 남는 문장으로 바꾸는 편이다. 좋은 문장은 길어서 좋은 문장이 아니라 다시 확인할 수 있어서 좋은 문장이다. "2026Q1 손익계산서 기준, 영업이익 57.233조원을 매출액 133.873조원으로 나누면 영업이익률은 약 42.75%다"처럼 쓰면 독자는 같은 표를 열어 같은 계산을 다시 해 볼 수 있다.
...
결과가 `KR`이면 DART 회사로 열렸다. 오늘 코드의 목표는 표를 크게 보여 주는 것이 아니라 문장 재료를 잃어버리지 않는 것이다. `sentenceParts`는 기간, 표 이름, 분자, 분모, 계산 결과를 한 묶음으로 만든다. 문장을 쓰기 전에 이 다섯 칸이 먼저 차야 한다.
...
순서를 외우기 어렵다면 이렇게만 기억하면 된다. **언제, 어디서, 무엇을, 무엇으로, 얼마가 나왔다.** 2026Q1이 언제, 손익계산서가 어디서, 영업이익이 무엇을, 매출액이 무엇으로, 42.75%가 얼마다. 이 순서로 쓰면 어려운 재무 용어를 많이 쓰지 않아도 문장이 버틴다.

...
이번 편에서는 DART 공시분석을 설치 없이 시작하고, 데이터가 어떤 모양이며, 그것이 어떻게 갱신되는지를 훑었다. 다음 편 [재무제표, 파이썬 한 줄](/blog/call-financial-statements)은 손을 더 깊이 넣는다. **재무제표를 실제로 불러오고, 원하는 항목을 골라내고, 그것을 표로 만드는 법**이다.

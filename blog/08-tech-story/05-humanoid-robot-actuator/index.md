...
carousel:
  ...
  slides:
    ...
    - layout: editorialBeat
      kicker: "아직 오지 않은 이익"
      line: "결국 이익은 아직 도착하지 않았고, 지금 값을 만드는 것은 실적이 아니라 미래의 기대입니다."
...
그렇다면 질문. **휴머노이드라는 이 뜨거운 기술의 부품을 만드는 우리 상장사들은, 지금 돈을 얼마나 벌고 있을까?** [원자로를 만드는 회사](/blog/smr-reactor-value-chain)는 미래의 매출을 기다리는 중이었고, [전기를 실어나르는 변압기 회사](/blog/ai-power-transformer-supercycle)는 이미 이익이 터졌다. 로봇은 어느 쪽일까. 우리 데이터로 여섯 회사를 실측한 결과는, 앞의 두 편과 또 달랐다.
...
2025년 매출이 오히려 줄었고, 적자는 더 커졌다. 영업이익률 마이너스 180%는 100원을 팔 때마다 180원을 잃었다는 뜻이다. 완성 로봇은 아직 판매량이 적어 고정비를 나눠 낼 규모가 안 되는데, 미래를 위한 연구개발과 영업 조직에는 계속 돈을 넣어야 한다. 그래서 팔수록 손해인 국면이 이어진다. 삼성이 최대주주가 된 레인보우로보틱스도 매출은 90억에서 341억으로 컸지만 여전히 영업 적자다.

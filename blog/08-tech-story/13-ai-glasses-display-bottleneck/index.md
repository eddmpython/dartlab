...
![광원 5,000 nit가 아이박스 확산과 격자 손실을 거쳐 눈에서는 실내 글자 한 줄로 줄어드는 빛의 통행세](./assets/13-light-budget-tollgate.svg)
...
![세대별 최대 밝기 사다리. 실내는 수천 nit로 되지만, 야외 풀컬러가 요구하는 수만에서 수백만 nit에 닿는 것은 마이크로LED뿐이다](./assets/13-brightness-ladder.svg)
...
![LG디스플레이 3년 적자 후 2025년 흑자전환. 그러나 그 주어는 대형 패널 사이클이지 AR 안경이 아니다](./assets/13-lgd-cycle.svg)
...
![삼성 장부엔 안경 라인이 없고, 메타 Reality Labs는 손실이 매출을 압도하는 크기로 잡힌다. 대조의 축은 금액이 아니라 라인의 유무다](./assets/13-presence-absence.svg)
...
![안경 인접 부품층 마진과 누가 이기든 파는 전사 마진. 한 줄로 이으면 안 되는 두 블록이다](./assets/13-two-blocks-margin.svg)

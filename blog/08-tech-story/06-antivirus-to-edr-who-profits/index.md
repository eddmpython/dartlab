---
title: "백신은 왜 커널까지 들어갔나: 시그니처·EDR·제로트러스트가 바꾼 보안 산업 지도"
date: "2026-07-05"
description: "2024년 크라우드스트라이크 장애는 보안 소프트웨어가 왜 운영체제 커널까지 들어갔는지 묻게 했다. 시그니처 백신, 방화벽, EDR, 제로트러스트를 기술 층위별로 나누고 DART·EDGAR 근거로 9개 보안사의 손익을 연결해 보안 산업의 세대교체를 읽는다."
category: tech-story
series: tech-story
seriesOrder: 6
topicSlug: "antivirus-to-edr-who-profits"
tags:
  - 사이버보안
  - 백신
  - EDR
...
carousel:
  ...
  caption: |
    ...
    보안 9곳을 DART와 EDGAR 근거로 실측하니, 커널 기반 EDR의 크라우드스트라이크는 매출총이익률 75%에도 성장 비용과 주식보상이 컸고, 방화벽의 포티넷은 ASIC과 성숙한 구독 구조로 30.7%를 남겼습니다. 기술 세대와 자본 모델이 다른 그림을 만들었습니다.
  ...
  slides:
    - layout: editorial
      line: "백신은 왜 커널까지 들어갔나"
      sub: "시그니처·EDR·제로트러스트가 바꾼 보안 산업 지도"
    ...
    - layout: editorialBeat
      kicker: "세대교체의 조건"
      line: "기술은 시그니처를 떠났지만, 회계 이익은 아직 성숙한 방화벽과 내수 백신에도 남아 있습니다."
...
![시그니처 방식과 행동탐지(EDR)의 차이](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/38/38520552d2b9296b7e4e6118692732d58f373ff8cd950843d5b8fc8bacebb55a.svg)
...
![보안 기술의 3세대 지형](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/36/36ef76a24a100841d3d505146ba362b9c6e559c309e920f158cae4e3a950ff2d.svg)

공정별 근거 지도를 먼저 세우면 이 어긋남이 덜 이상해진다. 한국사는 DART 손익과 사업보고서, 미국사는 EDGAR 10-K와 각사 실적발표를 함께 본다.

| 공정/층위 | 기술 역할 | 대표 회사 | 공시 근거 | 재무로 보이는 흔적 |
|---|---|---|---|---|
| 전통 백신 | 알려진 악성코드 시그니처를 막는다 | 안랩(DART) | DART 손익과 보안 제품 설명 | 성숙한 내수 구독·유지보수 매출이 안정적 흑자로 보인다 |
| 방화벽·네트워크 보안 | 경계 트래픽을 검사하고 전용 장비로 처리한다 | 포티넷·팔로알토(EDGAR), 윈스(DART) | EDGAR 10-K, DART 사업보고서 | ASIC, 장비, 구독 조합이 높은 매출총이익률을 만든다 |
| EDR·XDR | 단말 행동을 커널 가까이에서 감시한다 | 크라우드스트라이크·센티넬원(EDGAR), 지니언스(DART) | EDGAR 10-K와 실적발표, DART 손익 | 성장 비용과 주식보상이 회계 이익을 누른다 |
| 제로트러스트·SASE | 접속을 매번 검증하고 클라우드 경계로 옮긴다 | 지스케일러·팔로알토(EDGAR) | EDGAR 10-K와 실적발표 | 구독 매출은 커지지만 영업·마케팅 비용이 크게 남는다 |
| 한국 내수 보안 | 공공·금융권 조달과 유지보수를 맡는다 | 안랩·윈스·지니언스·파수(DART) | DART 손익과 사업보고서 | 흑자는 지키지만 시장 규모가 글로벌 SaaS보다 작다 |
...
![보안 9곳의 영업이익률 지도](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/f6/f6f0ed1af32f687b6909f6f31ed8c726d2580e2c4e4bf6bd461b39c063926a14.svg)
...
표시: FY2024(2024년 1월 결산)에 영업이익률이 -0.1%까지 올라 흑자를 코앞에 뒀다가, 7·19 사고가 포함된 FY2025에 -3.0%로 되밀렸다(고객 보상·계약 조정 여파). 시장을 이끄는 회사와 회계 이익을 남기는 회사가 자주 다르다는 건 [벡터 검색 스택 지도](/blog/vector-search-who-profits)에서도 본 장면이다.

## 4. 매출총이익 75%를 흡수하는 성장 비용
...
![크라우드스트라이크와 포티넷: 매출 100원의 행방](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/9b/9ba3cb9c671081dfb406b6bcc9c988b9297cdced7e8074e9c82b0cff6fdee824.svg)
...
![한국과 미국 보안: 규모와 이익의 반대 그림](https://huggingface.co/datasets/eddmpython/dartlab-media/resolve/main/objects/sha256/c0/c0263040a43f7dd5382bf9c6021f76bc968094bd7ba7c46b08937198bea1fc92.svg)

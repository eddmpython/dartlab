...
| 팔로알토 (PANW) | 2~3세대 플랫폼 | 92.2억 달러 | +13.5% |
| **안랩** (053800) | 1세대 백신 | 2,677억 원 | +12.4% |
| 윈스 (136540) | 2세대 네트워크 | 990억 원 | +21.3% |
| 지니언스 (263860) | 3세대 접근제어 | 484억 원 | +14.5% |
| **크라우드스트라이크** (CRWD) | 3세대 EDR | 43.8억 달러 | **-3.5%** |
| 지스케일러 (ZS) | 3세대 제로트러스트 | 26.7억 달러 | -4.8% |
| **센티넬원** (S) | 3세대 EDR | 10.0억 달러 | **-32.1%** |

표시: 흑자 4곳은 모두 1~2세대(방화벽·백신)이고, 적자 3곳은 모두 가장 앞선 3세대(EDR·제로트러스트)다.

지도가 어긋난다. 기술 지도에서 맨 위에 있던 3세대(크라우드스트라이크 -3.5%, 지스케일러 -4.8%, 센티넬원 -32.1%)가 이익 지도에서는 바닥이다. 반대로 아무도 첨단이라 부르지 않는 옛 방화벽 포티넷이 30.7%로 꼭대기에 있다. 가장 좋은 기술을 가진 회사가 가장 돈을 못 벌고 있는 것이다. 이건 실수인가, 아니면 이유가 있는가?

![보안 9곳의 영업이익률 지도](./assets/06-profit-map.svg)

이 어긋남은 한 해의 우연이 아니다. 시간을 펼치면 더 분명해진다. 크라우드스트라이크는 5년 동안 매출이 4배 넘게 불었는데도, 영업이익률은 내내 마이너스를 벗어나지 못했다.

| 크라우드스트라이크 | FY2021 | FY2022 | FY2024 | FY2025 |
|---|---:|---:|---:|---:|
| 매출 (억 달러) | 10.2 | 30.6 | 39.5 | 43.8 |
| 영업이익률 | -9.1% | -0.1% | -0.8% | -3.5% |

표시: 매출이 4.3배로 폭발하는 동안에도 회계상 영업이익은 줄곧 적자였다(FY2023은 로컬 데이터 공백). 시장을 이끄는 회사와 돈을 버는 회사가 자주 다르다는 건, "누가 버나"를 똑같이 물었던 [벡터 검색 편](/blog/vector-search-who-profits)에서도 본 장면이다.
...
크라우드스트라이크는 100원을 팔면 원가를 빼고 **75원**이 매출총이익으로 남는다(매출총이익률 75.1%). 소프트웨어 구독이라 원가가 거의 없어서, 이 자체는 세계 최고 수준의 장사다. 문제는 그 다음이다. 이 75원을 영업비용에 쏟아붓는데, 그 총합이 **78.5원**으로 벌어들인 총이익을 넘어선다. 가장 큰 덩어리가 다음 세대 기술을 만드는 연구개발(28원)과 새 고객을 잡는 영업·관리비(38원)다. 75원을 벌어 78.5원을 쓰니, 영업이익은 100원당 마이너스 3.5원으로 끝난다. 특히 이 영업비용 안에는 **직원에게 현금 대신 주식으로 준 급여(주식보상)가 21원**이나 비현금으로 녹아 있다. 성장에 필요한 인재를 현금이 아니라 주식으로 사들이는 것이다.

핵심은 이 지출이 낭비가 아니라 **선택**이라는 점이다. 크라우드스트라이크는 매출이 4년 만에 4.3배(10.2억→43.8억 달러)로 폭발했다. 이 성장을 사기 위해 지금의 이익을 미래로 미루는 중이다. 반면 포티넷은 이미 다 자란 사업이다. 매출총이익률은 오히려 더 높고(80.5%), 연구개발비는 매출의 12%로 절반 이하이며, 주식보상 같은 폭발적 비용이 없다. 그 규율이 영업이익률 30.7%를 만든다. 같은 보안업인데 한쪽은 성장을 사고 한쪽은 이익을 남긴다.
...
표시: 성장을 좇기보다 이미 가진 사업에서 이익률을 끌어올린 궤적이다. 자체 설계한 전용 칩(ASIC)으로 장비 원가를 눌러 온 것도 높은 총이익의 바탕이다.

가장 극단은 센티넬원이다. 이 회사는 주식보상 하나만으로 매출의 **29.7%**를 쓴다. 직원에게 준 주식값이 1년 매출의 3분의 1에 가까우니, 영업이익률이 마이너스 32%로 깊은 것도 당연하다. 3세대 EDR의 적자는 게으름이 아니라, 아직 규모의 문턱을 넘지 못한 채 미래를 당겨쓰는 청년기의 모습이다.
...
둘째, 그래서 **현금과 잉여현금흐름은 두둑하다.** 손에 쥔 현금성 자산이 43억 달러(약 6조 원)이고, 투자비를 빼고도 남는 잉여현금흐름은 직전 회계연도에 약 11억 달러(잉여현금 마진 28%)였다. 회계장부의 '적자'는 그림자이고, 실제 현금은 콸콸 들어온다.
...
이 셋을 합치면 시장이 왜 적자를 눈감아 주는지가 풀린다. 성장률과 현금창출력을 더한 값이 40을 넘으면 건강한 구독 기업으로 보는 오랜 경험칙('40의 법칙')이 있는데, 크라우드스트라이크는 매출 성장률이 20%대에 잉여현금흐름 마진이 30% 가까우니 이 선을 가뿐히 넘는다. 회계상 적자는 성장이 멈추는 순간 흑자로 뒤집힐 수 있는, 스스로 고른 적자인 셈이다. 다만 그 전제는 성장이 계속된다는 것이고, 성장이 꺾이면 이 논리도 함께 무너진다. 시장이 이 회사들에 매긴 값은 바로 그 성장에 건 베팅이다.
...
그런데 모두 작다. 안랩의 1년 매출은 2,677억 원, 약 2,700억이다. 크라우드스트라이크의 매출 43.8억 달러는 원화로 약 6조 원이다. **크라우드스트라이크 하나가 토종 대표 안랩의 스무 배가 넘는다.** 게다가 잘 크지도 않는다. 윈스는 매출이 4년째 1,000억 원 언저리에서 제자리걸음이고(2022년 1,014억 → 2025년 990억), 데이터보안 파수는 영업이익률이 11.8%에서 5.4%로 내려앉았다. 그나마 성장의 실마리를 보이는 곳은 접근제어에서 EDR로 사업을 넓히려는 지니언스 정도인데, 흑자는 지키되 새 세대 기술로 몸집을 키우려는 시도다. 그마저도 규모는 미국 회사의 수십 분의 일이다.

왜 이렇게 갈렸을까. 미국에는 "몇 년을 적자로 버티면서 주식으로 인재를 모으고 시장을 통째로 삼키는" 자본 모델이 있다. 크라우드스트라이크의 21% 주식보상, 센티넬원의 30% 주식보상이 그 모델의 연료다. 한국 보안사에는 그 연료가 없다. 대신 내수 시장에서 규율 있게 흑자를 지킨다. 안정적이지만, 세계 시장을 삼키는 규모의 게임은 미국이 가져간다. 흑자냐 성장이냐. 태평양을 사이에 두고 두 산업은 정확히 반대 방향을 골랐다.
...
본문의 모든 실측 수치는 아래 호출로 재현된다. 각사 최근 완료 회계연도의 손익계산서를 분기 단위로 받아 회계연도로 합산한 값이다. 미국사는 결산월이 달라 회계연도 기준을 병기한다. 데이터 기준: 2026-07-05 (dartlab). 로컬 데이터 최신 반영일 기준이며, 최신 분기 확정 공시에 따라 소폭 갱신될 수 있다.

| 본문 수치 | dartlab 호출 | 결과 |
|---|---|---|
| 포티넷 매출 68.0억 달러 / 영업이익률 30.7% (FY2025, 12월 결산) | `Company("FTNT").select("IS")` 분기 합산 | 매출 6,800M, 영익 2,085M (EDGAR 실측) |
| 포티넷 매출총이익률 80.5% / R&D 매출대비 12.0% | `Company("FTNT").select("IS", ["revenue","gross_profit","research_and_development"])` | 실측 |
| 크라우드스트라이크 매출 43.8억 달러 / 영업이익률 -3.5% (FY2025, 1월 결산) | `Company("CRWD").select("IS")` 분기 합산 | 매출 4,383M, 영익 -153M (EDGAR 실측) |
| 크라우드스트라이크 매출총이익률 75.1% / SG&A 38.0% / R&D 27.8% / 주식보상 21.4% | `Company("CRWD").select("IS", ["gross_profit","selling_general_and_administrative","research_and_development","stock_compensation_expense"])` | 실측 |
| 크라우드스트라이크 매출 4.3배 (FY2021 10.2억 → FY2025 43.8억 달러) | `Company("CRWD").select("IS", ["revenue"])` 연도별 합산 | 1,019M → 4,383M |
| 크라우드스트라이크 영업활동현금흐름 약 +13.8억 달러 / 잉여현금흐름 약 +11.3억 달러 (FY2024, OCF 1,382M - capex 255M) | `Company("CRWD").select("CF")` 분기 합산 | EDGAR 실측 |
| 크라우드스트라이크 이연매출 약 3.7조 원 (현재분 2,733M + 비유동 996M) / 현금성자산 4,323M 달러 (FY2025Q4) | `Company("CRWD").select("BS", ["contract_liability","cash_and_cash_equivalents"])` | EDGAR 실측 |
| 팔로알토 영업이익률 13.5% (FY2025, 7월 결산) | `Company("PANW").select("IS")` 분기 합산 | 매출 9,222M, 영익 1,243M |
| 지스케일러 영업이익률 -4.8% (FY2025, 7월 결산) | `Company("ZS").select("IS")` 분기 합산 | 매출 2,673M, 영익 -128M |
| 센티넬원 영업이익률 -32.1% / 주식보상 매출대비 29.7% (FY2026, 1월 결산) | `Company("S").select("IS", ["revenue","operating_income","stock_compensation_expense"])` | 매출 1,001M, SBC 298M |
| 안랩 매출 2,677억 원 / 영업이익률 12.4% (2025) | `Company("053800").select("IS")` 분기 합산 | 매출 2,677억, 영익 333억 (DART 실측) |
| 윈스 영업이익률 21.3% / 매출 990억 원 (2025, 정체) | `Company("136540").select("IS")` 분기 합산 | 2022년 1,014억 → 2025년 990억 |
| 지니언스 영업이익률 14.5% / 매출 484억 원 (2025) | `Company("263860").select("IS")` 분기 합산 | 2024년 19.8% → 2025년 14.5% |
| 파수 영업이익률 11.8% → 5.4% 하락 (2022~2025) | `Company("150900").select("IS")` 분기 합산 | 마진 하락 추세 |
| 크라우드스트라이크 매출 궤적 10.2 → 43.8억 달러 (FY2021~FY2025) | `Company("CRWD").select("IS", ["revenue"])` 연도별 합산 | 1,019M → 4,383M (FY2023 데이터 공백) |
| 포티넷 영업이익률 궤적 19.5% → 30.7% (2021~2025) | `Company("FTNT").select("IS")` 연도별 합산 | EDGAR 실측, 꾸준한 상승 |
...
- 재무 수치는 전부 dartlab이 DART(한국)와 EDGAR(미국) 공시에서 런타임 직독한 실측이며, 검증표의 호출로 재현된다.
</content>
</invoke>

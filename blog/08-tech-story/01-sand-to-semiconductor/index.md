...
carousel:
  ...
  slides:
    ...
    - layout: editorialBeat
      kicker: "값은 어디서 터지나"
      line: "규사 1kg은 몇 백원인데, 칩이 되면 금보다 비쌉니다. 이 부가가치는 사슬의 어디서 터질까요?"
      sub: "모래에서 칩까지 8단계를 우리 데이터로 실측했습니다"
    - layout: editorialStat
      kicker: "폴리실리콘, 모래를 정제하는 맨 앞"
      bigNumber: "0.0%"
      unit: "영업이익률"
      context: "순도 99.999999999%까지 올리는 인류 최고 난도의 정제인데, 사슬에서 가장 못 법니다."
    - layout: editorialBeat
      kicker: "중간, 소재와 부품"
      line: "그런데 사슬 중간으로 오면 이야기가 뒤집힙니다. 값을 정하는 힘은 대체 불가능성에서 나오고, 특정 라인에 잠긴 소재가 원재료보다 서너 배를 법니다."
      sub: "포토레지스트(감광액) 동진쎄미켐 14.3%, 실리콘 부품 하나머티리얼즈 18.3%"
    - layout: editorialStat
      kicker: "고대역폭 메모리 장비, AI의 곡괭이"
      bigNumber: "43.6%"
      unit: "영업이익률"
      context: "고대역폭 메모리 장비를 만드는 한미반도체는 매출이 한 해 만에 3.5배로 뛰며, 칩에 육박하는 마진을 냈습니다."
    - layout: editorialStat
      kicker: "칩 제조, 사슬의 끝"
      bigNumber: "48.6%"
      unit: "영업이익률"
      context: "SK하이닉스는 마진의 정점이지만 2023년엔 영업이익률 -23.6% 적자였습니다. 정점은 공짜가 아닙니다."
    - layout: editorialBeat
      kicker: "값을 정하는 규칙"

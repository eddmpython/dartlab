...
carousel:
  ...
  slides:
    ...
    - layout: editorialBeat
      kicker: "중간, 소재와 부품"
      line: "값을 정하는 힘은 대체 불가능성에서 나옵니다. 특정 라인에 잠긴 소재가 원재료보다 서너 배를 법니다."
      sub: "포토레지스트 동진쎄미켐 14.3%, 실리콘 부품 하나머티리얼즈 18.3%"
    - layout: editorialStat
      kicker: "고대역폭 메모리 장비, AI의 곡괭이"
      bigNumber: "43.6%"
      unit: "영업이익률"
      context: "그 장비를 만드는 한미반도체는 매출이 한 해 만에 3.5배로 뛰며, 칩에 육박하는 마진을 냈습니다."
    - layout: editorialStat
      kicker: "칩 제조, 사슬의 끝"
      bigNumber: "48.6%"
      unit: "영업이익률"

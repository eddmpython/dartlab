...
carousel:
  title: "AI가 전기를 삼킨다: GPU 뒤에 숨은 쇳덩어리, 변압기로 누가 돈을 버나"
  caption: |
    AI 데이터센터가 전기를 삼키자, 전기를 실어나르는 변압기가 슈퍼사이클을 맞았습니다.
  ...
  slides:
    - layout: editorial
      line: "AI가 전기를 삼킨다"
      sub: "GPU 뒤에 숨은 쇳덩어리, 변압기로 누가 돈을 버나"
    - layout: editorialBeat
      kicker: "질문"
      line: "AI 담론은 GPU와 모델에 쏠려 있지만, 정작 물리적 병목은 전기를 발전소에서 서버까지 실어나르는 쇠붙이입니다."
      sub: "그 쇠붙이가 변압기입니다. 5개 상장사 이익률을 실측했습니다"
    - layout: editorialStat
      kicker: "초고압 변압기, 미국이 못 만드는 것"
      bigNumber: "0.5% → 24.4%"
      unit: "영업이익률 (2021→2025)"
      context: "HD현대일렉트릭은 5년 만에 영업이익률이 50배 가까이 뛰었습니다. 미국이 스스로 못 만드는 것을 만드는 힘입니다."
    - layout: editorialStat
      kicker: "가장 작은 회사가 가장 높은 마진"
      bigNumber: "35.6%"
      unit: "영업이익률"
      context: "매출 5,019억의 작은 산일전기가, 좁은 특수 변압기 틈새에서 대형사보다 높은 이익률을 냈습니다."
    - layout: editorialBeat
      kicker: "전선은 왜 못 버나"
      line: "같은 슈퍼사이클 안에서도 전선을 만드는 일진전기는 영업이익률 7.4%에 머물렀습니다."
      sub: "구리를 뽑아 만드는 전선은 상품에 가까워, 값을 정하는 힘이 약합니다"
    - layout: editorialBeat
      kicker: "그래서"
      line: "이익은 매출 크기가 아니라, 남이 못 만드는 자리에 앉습니다."
      sub: "1편의 원자로가 전기를 만들면, 이 변압기가 그 전기를 실어나릅니다"
---
...
| 산일전기 영업이익률 35.6%, 매출총이익률 46.6%(2025) | `Company("062040").panel("IS")` | 실측 |

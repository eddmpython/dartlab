---
title: "AI가 전기를 삼킨다: GPU 뒤에 숨은 쇳덩어리, 변압기로 누가 돈을 버나"
date: "2026-07-04"
description: "AI 데이터센터가 전기를 삼키자, 발전소에서 서버까지 전기를 실어나르는 변압기가 슈퍼사이클을 맞았다. 5개 상장사 이익률을 실측하니 초고압 변압기의 HD현대일렉트릭이 영업이익률 0.5%에서 24.4%로 폭발했고, 작은 특수 변압기 산일전기는 35.6%였다. 전선을 만드는 회사만 한 자릿수에 머물렀다."
category: tech-story
series: tech-story
seriesOrder: 4
...
ai:
  ...
  dataAsOf: "2026-07-04"
carousel:
  title: "AI가 전기를 삼킨다: AI 칩 뒤에 숨은 쇳덩어리, 변압기로 누가 돈을 버나"
  caption: |
    AI 데이터센터가 전기를 삼키자, 전기를 실어나르는 변압기가 슈퍼사이클(초호황)을 맞았습니다.

    5개 상장사 이익률을 실측하니 초고압 변압기의 HD현대일렉트릭이 영업이익률 0.5%에서 24.4%로 폭발했고, 작은 특수 변압기 산일전기는 35.6%였습니다. 전선을 만드는 회사만 한 자릿수에 머물렀습니다. 이익은 미국이 스스로 못 만드는 자리에 앉았습니다.
  ...
  slides:
    - layout: editorial
      line: "AI가 전기를 삼킨다"
      sub: "AI 칩 뒤에 숨은 쇳덩어리, 변압기로 누가 돈을 버나"
...
이것이 2025년부터 이어진 변압기 슈퍼사이클이다. 그렇다면 질문. **이 쇳덩어리를 만드는 우리 상장사들 중, 누가 얼마나 버는가?** [1편에서 원자로를 만드는 회사](/blog/smr-reactor-value-chain)를 봤을 때는 가장 큰 회사가 가장 못 벌었다. 이번엔 정반대였다. 우리 데이터로 다섯 회사를 실측했더니, 그 이유가 선명하게 드러났다.
...
본문의 모든 실측 수치는 아래 호출로 재현된다. `scan`은 스크린이고, 표의 이익률·매출은 손익계산서를 분기 단위로 받아 연간(또는 최근 4개 분기, TTM)으로 합산한 실측이다. 데이터 기준: 2026-07-04, 2025년 연간까지 반영.
...
기술 원리(승압·강압, 초고압 변압기, 미국 노후 전력망과 슈퍼사이클)와 최신 수주는 [이투데이: HD현대일렉트릭 빅테크 1.1조 공급계약](https://www.etoday.co.kr/news/view/2599577), [글로벌이코노믹: 美 전력수요 166GW 돌파와 변압기 슈퍼사이클](https://www.g-enews.com/article/Global-Biz/2026/07/2026070307103559642bd56fbc3c_1), [서울신문: 美 AI 대란과 K-전력기기 슈퍼사이클](https://www.seoul.co.kr/news/economy/2026/05/07/20260507030005), [파이낸셜뉴스: 전력인프라 대규모 수주](https://www.fnnews.com/news/202606161817592402)를 참고했다. 외부 본문은 원리와 최신성 참고용이며, 이익률·매출 숫자는 전부 우리 데이터 실측이다.

---
title: "스텔스는 왜 '안 보이는 전투기'가 아닌가: RCS·코팅·센서융합의 저피탐 지도"
date: "2026-07-06"
...
carousel:
  ...
  slides:
    - layout: editorial
      line: "스텔스는 '안 보이는 전투기'가 아니라 되돌아오는 신호를 줄이는 기술입니다."
      sub: "RCS·흡수재·센서융합이 만드는 저피탐 지도"
    ...
    - layout: editorialBeat
      ...
      sub: "그래서 스텔스는 항공기 한 대가 아니라 시스템으로 봐야 합니다."
    - layout: editorialStat
      kicker: "미국 주계약사"
      bigNumber: "10%대"
      unit: "영업이익률"
      context: "하지만 이 기술 난도는 곧바로 고마진으로 이어지지 않습니다. LMT 10.3%, NOC 10.8%, RTX 10.5%, GD 10.2%처럼 주계약사의 남는 몫은 정부 조달 구조 안에서 모입니다."
      visual:
        kind: table
        cols: ["회사", "2025 영업이익률"]
        data:
    ...
    - layout: editorialStat
      ...
      bigNumber: "7.3%"
      unit: "KAI 영업이익률"
      context: "그래서 한국 KF-21 라인은 역할별 손익이 갈립니다. KAI는 체계통합으로 7.3%, 한화시스템은 AESA와 ICT 믹스 때문에 3.3%, 한화에어로는 11.6%, LIG넥스원은 7.4%입니다."
      visual:
        kind: table

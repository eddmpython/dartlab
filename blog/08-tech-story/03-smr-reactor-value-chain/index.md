...
carousel:
  ...
  slides:
    - layout: editorial
      line: "원자로를 공장에서 찍어낸다"
      sub: "가장 큰 설비를 만드는 회사가 가장 못 버는 역설"
    ...
    - layout: editorialStat
      ...
      bigNumber: "4.5%"
      unit: "영업이익률"
      context: "매출 17조로 밸류체인에서 가장 큰 두산에너빌리티가, 정작 이익률은 5년 내 최저이자 사슬에서 가장 낮았습니다."
    - layout: editorialBeat
      kicker: "계측과 정비, 조연들"
      line: "원자로의 눈이 되는 계측기와 20년 정비를 대는 회사들이 두 자릿수로 더 잘 법니다."
      sub: "우진 12.4%, 한전KPS 10.3%. 대체 불가능성과 서비스 지속성의 힘입니다"
    - layout: editorialStat
      kicker: "보조기기, 죽었다 살아난 반전"
      bigNumber: "-13% → 9.8%"
      unit: "영업이익률"
      context: "비에이치아이는 매출이 4년 만에 3배로 뛰며 적자에서 두 자릿수 문턱으로 올라섰습니다."
    - layout: editorialBeat
      kicker: "정직하게"
    ...
    - layout: editorialBeat
      kicker: "그래서"
      line: "부가가치는 설비 크기가 아니라 대체 불가능성과 서비스 지속성이 정합니다."
      sub: "가장 큰 것을 만드는 곳이 아니라 가장 바꾸기 어려운 곳이 법니다"
---

---
title: "원자로를 공장에서 찍어낸다: 가장 큰 설비를 만드는 회사가 가장 못 버는 역설"
date: "2026-07-04"
description: "AI 데이터센터가 전기를 삼키며 소형모듈원자로(SMR)가 돌아왔다. 설계부터 주기기, 계측, 정비까지 5단계 밸류체인의 상장사 이익률을 실측하니, 매출 17조로 원자로를 만드는 두산에너빌리티(영업이익률 4.5%)가 아니라 계측기와 정비를 대는 조연들이 두 자릿수로 더 잘 벌었다."
category: tech-story
series: tech-story
seriesOrder: 3
...
carousel:
  ...
  caption: |
    ...
    설계부터 정비까지 5단계 밸류체인의 상장사 이익률을 실측하니, 매출 17조로 원자로를 만드는 두산에너빌리티(영업이익률 4.5%)가 아니라 계측기와 정비를 대는 조연들이 두 자릿수로 더 잘 벌었습니다. 부가가치는 설비 크기가 아니라 대체 불가능성이 정합니다.
  ...
  slides:
    - layout: editorial
      line: "원자로를 공장에서 찍어낸다"
      sub: "매출 17조로 원자로를 벼려낸 대장간이, 정작 사슬에서 가장 못 벌었다"
    ...
    - layout: editorialBeat
      kicker: "계측과 정비, 조연들"
      line: "그 대신 원자로의 눈이 되는 계측기와 20년 정비를 대는 조연들이 두 자릿수로 더 잘 법니다."
    ...
    - layout: editorialBeat
      kicker: "20년을 쥐는 손"
      line: "결국 덩치가 아니라, 20년을 붙잡는 손이 마진을 정합니다."
...
그렇다면 질문 하나. **이 새 원자로를 우리 상장사 중 누가, 어느 공정에서 만드는가. 그리고 그 사슬에서 돈은 어디에 앉는가?** 상식대로라면 원자로라는 가장 크고 어려운 물건을 직접 만드는 회사가 가장 많이 벌 것 같다. 우리 데이터로 밸류체인 다섯 단계의 상장사 이익률을 직접 재봤더니, 반도체 사슬에서 봤던 것과 똑같은 역설이 다시 나타났다.
...
## 4. 주기기: 원자로를 벼려내는 대장간, 그런데 가장 못 번다
...
매출은 다섯 회사를 다 합친 것보다 크다. 그런데 영업이익률은 4.5%, 5년 내 가장 낮고 사슬에서도 가장 낮다. 왜 가장 큰 대장간이 가장 못 벌까.
...
가장 크고 어려운 주기기를 만드는 힘은 두산에너빌리티에 있지만, 그 힘이 이익으로 번역되려면 SMR이 실제로 팔리고 8,000억짜리 공장이 물량으로 차야 한다. 그 전까지 이익은 사슬의 조용한 자리, 곧 대체하기 어렵고 오래 먹는 곳에 앉는다. **부가가치는 설비의 크기가 아니라 협상력과 지속성의 크기로 결정된다.** 이것은 [반도체 사슬에서 본 법칙](/blog/sand-to-semiconductor), 그리고 [AI 소프트웨어에서 누가 돈을 벌었나](/blog/vector-search-who-profits)를 물었을 때 나온 답과 정확히 같은 문법이다.
...
본문의 모든 실측 수치는 아래 호출로 재현된다. `scan`은 스크린이고, 표의 이익률·매출은 손익계산서를 분기 단위로 받아 연간(또는 최근 4개 분기, TTM)으로 합산한 실측이다. 데이터 기준: 2026-07-04, 2025년 연간까지 반영(일부 회사는 2026년 1분기 포함 TTM 병기).

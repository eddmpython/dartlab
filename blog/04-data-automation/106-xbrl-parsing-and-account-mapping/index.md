...
**데이터 파이프라인**
- [sections 기반 전자공시 기간 비교](/blog/sections-comparison) — XBRL 이후의 텍스트 수평화
- [show(topic) 구조와 실전 활용](/blog/show-topic-design) — 매핑된 데이터의 소비 경로

**검증과 해석**
- [연결 재무제표 주석에서 놓치면 안 되는 5가지](/blog/consolidated-financial-statement-notes) — 연결/별도 차이의 실체
- [매출 인식 시점은 어디서 조작 신호가 나오나](/blog/revenue-recognition-timing-and-manipulation-signals) — 매출 계정 매핑의 회계적 맥락

...
4. **SEO 다듬기(선택):** 각 에피소드 폴더 `youtube.md`(제목·설명·태그·고정댓글·챕터)를 스튜디오에서 그 자동생성 영상에 덮어써 검색 최적화한다. 설명 앞 2줄이 검색 스니펫이라 훅+키워드를 먼저. 챕터 타임스탬프는 오디오 들으며 맞춘다(첫 줄 00:00). 새 에피소드는 `youtube.md` 를 함께 작성한다.

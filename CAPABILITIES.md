...
| 파라미터 | 타입 | 필수 | 설명 |
|---------|------|------|------|
| `code` | string | O | 실행할 dartlab Python 코드. import dartlab으로 시작. |
...
|----------|----------------------|
| 건전성 | show_topic(95) > get_data(90) > get_insight(85) > list_topics(85) > compute_ratios(80) > get_scan_data(70) > get_ratio_series(65) > custom_ratio(55) |
| 공시 | show_topic(95) > list_topics(85) > search_dart_filings(85) > get_report_data(75) > get_dart_filing_text(75) > diff_topic(70) > call_dart_openapi(70) > read_filing(66) > get_disclosure_changes(65) > analyze_disclosure_change(65) > list_live_filings(64) > trace_topic(60) > get_sections(55) > list_filings(55) > get_evidence(55) > get_notes(50) > show_block(45) > get_topic_coverage(35) |
| 리스크 | show_topic(95) > get_data(90) > get_insight(85) > list_topics(85) > run_audit(75) > diff_topic(70) > detect_anomalies(70) > read_filing(66) > get_disclosure_changes(65) > analyze_disclosure_change(65) > economic_forecast(65) > trace_topic(60) > stress_test(60) > run_stress_test(55) > get_evidence(55) > analyze_supply_risk(55) > monte_carlo(55) > run_monte_carlo(50) > get_notes(50) |
| 배당 | show_topic(95) > get_data(90) > list_topics(85) > get_report_data(75) > diff_topic(70) |
...
| 사업 | show_topic(95) > list_topics(85) > search_dart_filings(85) > get_dart_filing_text(75) > diff_topic(70) > call_dart_openapi(70) > read_filing(66) > list_live_filings(64) > get_sections(55) > get_evidence(55) |
| 성장성 | show_topic(95) > get_data(90) > list_topics(85) > forecast_revenue(80) > run_forecast(70) > diff_topic(70) > compute_growth(70) > forecast(70) > analyze_disclosure_change(65) > yoy_analysis(65) > get_ratio_series(65) > proforma_forecast(65) |
| 수익성 | show_topic(95) > get_data(90) > get_insight(85) > list_topics(85) > compute_ratios(80) > get_ratio_series(65) > custom_ratio(55) |
| 종합 | show_topic(95) > get_data(90) > get_insight(85) > list_topics(85) > compute_ratios(80) > run_audit(75) > run_valuation(75) > get_company_info(75) > get_sector_info(70) > diff_topic(70) > run_simulation(70) > get_scan_data(70) > read_filing(66) > get_disclosure_changes(65) > analyze_disclosure_change(65) > list_live_filings(64) > get_rank(60) > get_digest(60) > list_filings(55) > analyze_supply_risk(55) > execute_code(50) > get_notes(50) > batch_query(40) |
| 지배구조 | show_topic(95) > list_topics(85) > get_report_data(75) > get_scan_data(70) > network_graph(65) > trace_topic(60) |
| 투자 | show_topic(95) > list_topics(85) > intrinsic_value(85) > price_target(85) > forecast_revenue(80) > get_current_price(80) > run_valuation(75) > scenario(75) > get_consensus(75) > get_sector_info(70) > run_forecast(70) > forecast(70) > run_simulation(70) > economic_forecast(65) > proforma_forecast(65) > get_fund_flow(65) > sensitivity(60) > get_price_history(60) > run_stress_test(55) > monte_carlo(55) > execute_code(50) |

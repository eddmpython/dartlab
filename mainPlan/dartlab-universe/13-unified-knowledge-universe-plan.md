...
- K1 잔여: Parquet schema detail과 row group navigator, 파일별 크기와 수정 metadata를 추가한다.
...
아직 최종 완성이라고 부르지 않는다. K1 Parquet metadata explorer, K2 전체 semantic relation, K3 worker index, K4 wiki-grade rich content, K5 workflow film, K6 성능과 접근성 hardening 및 사용자 눈검수가 남아 있다.

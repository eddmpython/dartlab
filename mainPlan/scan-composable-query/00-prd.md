...
- 잔여: **Phase 3**(시계열 trend/CAGR·상대 percentile, sector join 선provision, demand-driven) / **Phase 4**(퍼블릭 scan 뷰가 screens/*.json 렌더, TS 3~4중 정의 붕괴, 눈검수 격리). 왓처 배포는 운영자 게이트(operation.notifyPipeline 런북 = PUSHHUB·VAPID secret).
